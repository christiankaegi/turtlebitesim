...
class Multiplexer extends Sprite {
    ...
    private function addedToStageHandler(event:Event):Void {
        ...
        Assets.loadBitmapData("assets/" + AppConstants.ASSET_FOLDER + "/MUX-out-0.png", out0LoadCompleteHandler);
        Assets.loadBitmapData("assets/" + AppConstants.ASSET_FOLDER + "/MUX-out-1.png", out1LoadCompleteHandler);
        Assets.loadBitmapData("assets/" + AppConstants.ASSET_FOLDER + "/MUX-out-2.png", out2LoadCompleteHandler);
        Assets.loadBitmapData("assets/" + AppConstants.ASSET_FOLDER + "/MUX-out-3.png", out3LoadCompleteHandler);
    }
...
**/
    ...
    public function hideAllLines():Void {
        for (i in 0 ... 4) {
            if (getChildByName("muxOut" + i) != null) {
                removeChild(getChildByName("muxOut" + i));
            }
        }
    }
