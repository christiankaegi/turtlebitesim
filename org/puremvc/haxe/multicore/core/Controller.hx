 ...
 * <li> Creating a AppFacade instance of the proper [ICommand] to handle a given [INotification]
...
class Controller implements IController
{
	 ...
	 * used, the AppFacade [ICommand] is used instead.</p>
	 * 
	 * <p>The Observer for the AppFacade ICommand is only created if this the
