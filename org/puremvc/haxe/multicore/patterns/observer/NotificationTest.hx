...
// Create a AppFacade Notification and use accessors to set the note name
...
// Create a AppFacade Notification and use accessors to set the body
...
// Create a AppFacade Notification using the Constructor to set the note name and body
