...
{  		
	...
	{
		// Create a AppFacade Proxy and use accessors to set the proxy name
	...
	{
		// Create a AppFacade Proxy and use accessors to set the data
	...
	{
		// Create a AppFacade Proxy using the Constructor to set the name and data
