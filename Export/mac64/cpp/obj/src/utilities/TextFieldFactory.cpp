...
::openfl::text::TextFormat TextFieldFactory_obj::TEXT_FORMAT;

::openfl::text::TextFormat TextFieldFactory_obj::TEXT_FORMAT_CENTERED;

::openfl::text::TextFormat TextFieldFactory_obj::TEXT_FORMAT_BOLD;

::openfl::text::TextFormat TextFieldFactory_obj::TEXT_FORMAT_CENTERED_BOLD;

::openfl::text::TextFormat TextFieldFactory_obj::TEXT_FORMAT_BUTTON_LABEL;

::openfl::text::TextFormat TextFieldFactory_obj::OUTPUT_TEXT_FORMAT_BOLD;

::openfl::text::TextFormat TextFieldFactory_obj::STEP_TEXT_FORMAT;

int TextFieldFactory_obj::TEXT_ACTIVE_COLOR;

int TextFieldFactory_obj::TEXT_INACTIVE_COLOR;

::openfl::text::TextField TextFieldFactory_obj::getOutputTFBold( ){
...
::openfl::text::TextField TextFieldFactory_obj::getInstructionOutput( ){
	...
	::openfl::text::TextField tf = ::openfl::text::TextField_obj::__new();		HX_STACK_VAR(tf,"tf");
	HX_STACK_LINE(67)
	::openfl::text::TextFormat _g = ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)20,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(67)
...
Dynamic TextFieldFactory_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"TEXT_FORMAT") ) { TEXT_FORMAT=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"SCALE_FACTOR") ) { SCALE_FACTOR=inValue.Cast< Float >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"TEXT_FORMAT_BOLD") ) { TEXT_FORMAT_BOLD=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		if (HX_FIELD_EQ(inName,"STEP_TEXT_FORMAT") ) { STEP_TEXT_FORMAT=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		break;
	case 17:
	...
	case 19:
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"TEXT_FORMAT_CENTERED") ) { TEXT_FORMAT_CENTERED=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"OUTPUT_TEXT_FORMAT_BOLD") ) { OUTPUT_TEXT_FORMAT_BOLD=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"TEXT_FORMAT_BUTTON_LABEL") ) { TEXT_FORMAT_BUTTON_LABEL=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"TEXT_FORMAT_CENTERED_BOLD") ) { TEXT_FORMAT_CENTERED_BOLD=inValue.Cast< ::openfl::text::TextFormat >(); return inValue; }
	}
...
void TextFieldFactory_obj::__boot()
{
	...
	TF_HEIGHT= (int)14;
	SCALE_FACTOR= (int)1;
	TEXT_FORMAT= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	TEXT_FORMAT_CENTERED= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)12,(int)16777215,null(),null(),null(),null(),null(),::openfl::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	TEXT_FORMAT_BOLD= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	TEXT_FORMAT_CENTERED_BOLD= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)12,(int)16777215,null(),null(),null(),null(),null(),::openfl::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	TEXT_FORMAT_BUTTON_LABEL= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)14,(int)16777215,null(),null(),null(),null(),null(),::openfl::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	OUTPUT_TEXT_FORMAT_BOLD= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Consolas Bold"),(int)12,(int)65280,null(),null(),null(),null(),null(),::openfl::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	STEP_TEXT_FORMAT= ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Consolas Bold"),(int)18,(int)65280,null(),null(),null(),null(),null(),::openfl::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
