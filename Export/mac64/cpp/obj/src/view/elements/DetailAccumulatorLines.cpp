...
Dynamic DetailAccumulatorLines_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"enable") ) { enable=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"memoryIn0") ) { memoryIn0=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn1") ) { memoryIn1=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn2") ) { memoryIn2=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn3") ) { memoryIn3=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memorySet") ) { memorySet=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"memoryOut0") ) { memoryOut0=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut1") ) { memoryOut1=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut2") ) { memoryOut2=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut3") ) { memoryOut3=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"enablerOut0") ) { enablerOut0=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut1") ) { enablerOut1=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut2") ) { enablerOut2=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut3") ) { enablerOut3=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"enableBmpData") ) { enableBmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"memoryIn0BmpData") ) { memoryIn0BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn1BmpData") ) { memoryIn1BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn2BmpData") ) { memoryIn2BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryIn3BmpData") ) { memoryIn3BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memorySetBmpData") ) { memorySetBmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"memoryOut0BmpData") ) { memoryOut0BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut1BmpData") ) { memoryOut1BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut2BmpData") ) { memoryOut2BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"memoryOut3BmpData") ) { memoryOut3BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"enablerOut0BmpData") ) { enablerOut0BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut1BmpData") ) { enablerOut1BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut2BmpData") ) { enablerOut2BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
		if (HX_FIELD_EQ(inName,"enablerOut3BmpData") ) { enablerOut3BmpData=inValue.Cast< ::openfl::display::BitmapData >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut0),HX_CSTRING("enablerOut0")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut0BmpData),HX_CSTRING("enablerOut0BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut1),HX_CSTRING("enablerOut1")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut1BmpData),HX_CSTRING("enablerOut1BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut2),HX_CSTRING("enablerOut2")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut2BmpData),HX_CSTRING("enablerOut2BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut3),HX_CSTRING("enablerOut3")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,enablerOut3BmpData),HX_CSTRING("enablerOut3BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn0),HX_CSTRING("memoryIn0")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn0BmpData),HX_CSTRING("memoryIn0BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn1),HX_CSTRING("memoryIn1")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn1BmpData),HX_CSTRING("memoryIn1BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn2),HX_CSTRING("memoryIn2")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn2BmpData),HX_CSTRING("memoryIn2BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn3),HX_CSTRING("memoryIn3")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryIn3BmpData),HX_CSTRING("memoryIn3BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut0),HX_CSTRING("memoryOut0")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut0BmpData),HX_CSTRING("memoryOut0BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut1),HX_CSTRING("memoryOut1")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut1BmpData),HX_CSTRING("memoryOut1BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut2),HX_CSTRING("memoryOut2")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut2BmpData),HX_CSTRING("memoryOut2BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut3),HX_CSTRING("memoryOut3")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memoryOut3BmpData),HX_CSTRING("memoryOut3BmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,enable),HX_CSTRING("enable")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,enableBmpData),HX_CSTRING("enableBmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(DetailAccumulatorLines_obj,memorySet),HX_CSTRING("memorySet")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(DetailAccumulatorLines_obj,memorySetBmpData),HX_CSTRING("memorySetBmpData")},
	{ hx::fsUnknown, 0, null()}
};
#endif
