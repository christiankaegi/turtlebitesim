...
{
		HX_STACK_FRAME("view.component.EditRom","populateRomRows",0x25a1ee1d,"view.component.EditRom.populateRomRows","view/component/EditRom.hx",148,0x4965d6f4)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.EditRom","dataEventHandler",0x267a41bc,"view.component.EditRom.dataEventHandler","view/component/EditRom.hx",157,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		struct _Function_1_1{
			inline static Dynamic Block( ::events::AppEvent &event){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",158,0x4965d6f4)
				{
...
{
		HX_STACK_FRAME("view.component.EditRom","setActiveSample",0x8cc2a9f0,"view.component.EditRom.setActiveSample","view/component/EditRom.hx",165,0x4965d6f4)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.EditRom","destroy",0x17448798,"view.component.EditRom.destroy","view/component/EditRom.hx",180,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(181)
