...
{
HX_STACK_FRAME("view.component.EditRom","new",0x69ad03fe,"view.component.EditRom.new","view/component/EditRom.hx",26,0x4965d6f4)
HX_STACK_THIS(this)
...
Void EditRom_obj::addedToStageHandler( ::openfl::events::Event event){
{
		HX_STACK_FRAME("view.component.EditRom","addedToStageHandler",0x0dc6e745,"view.component.EditRom.addedToStageHandler","view/component/EditRom.hx",56,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(57)
		this->removeEventListener(::openfl::events::Event_obj::ADDED_TO_STAGE,this->addedToStageHandler_dyn(),null());
		HX_STACK_LINE(58)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/EditRomPopup2048.png")),this->bmpLoadCompleteHandler_dyn(),true);
	}
return null();
}
...
Void EditRom_obj::bmpLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.EditRom","bmpLoadCompleteHandler",0x01f3fa68,"view.component.EditRom.bmpLoadCompleteHandler","view/component/EditRom.hx",61,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(62)
		this->bmpData = bmd;
		HX_STACK_LINE(63)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(this->bmpData,null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(63)
		this->bmp = _g;
		HX_STACK_LINE(64)
		this->bmp->set_name(HX_CSTRING("editRomPopup"));
		HX_STACK_LINE(67)
		Float _g1 = this->bmp->set_scaleY(0.5);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(67)
		...
		this->createRomRows();
		HX_STACK_LINE(80)
		::events::AppEvent _g3 = ::events::AppEvent_obj::__new(::events::AppEvent_obj::VIEW_READY,null(),null(),null());		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("view.component.EditRom","createOkButton",0x994ac86c,"view.component.EditRom.createOkButton","view/component/EditRom.hx",83,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(84)
...
{
		HX_STACK_FRAME("view.component.EditRom","createCancelButton",0x23e2e64a,"view.component.EditRom.createCancelButton","view/component/EditRom.hx",91,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(92)
		...
		HX_STACK_LINE(94)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",94,0x4965d6f4)
					{
						HX_STACK_LINE(94)
...
{
		HX_STACK_FRAME("view.component.EditRom","createLoadButton",0x65d57076,"view.component.EditRom.createLoadButton","view/component/EditRom.hx",99,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(100)
...
{
		HX_STACK_FRAME("view.component.EditRom","createSaveButton",0xf963cccd,"view.component.EditRom.createSaveButton","view/component/EditRom.hx",104,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
		...
		HX_STACK_LINE(106)
		{
			...
			struct _Function_2_1{
				inline static Float Block( int &_g2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",106,0x4965d6f4)
					{
						HX_STACK_LINE(106)
...
{
		HX_STACK_FRAME("view.component.EditRom","createSampleButtons",0x15d0de39,"view.component.EditRom.createSampleButtons","view/component/EditRom.hx",110,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(111)
		...
		HX_STACK_LINE(112)
		::openfl::text::TextFormat _g1 = ::openfl::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),((int)14 * ::AppConstants_obj::SCALE_FACTOR),(int)3355443,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(112)
		this->tfSampleTitle->set_defaultTextFormat(_g1);
		HX_STACK_LINE(113)
		this->tfSampleTitle->embedFonts = true;
		HX_STACK_LINE(114)
		...
		HX_STACK_LINE(114)
		{
			...
			struct _Function_2_1{
				inline static Float Block( int &_g3){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",114,0x4965d6f4)
					{
						HX_STACK_LINE(114)
		...
		HX_STACK_LINE(119)
		::view::elements::LabelButton _g4 = ::view::elements::LabelButton_obj::__new(this->btnWidth,HX_CSTRING("ADD,SUB,RAM"),null(),null());		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(119)
		...
		HX_STACK_LINE(125)
		::view::elements::LabelButton _g7 = ::view::elements::LabelButton_obj::__new(this->btnWidth,HX_CSTRING("WELCOME!"),null(),null());		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(125)
		...
		HX_STACK_LINE(131)
		::view::elements::LabelButton _g10 = ::view::elements::LabelButton_obj::__new(this->btnWidth,HX_CSTRING("INC,DEC,Jump"),null(),null());		HX_STACK_VAR(_g10,"_g10");
		HX_STACK_LINE(131)
		...
		HX_STACK_LINE(133)
		{
			...
			struct _Function_2_1{
				inline static Float Block( int &_g41){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",133,0x4965d6f4)
					{
						HX_STACK_LINE(133)
...
{
		HX_STACK_FRAME("view.component.EditRom","createRomRows",0x92e148cb,"view.component.EditRom.createRomRows","view/component/EditRom.hx",138,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(139)
...
{
		HX_STACK_FRAME("view.component.EditRom","populateRomRows",0x25a1ee1d,"view.component.EditRom.populateRomRows","view/component/EditRom.hx",154,0x4965d6f4)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(155)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(156)
				this->romRows->__get(i).StaticCast< ::view::elements::RomRow >()->clear();
			}
		}
		HX_STACK_LINE(158)
		{
...
{
		HX_STACK_FRAME("view.component.EditRom","dataEventHandler",0x267a41bc,"view.component.EditRom.dataEventHandler","view/component/EditRom.hx",163,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		struct _Function_1_1{
			inline static Dynamic Block( ::events::AppEvent &event){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/EditRom.hx",164,0x4965d6f4)
				{
...
{
		HX_STACK_FRAME("view.component.EditRom","setActiveSample",0x8cc2a9f0,"view.component.EditRom.setActiveSample","view/component/EditRom.hx",171,0x4965d6f4)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.EditRom","destroy",0x17448798,"view.component.EditRom.destroy","view/component/EditRom.hx",186,0x4965d6f4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(187)
...
Dynamic EditRom_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"tfSampleTitle") ) { tfSampleTitle=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"buttonContainer") ) { buttonContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"romRowsContainer") ) { romRowsContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(int)offsetof(EditRom_obj,bmpData),HX_CSTRING("bmpData")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(EditRom_obj,bmp),HX_CSTRING("bmp")},
	...
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EditRom_obj,romRowsContainer),HX_CSTRING("romRowsContainer")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(EditRom_obj,tfSampleTitle),HX_CSTRING("tfSampleTitle")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EditRom_obj,buttonContainer),HX_CSTRING("buttonContainer")},
