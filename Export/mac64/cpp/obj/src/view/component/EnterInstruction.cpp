...
Dynamic EnterInstruction_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"linesContainer") ) { linesContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"selectedButtonID") ) { selectedButtonID=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"opcodeMenuButton") ) { opcodeMenuButton=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 17:
	...
	case 18:
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"lineButtonsContainer") ) { lineButtonsContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tfAssemblerContainer") ) { tfAssemblerContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EnterInstruction_obj,lineButtonsContainer),HX_CSTRING("lineButtonsContainer")},
	{hx::fsObject /*::view::elements::LabelButton*/ ,(int)offsetof(EnterInstruction_obj,closeButton),HX_CSTRING("closeButton")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(EnterInstruction_obj,bg),HX_CSTRING("bg")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(EnterInstruction_obj,lines),HX_CSTRING("lines")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EnterInstruction_obj,linesContainer),HX_CSTRING("linesContainer")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(EnterInstruction_obj,tfAssemblerOpcode),HX_CSTRING("tfAssemblerOpcode")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EnterInstruction_obj,opcodeMenuButton),HX_CSTRING("opcodeMenuButton")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(EnterInstruction_obj,tfAssemblerAddress),HX_CSTRING("tfAssemblerAddress")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(EnterInstruction_obj,tfAssemblerContainer),HX_CSTRING("tfAssemblerContainer")},
