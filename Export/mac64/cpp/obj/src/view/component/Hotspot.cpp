...
Void Hotspot_obj::addedToStageHandler( ::openfl::events::Event event){
{
...
Void Hotspot_obj::createClockButton( ){
{
		...
		HX_STACK_LINE(39)
		this->clockButton->addEventListener(::openfl::events::MouseEvent_obj::MOUSE_DOWN,this->clockButtonEventHandler_dyn(),null(),null(),null());
		HX_STACK_LINE(40)
...
Void Hotspot_obj::createAccumulatorButton( ){
{
		...
		HX_STACK_LINE(50)
		this->accumulatorButton->addEventListener(::openfl::events::MouseEvent_obj::MOUSE_DOWN,this->accumulatorButtonEventHandler_dyn(),null(),null(),null());
		HX_STACK_LINE(51)
...
Void Hotspot_obj::createRomButton( ){
{
		...
		HX_STACK_LINE(61)
		this->romButton->addEventListener(::openfl::events::MouseEvent_obj::MOUSE_DOWN,this->romButtonEventHandler_dyn(),null(),null(),null());
		HX_STACK_LINE(62)
...
Void Hotspot_obj::clockButtonEventHandler( ::openfl::events::MouseEvent event){
{
...
Void Hotspot_obj::accumulatorButtonEventHandler( ::openfl::events::MouseEvent event){
{
...
Void Hotspot_obj::romButtonEventHandler( ::openfl::events::MouseEvent event){
{
...
Dynamic Hotspot_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"romButton") ) { romButton=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"clockButton") ) { clockButton=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"accumulatorButton") ) { accumulatorButton=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(Hotspot_obj,clockButton),HX_CSTRING("clockButton")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(Hotspot_obj,accumulatorButton),HX_CSTRING("accumulatorButton")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(Hotspot_obj,romButton),HX_CSTRING("romButton")},
	{ hx::fsUnknown, 0, null()}
};
#endif
