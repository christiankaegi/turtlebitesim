...
Dynamic Output_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"r1") ) { r1=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		if (HX_FIELD_EQ(inName,"r2") ) { r2=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"accu") ) { accu=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Output_obj,r1),HX_CSTRING("r1")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Output_obj,r2),HX_CSTRING("r2")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Output_obj,accu),HX_CSTRING("accu")},
