...
{
		HX_STACK_FRAME("view.component.lines.MainBus","toggleSingleLine",0xc43d7b40,"view.component.lines.MainBus.toggleSingleLine","view/component/lines/MainBus.hx",84,0x5508b983)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(84)
