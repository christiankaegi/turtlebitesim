...
{
HX_STACK_FRAME("view.component.lines.Gates","new",0x63917ab1,"view.component.lines.Gates.new","view/component/lines/Gates.hx",29,0x5f0869a2)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
	super::__construct();
...
Void Gates_obj::addedToStageHandler( ::openfl::events::Event event){
{
		HX_STACK_FRAME("view.component.lines.Gates","addedToStageHandler",0x02f333f8,"view.component.lines.Gates.addedToStageHandler","view/component/lines/Gates.hx",34,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(35)
		this->removeEventListener(::openfl::events::Event_obj::ADDED_TO_STAGE,this->addedToStageHandler_dyn(),null());
		HX_STACK_LINE(36)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G1-out-0.png")),this->g1Out0LoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(37)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G1-out-1.png")),this->g1Out1LoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(38)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G1-out-2.png")),this->g1Out2LoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(39)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G1-out-3.png")),this->g1Out3LoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(40)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G2-out.png")),this->g2OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(41)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G3-out.png")),this->g3OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(42)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G4-out.png")),this->g4OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(43)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G5-out.png")),this->g5OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(44)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G6-out.png")),this->g6OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(45)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G7-out.png")),this->g7OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(46)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G8-out.png")),this->g8OutLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(47)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/G9-out.png")),this->g9OutLoadCompleteHandler_dyn(),null());
	}
return null();
}
...
Void Gates_obj::g1Out0LoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g1Out0LoadCompleteHandler",0x10b42410,"view.component.lines.Gates.g1Out0LoadCompleteHandler","view/component/lines/Gates.hx",54,0x5f0869a2)
		HX_STACK_THIS(this)
...
Void Gates_obj::g1Out1LoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g1Out1LoadCompleteHandler",0x7718c8af,"view.component.lines.Gates.g1Out1LoadCompleteHandler","view/component/lines/Gates.hx",60,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(61)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g1Out2LoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g1Out2LoadCompleteHandler",0xdd7d6d4e,"view.component.lines.Gates.g1Out2LoadCompleteHandler","view/component/lines/Gates.hx",66,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(67)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g1Out3LoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g1Out3LoadCompleteHandler",0x43e211ed,"view.component.lines.Gates.g1Out3LoadCompleteHandler","view/component/lines/Gates.hx",72,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(73)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g2OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g2OutLoadCompleteHandler",0xcc16f4f7,"view.component.lines.Gates.g2OutLoadCompleteHandler","view/component/lines/Gates.hx",81,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(82)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g3OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g3OutLoadCompleteHandler",0x4c49bdb8,"view.component.lines.Gates.g3OutLoadCompleteHandler","view/component/lines/Gates.hx",91,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(92)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g4OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g4OutLoadCompleteHandler",0xcc7c8679,"view.component.lines.Gates.g4OutLoadCompleteHandler","view/component/lines/Gates.hx",101,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(102)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g5OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g5OutLoadCompleteHandler",0x4caf4f3a,"view.component.lines.Gates.g5OutLoadCompleteHandler","view/component/lines/Gates.hx",111,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(112)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.lines.Gates","g6OutLoadCompleteHandler",0xcce217fb,"view.component.lines.Gates.g6OutLoadCompleteHandler","view/component/lines/Gates.hx",121,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(122)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g7OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g7OutLoadCompleteHandler",0x4d14e0bc,"view.component.lines.Gates.g7OutLoadCompleteHandler","view/component/lines/Gates.hx",133,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(134)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Gates_obj::g8OutLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
		HX_STACK_FRAME("view.component.lines.Gates","g8OutLoadCompleteHandler",0xcd47a97d,"view.component.lines.Gates.g8OutLoadCompleteHandler","view/component/lines/Gates.hx",143,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(144)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.lines.Gates","g9OutLoadCompleteHandler",0x4d7a723e,"view.component.lines.Gates.g9OutLoadCompleteHandler","view/component/lines/Gates.hx",153,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(154)
		::openfl::display::Bitmap _g = ::openfl::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.lines.Gates","showLines",0xfb8a00d3,"view.component.lines.Gates.showLines","view/component/lines/Gates.hx",164,0x5f0869a2)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_1==::AppConstants_obj::OPCODE_MOV)){
			...
			struct _Function_2_1{
				inline static bool Block( ::model::vo::SnapshotVO &accumulator,::model::vo::SnapshotVO &register1){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/lines/Gates.hx",200,0x5f0869a2)
					{
						HX_STACK_LINE(200)
			...
			struct _Function_2_1{
				inline static bool Block( ::model::vo::SnapshotVO &accumulator,::model::vo::SnapshotVO &register1){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/lines/Gates.hx",205,0x5f0869a2)
					{
						HX_STACK_LINE(205)
						int a = accumulator->getDecimal();		HX_STACK_VAR(a,"a");
						HX_STACK_LINE(205)
...
{
		HX_STACK_FRAME("view.component.lines.Gates","showLinesG1",0x72aa599d,"view.component.lines.Gates.showLinesG1","view/component/lines/Gates.hx",215,0x5f0869a2)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.lines.Gates","hideLinesG1",0x937aac78,"view.component.lines.Gates.hideLinesG1","view/component/lines/Gates.hx",232,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(232)
		...
		while((true)){
			...
			HX_STACK_LINE(233)
			::openfl::display::DisplayObject _g1 = this->getChildByName((HX_CSTRING("g1Out") + i));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(233)
			if (((_g1 != null()))){
				HX_STACK_LINE(234)
				::openfl::display::DisplayObject _g11 = this->getChildByName((HX_CSTRING("g1Out") + i));		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(234)
...
{
		HX_STACK_FRAME("view.component.lines.Gates","showLineG6",0x1d3691af,"view.component.lines.Gates.showLineG6","view/component/lines/Gates.hx",239,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(241)
		::openfl::display::DisplayObject _g = this->getChildByName(HX_CSTRING("g6Out"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(241)
		if (((_g == null()))){
			HX_STACK_LINE(242)
			this->addChild(this->g6Out);
...
{
		HX_STACK_FRAME("view.component.lines.Gates","hideLineG6",0x4b479334,"view.component.lines.Gates.hideLineG6","view/component/lines/Gates.hx",247,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(248)
		::openfl::display::DisplayObject _g = this->getChildByName(HX_CSTRING("g6Out"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(248)
		if (((_g != null()))){
			HX_STACK_LINE(249)
			::openfl::display::DisplayObject _g1 = this->getChildByName(HX_CSTRING("g6Out"));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("view.component.lines.Gates","hideAllLines",0x4738238f,"view.component.lines.Gates.hideAllLines","view/component/lines/Gates.hx",253,0x5f0869a2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(254)
		{
			HX_STACK_LINE(254)
		...
		HX_STACK_LINE(259)
		{
			...
			while((true)){
				...
				int i = (_g)++;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(260)
				::openfl::display::DisplayObject _g2 = this->getChildByName(((HX_CSTRING("g") + i) + HX_CSTRING("Out")));		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(260)
				if (((  (((_g2 != null()))) ? bool((i != (int)6)) : bool(false) ))){
					HX_STACK_LINE(261)
					::openfl::display::DisplayObject _g3 = this->getChildByName(((HX_CSTRING("g") + i) + HX_CSTRING("Out")));		HX_STACK_VAR(_g3,"_g3");
					HX_STACK_LINE(261)
...
Dynamic Gates_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 2:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"g2Out") ) { g2Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g3Out") ) { g3Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g4Out") ) { g4Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g5Out") ) { g5Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g6Out") ) { g6Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g7Out") ) { g7Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g8Out") ) { g8Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g9Out") ) { g9Out=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"g1Out0") ) { g1Out0=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g1Out1") ) { g1Out1=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g1Out2") ) { g1Out2=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
		if (HX_FIELD_EQ(inName,"g1Out3") ) { g1Out3=inValue.Cast< ::openfl::display::Bitmap >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g1Out0),HX_CSTRING("g1Out0")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g1Out1),HX_CSTRING("g1Out1")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g1Out2),HX_CSTRING("g1Out2")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g1Out3),HX_CSTRING("g1Out3")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g2Out),HX_CSTRING("g2Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g3Out),HX_CSTRING("g3Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g4Out),HX_CSTRING("g4Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g5Out),HX_CSTRING("g5Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g6Out),HX_CSTRING("g6Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g7Out),HX_CSTRING("g7Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g8Out),HX_CSTRING("g8Out")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(Gates_obj,g9Out),HX_CSTRING("g9Out")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(Gates_obj,tf),HX_CSTRING("tf")},
	{ hx::fsUnknown, 0, null()}
};
#endif
