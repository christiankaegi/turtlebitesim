...
Void RomRamDisplay_obj::updateCell( Array< ::Dynamic > values,int pointer){
{
		...
		HX_STACK_LINE(134)
		{
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static Float Block( hx::ObjectPtr< ::view::component::RomRamDisplay_obj > __this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/component/RomRamDisplay.hx",135,0xed7d34a6)
						{
							HX_STACK_LINE(135)
							int _int = __this->textColor;		HX_STACK_VAR(_int,"int");
							HX_STACK_LINE(135)
				...
				HX_STACK_LINE(135)
				if (((_Function_3_1::Block(this) == this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->backgroundColor))){
					HX_STACK_LINE(136)
					this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->set_backgroundColor((int)0);
					HX_STACK_LINE(137)
					this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->set_textColor(this->textColor);
				}
			}
		...
		HX_STACK_LINE(141)
		this->tfOut->__get(pointer).StaticCast< ::openfl::text::TextField >()->set_backgroundColor(this->textColor);
		HX_STACK_LINE(142)
		this->tfOut->__get(pointer).StaticCast< ::openfl::text::TextField >()->set_textColor((int)0);
	}
return null();
}
...
Void RomRamDisplay_obj::resetPointer( ){
{
		...
		while((true)){
			...
			HX_STACK_LINE(156)
			if (((_Function_2_1::Block(this) == this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->backgroundColor))){
				HX_STACK_LINE(157)
				this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->set_backgroundColor((int)0);
				HX_STACK_LINE(158)
				this->tfOut->__get(i).StaticCast< ::openfl::text::TextField >()->set_textColor(this->textColor);
