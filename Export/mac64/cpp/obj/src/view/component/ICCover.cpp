...
Void ICCover_obj::addedToStageHandler( ::openfl::events::Event event){
{
...
Void ICCover_obj::coverAluLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
...
Void ICCover_obj::coverMultiplexerLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
...
Void ICCover_obj::coverDecoderLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(ICCover_obj,coverAluIC),HX_CSTRING("coverAluIC")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(ICCover_obj,coverMultiplexer),HX_CSTRING("coverMultiplexer")},
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(ICCover_obj,coverDecoder),HX_CSTRING("coverDecoder")},
