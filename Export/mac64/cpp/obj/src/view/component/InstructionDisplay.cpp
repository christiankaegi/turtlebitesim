...
Void InstructionDisplay_obj::addedToStageHandler( ::openfl::events::Event event){
{
		...
		HX_STACK_LINE(44)
		::openfl::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/instructionTable2048.png")),this->bmpLoadCompleteHandler_dyn(),null());
		HX_STACK_LINE(45)
...
Void InstructionDisplay_obj::bmpLoadCompleteHandler( ::openfl::display::BitmapData bmd){
{
...
Void InstructionDisplay_obj::createTfPointer( ){
{
		...
		HX_STACK_LINE(70)
		this->tfPointer->embedFonts = true;
		HX_STACK_LINE(71)
...
Void InstructionDisplay_obj::createTfMachine( ){
{
		...
		HX_STACK_LINE(108)
		::openfl::text::TextField _g3 = this->getBasicTextField();		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(108)
...
Void InstructionDisplay_obj::createTfDescription( ){
{
		...
		HX_STACK_LINE(144)
		this->tfDescription->multiline = true;
		HX_STACK_LINE(145)
...
::openfl::text::TextField InstructionDisplay_obj::getBasicTextField( ){
...
Dynamic InstructionDisplay_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"tfHexOpcode") ) { tfHexOpcode=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"tfHexAddress") ) { tfHexAddress=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"tfDescription") ) { tfDescription=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"tfMachineOpcode") ) { tfMachineOpcode=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"tfMachineAddress") ) { tfMachineAddress=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"tfAssemblerOpcode") ) { tfAssemblerOpcode=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"tfAssemblerAddress") ) { tfAssemblerAddress=inValue.Cast< ::openfl::text::TextField >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(InstructionDisplay_obj,bmp),HX_CSTRING("bmp")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfPointer),HX_CSTRING("tfPointer")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfAssemblerOpcode),HX_CSTRING("tfAssemblerOpcode")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfAssemblerAddress),HX_CSTRING("tfAssemblerAddress")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfMachineOpcode),HX_CSTRING("tfMachineOpcode")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfMachineAddress),HX_CSTRING("tfMachineAddress")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfHexOpcode),HX_CSTRING("tfHexOpcode")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfHexAddress),HX_CSTRING("tfHexAddress")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(InstructionDisplay_obj,tfDescription),HX_CSTRING("tfDescription")},
	{ hx::fsUnknown, 0, null()}
};
#endif
