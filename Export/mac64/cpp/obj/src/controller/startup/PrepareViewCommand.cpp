...
{
HX_STACK_FRAME("controller.startup.PrepareViewCommand","new",0xf2090654,"controller.startup.PrepareViewCommand.new","controller/startup/PrepareViewCommand.hx",60,0x14c3ab5a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(60)
	super::__construct();
...
{
		HX_STACK_FRAME("controller.startup.PrepareViewCommand","execute",0xf6c64a29,"controller.startup.PrepareViewCommand.execute","controller/startup/PrepareViewCommand.hx",63,0x14c3ab5a)
		HX_STACK_THIS(this)
