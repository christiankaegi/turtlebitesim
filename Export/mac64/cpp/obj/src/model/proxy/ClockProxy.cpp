...
Void ClockProxy_obj::startClock( ){
{
		...
		HX_STACK_LINE(32)
		::openfl::utils::Timer _g = ::openfl::utils::Timer_obj::__new(frequency->ms,null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(32)
		this->timer = _g;
		HX_STACK_LINE(33)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::utils::Timer*/ ,(int)offsetof(ClockProxy_obj,timer),HX_CSTRING("timer")},
