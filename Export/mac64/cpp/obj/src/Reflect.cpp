...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Reflect","compare",0xa2d92b54,"Reflect.compare","/usr/lib/haxe/std/cpp/_std/Reflect.hx",65,0xe2153adf)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(65)
	if (((a == b))){
...
bool Reflect_obj::isEnumValue( Dynamic v){
	HX_STACK_FRAME("Reflect","isEnumValue",0x97884d95,"Reflect.isEnumValue","/usr/lib/haxe/std/cpp/_std/Reflect.hx",84,0xe2153adf)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(84)
	if (((v != null()))){
		HX_STACK_LINE(84)
