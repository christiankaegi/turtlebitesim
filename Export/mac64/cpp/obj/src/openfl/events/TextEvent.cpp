...
::openfl::events::Event TextEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.TextEvent","clone",0x41494205,"openfl.events.TextEvent.clone","openfl/events/TextEvent.hx",74,0x23b91588)
	HX_STACK_THIS(this)
	HX_STACK_LINE(74)
	return ::openfl::events::TextEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text);
}
...
::String TextEvent_obj::toString( ){
	...
	HX_STACK_LINE(81)
	::String _g1 = (((HX_CSTRING("[TextEvent type=") + this->type) + HX_CSTRING(" bubbles=")) + _g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(81)
