...
::openfl::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.IOErrorEvent","clone",0xfbdc4afe,"openfl.events.IOErrorEvent.clone","openfl/events/IOErrorEvent.hx",57,0x9ba976af)
	HX_STACK_THIS(this)
	HX_STACK_LINE(57)
	return ::openfl::events::IOErrorEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text,this->errorID);
}
...
::String IOErrorEvent_obj::toString( ){
	...
	HX_STACK_LINE(64)
	::String _g1 = (((HX_CSTRING("[IOErrorEvent type=") + this->type) + HX_CSTRING(" bubbles=")) + _g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(64)
	...
	HX_STACK_LINE(64)
	::String _g5 = (_g4 + HX_CSTRING(" text="));		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(64)
	::String _g6 = (_g5 + this->text);		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(64)
	::String _g7 = (_g6 + HX_CSTRING(" errorID="));		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(64)
	::String _g8 = (_g7 + this->errorID);		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(64)
	return (_g8 + HX_CSTRING("]"));
}
