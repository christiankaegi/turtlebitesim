...
::openfl::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.ErrorEvent","clone",0xbbab6b58,"openfl.events.ErrorEvent.clone","openfl/events/ErrorEvent.hx",73,0x9d2fc215)
	HX_STACK_THIS(this)
	HX_STACK_LINE(73)
	return ::openfl::events::ErrorEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->text,this->errorID);
}
...
::String ErrorEvent_obj::toString( ){
	...
	HX_STACK_LINE(80)
	::String _g1 = (((HX_CSTRING("[ErrorEvent type=") + this->type) + HX_CSTRING(" bubbles=")) + _g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(80)
