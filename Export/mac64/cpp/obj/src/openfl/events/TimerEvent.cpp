...
{
HX_STACK_FRAME("openfl.events.TimerEvent","new",0xb64ac7fe,"openfl.events.TimerEvent.new","openfl/events/TimerEvent.hx",46,0x5c7b7b12)
HX_STACK_THIS(this)
...
::openfl::events::Event TimerEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.TimerEvent","clone",0xa3bdae7b,"openfl.events.TimerEvent.clone","openfl/events/TimerEvent.hx",53,0x5c7b7b12)
	HX_STACK_THIS(this)
	HX_STACK_LINE(53)
	return ::openfl::events::TimerEvent_obj::__new(this->type,this->bubbles,this->cancelable);
}


::String TimerEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.TimerEvent","toString",0x793b7c4e,"openfl.events.TimerEvent.toString","openfl/events/TimerEvent.hx",58,0x5c7b7b12)
	HX_STACK_THIS(this)
	HX_STACK_LINE(60)
	::String _g = ::Std_obj::string(this->bubbles);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(60)
	::String _g1 = (((HX_CSTRING("[TimerEvent type=") + this->type) + HX_CSTRING(" bubbles=")) + _g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("openfl.events.TimerEvent","updateAfterEvent",0xcd7c1969,"openfl.events.TimerEvent.updateAfterEvent","openfl/events/TimerEvent.hx",70,0x5c7b7b12)
		HX_STACK_THIS(this)
	}
return null();
}
