	...
	if (((bool((format != null())) && bool((format->font != null()))))){
		...
		HX_STACK_LINE(1063)
		{
			...
			if (  ( _switch_2==HX_CSTRING("_sans"))){
				HX_STACK_LINE(1070)
				fontList = Array_obj< ::String >::__new().Add((systemFontDirectory + HX_CSTRING("/Arial Black.ttf"))).Add((systemFontDirectory + HX_CSTRING("/Arial.ttf"))).Add((systemFontDirectory + HX_CSTRING("/Helvetica.ttf")));
			}
			else if (  ( _switch_2==HX_CSTRING("_serif"))){
			}
			else if (  ( _switch_2==HX_CSTRING("_typewriter"))){
				HX_STACK_LINE(1088)
				fontList = Array_obj< ::String >::__new().Add((systemFontDirectory + HX_CSTRING("/Courier New.ttf"))).Add((systemFontDirectory + HX_CSTRING("/Courier.ttf")));
			}
			else  {
				HX_STACK_LINE(1099)
...
;
	...
	::String systemFontDirectory = ::lime::system::System_obj::get_fontsDirectory();		HX_STACK_VAR(systemFontDirectory,"systemFontDirectory");
	HX_STACK_LINE(1126)
	fontList = Array_obj< ::String >::__new().Add((systemFontDirectory + HX_CSTRING("/Georgia.ttf"))).Add((systemFontDirectory + HX_CSTRING("/Times.ttf"))).Add((systemFontDirectory + HX_CSTRING("/Times New Roman.ttf")));
	HX_STACK_LINE(1137)
	{
		HX_STACK_LINE(1137)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
