...
{
	if (inName==HX_CSTRING("BOLD")) return 3;
	if (inName==HX_CSTRING("BOLD_ITALIC")) return 2;
...
{
hx::Static(BOLD) = hx::CreateEnum< FontStyle_obj >(HX_CSTRING("BOLD"),3);
hx::Static(BOLD_ITALIC) = hx::CreateEnum< FontStyle_obj >(HX_CSTRING("BOLD_ITALIC"),2);
hx::Static(ITALIC) = hx::CreateEnum< FontStyle_obj >(HX_CSTRING("ITALIC"),1);
hx::Static(REGULAR) = hx::CreateEnum< FontStyle_obj >(HX_CSTRING("REGULAR"),0);
}
