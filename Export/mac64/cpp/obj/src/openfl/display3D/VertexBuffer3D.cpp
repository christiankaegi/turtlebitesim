...
Void VertexBuffer3D_obj::uploadFromByteArray( ::lime::utils::ByteArray byteArray,int byteArrayOffset,int startOffset,int count){
{
		...
		HX_STACK_LINE(38)
		{
			...
			::lime::graphics::opengl::GLBuffer buffer = this->glBuffer;		HX_STACK_VAR(buffer,"buffer");
			HX_STACK_LINE(38)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,(  (((buffer == null()))) ? int((int)0) : int(buffer->id) ));
		}
		HX_STACK_LINE(40)
		...
		HX_STACK_LINE(57)
		::lime::utils::Float32Array _g = ::lime::utils::Float32Array_obj::__new(byteArray,offset,length);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(57)
		float32Array = _g;
		HX_STACK_LINE(60)
		{
			HX_STACK_LINE(60)
			::lime::utils::ByteArray _g1 = float32Array->getByteBuffer();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(60)
			int _g2 = float32Array->getStart();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(60)
			int _g3 = float32Array->getLength();		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(60)
			::lime::graphics::opengl::GL_obj::lime_gl_buffer_data((int)34962,_g1,_g2,_g3,(int)35044);
		}
	}
return null();
}
...
Void VertexBuffer3D_obj::uploadFromVector( Array< Float > data,int startVertex,int numVertices){
{
		...
		::lime::utils::Float32Array float32Array;		HX_STACK_VAR(float32Array,"float32Array");
		HX_STACK_LINE(94)
		::lime::utils::Float32Array _g = ::lime::utils::Float32Array_obj::__new(data,offset,length);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(94)
		float32Array = _g;
		HX_STACK_LINE(97)
		{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::graphics::opengl::GLBuffer*/ ,(int)offsetof(VertexBuffer3D_obj,glBuffer),HX_CSTRING("glBuffer")},
