...
Void IndexBuffer3D_obj::uploadFromByteArray( ::lime::utils::ByteArray byteArray,int byteArrayOffset,int startOffset,int count){
{
		...
		HX_STACK_LINE(55)
		::lime::utils::Int16Array _g = ::lime::utils::Int16Array_obj::__new(byteArray,offset,length);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(55)
		indices = _g;
		HX_STACK_LINE(58)
		{
			HX_STACK_LINE(58)
			::lime::utils::ByteArray _g1 = indices->getByteBuffer();		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(58)
			int _g2 = indices->getStart();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(58)
			int _g3 = indices->getLength();		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(58)
			::lime::graphics::opengl::GL_obj::lime_gl_buffer_data((int)34963,_g1,_g2,_g3,(int)35044);
		}
	}
return null();
}
...
Void IndexBuffer3D_obj::uploadFromVector( Array< int > data,int startOffset,int count){
{
		...
		::lime::utils::Int16Array indices;		HX_STACK_VAR(indices,"indices");
		HX_STACK_LINE(77)
		::lime::utils::Int16Array _g = ::lime::utils::Int16Array_obj::__new(data,startOffset,count);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(77)
		indices = _g;
		HX_STACK_LINE(80)
		{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::lime::graphics::opengl::GLBuffer*/ ,(int)offsetof(IndexBuffer3D_obj,glBuffer),HX_CSTRING("glBuffer")},
