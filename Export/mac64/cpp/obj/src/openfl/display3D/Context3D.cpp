...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(80)
	::openfl::display::Stage stage = ::openfl::Lib_obj::current->stage;		HX_STACK_VAR(stage,"stage");
	HX_STACK_LINE(82)
	::openfl::display::OpenGLView _g5 = ::openfl::display::OpenGLView_obj::__new();		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(82)
	this->ogl = _g5;
	HX_STACK_LINE(83)
	::openfl::geom::Rectangle _g6 = ::openfl::geom::Rectangle_obj::__new((int)0,(int)0,stage->stageWidth,stage->stageHeight);		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(83)
	this->ogl->set_scrollRect(_g6);
	HX_STACK_LINE(84)
	::openfl::geom::Rectangle _g7 = this->ogl->get_scrollRect()->clone();		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(84)
	this->scrollRect = _g7;
	HX_STACK_LINE(85)
	...
	HX_STACK_ARG(mask,"mask")
{
		...
		HX_STACK_LINE(107)
		::lime::graphics::opengl::GL_obj::lime_gl_clear_stencil(stencil);
		HX_STACK_LINE(109)
	...
	HX_STACK_ARG(enableDepthAndStencil,"enableDepthAndStencil")
{
		...
		HX_STACK_LINE(128)
		::openfl::geom::Rectangle _g1 = this->ogl->get_scrollRect()->clone();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(128)
		this->scrollRect = _g1;
		HX_STACK_LINE(129)
		{
			...
			HX_STACK_LINE(129)
			::lime::graphics::opengl::GL_obj::lime_gl_viewport(x,y,width1,height1);
		}
	}
return null();
}
...
::openfl::display3D::Program3D Context3D_obj::createProgram( ){
	...
	HX_STACK_LINE(154)
	::lime::graphics::opengl::GLProgram _g2 = ::lime::graphics::opengl::GLProgram_obj::__new(_g,_g1);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(154)
...
{
		HX_STACK_LINE(255)
		int location = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(this->currentProgram->glProgram->id,HX_CSTRING("yflip"));		HX_STACK_VAR(location,"location");
		HX_STACK_LINE(256)
		::lime::graphics::opengl::GL_obj::lime_gl_uniform1f(location,this->_yFlip);
		HX_STACK_LINE(258)
		if ((!(this->drawing))){
			HX_STACK_LINE(260)
		...
		HX_STACK_LINE(278)
		{
			...
			HX_STACK_LINE(278)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34963,(  (((buffer == null()))) ? int((int)0) : int(buffer->id) ));
		}
		HX_STACK_LINE(279)
		::lime::graphics::opengl::GL_obj::lime_gl_draw_elements((int)4,numIndices,(int)5123,byteOffset);
	}
return null();
}
...
Void Context3D_obj::present( ){
{
		...
		HX_STACK_LINE(289)
		::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,(int)0);
		HX_STACK_LINE(290)
		::lime::graphics::opengl::GL_obj::lime_gl_disable((int)2884);
		HX_STACK_LINE(292)
		if (((this->framebuffer != null()))){
			HX_STACK_LINE(294)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_framebuffer((int)36160,(int)0);
		}
		HX_STACK_LINE(298)
		if (((this->renderbuffer != null()))){
			HX_STACK_LINE(300)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_renderbuffer((int)36161,(int)0);
		}
	}
return null();
}
...
Void Context3D_obj::setDepthTest( bool depthMask,int passCompareMode){
{
		...
		HX_STACK_LINE(388)
		::lime::graphics::opengl::GL_obj::lime_gl_depth_func(passCompareMode);
		HX_STACK_LINE(389)
		::lime::graphics::opengl::GL_obj::lime_gl_depth_mask(depthMask);
	}
return null();
}
	...
	HX_STACK_ARG(byteArrayOffset,"byteArrayOffset")
{
		...
		HX_STACK_LINE(397)
		int location = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(this->currentProgram->glProgram->id,locationName);		HX_STACK_VAR(location,"location");
		HX_STACK_LINE(398)
		{
			HX_STACK_LINE(398)
	...
	HX_STACK_ARG(transposedMatrix,"transposedMatrix")
{
		...
		{
			HX_STACK_LINE(406)
			::lime::utils::Float32Array v = ::lime::utils::Float32Array_obj::__new(matrix->rawData,null(),null());		HX_STACK_VAR(v,"v");
			HX_STACK_LINE(406)
			::lime::utils::ByteArray _g = v->getByteBuffer();		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(406)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform_matrix(location,!(transposedMatrix),_g,(int)4);
		}
	}
return null();
}
	...
	HX_STACK_ARG(startIndex,"startIndex")
{
		...
		int location = ::lime::graphics::opengl::GL_obj::lime_gl_get_uniform_location(this->currentProgram->glProgram->id,locationName);		HX_STACK_VAR(location,"location");
		HX_STACK_LINE(414)
		::lime::graphics::opengl::GL_obj::lime_gl_uniform4f(location,data->__get(startIndex),data->__get((startIndex + (int)1)),data->__get((startIndex + (int)2)),data->__get((startIndex + (int)3)));
	}
return null();
}
...
Void Context3D_obj::setGLSLTextureAt( ::String locationName,::openfl::display3D::textures::TextureBase texture,int textureIndex){
{
		...
		if ((::Std_obj::is(texture,hx::ClassOf< ::openfl::display3D::textures::Texture >()))){
			...
			{
				HX_STACK_LINE(448)
				::lime::graphics::opengl::GLTexture texture1 = (hx::TCast< openfl::display3D::textures::Texture >::cast(texture))->glTexture;		HX_STACK_VAR(texture1,"texture1");
				HX_STACK_LINE(448)
				::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,(  (((texture1 == null()))) ? int((int)0) : int(texture1->id) ));
			}
			HX_STACK_LINE(449)
			::lime::graphics::opengl::GL_obj::lime_gl_uniform1i(location,textureIndex);
		}
		else{
			HX_STACK_LINE(451)
			if ((::Std_obj::is(texture,hx::ClassOf< ::openfl::display3D::textures::RectangleTexture >()))){
				...
				{
					HX_STACK_LINE(453)
					::lime::graphics::opengl::GLTexture texture1 = (hx::TCast< openfl::display3D::textures::RectangleTexture >::cast(texture))->glTexture;		HX_STACK_VAR(texture1,"texture1");
					HX_STACK_LINE(453)
					::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)3553,(  (((texture1 == null()))) ? int((int)0) : int(texture1->id) ));
				}
				HX_STACK_LINE(454)
				...
				if ((::Std_obj::is(texture,hx::ClassOf< ::openfl::display3D::textures::CubeTexture >()))){
					...
					{
						HX_STACK_LINE(458)
						::lime::graphics::opengl::GLTexture texture1 = (hx::TCast< openfl::display3D::textures::CubeTexture >::cast(texture))->glTexture;		HX_STACK_VAR(texture1,"texture1");
						HX_STACK_LINE(458)
						::lime::graphics::opengl::GL_obj::lime_gl_bind_texture((int)34067,(  (((texture1 == null()))) ? int((int)0) : int(texture1->id) ));
					}
					HX_STACK_LINE(459)
					::lime::graphics::opengl::GL_obj::lime_gl_uniform1i(location,textureIndex);
				}
	...
	HX_STACK_ARG(format,"format")
{
		...
		if (((bool((this->currentProgram != null())) && bool((this->currentProgram->glProgram != null()))))){
			HX_STACK_LINE(484)
			location = ::lime::graphics::opengl::GL_obj::lime_gl_get_attrib_location(this->currentProgram->glProgram->id,locationName);
		}
		else{
			HX_STACK_LINE(484)
			location = (int)-1;
		...
		HX_STACK_LINE(502)
		{
			...
			HX_STACK_LINE(502)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_buffer((int)34962,(  (((buffer1 == null()))) ? int((int)0) : int(buffer1->id) ));
		}
		HX_STACK_LINE(504)
		...
		HX_STACK_LINE(545)
		::lime::graphics::opengl::GL_obj::lime_gl_vertex_attrib_pointer(location,dimension,type,false,(buffer->data32PerVertex * numBytes),(bufferOffset * numBytes));
	}
return null();
}
...
Void Context3D_obj::setProgram( ::openfl::display3D::Program3D program3D){
{
		...
		HX_STACK_LINE(560)
		::lime::graphics::opengl::GL_obj::lime_gl_use_program((  (((glProgram == null()))) ? int((int)0) : int(glProgram->id) ));
		HX_STACK_LINE(561)
...
Void Context3D_obj::setRenderMethod( Dynamic func){
{
		...
		HX_STACK_LINE(620)
		this->ogl->set_render( Dynamic(new _Function_1_1(func1)));
	}
return null();
}
	...
	HX_STACK_ARG(surfaceSelector,"surfaceSelector")
{
		...
		HX_STACK_LINE(658)
		{
			...
			::lime::graphics::opengl::GLFramebuffer framebuffer = this->framebuffer;		HX_STACK_VAR(framebuffer,"framebuffer");
			HX_STACK_LINE(658)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_framebuffer((int)36160,(  (((framebuffer == null()))) ? int((int)0) : int(framebuffer->id) ));
		}
		HX_STACK_LINE(660)
		if (((this->renderbuffer == null()))){
			HX_STACK_LINE(662)
			...
			HX_STACK_LINE(662)
			Dynamic _g4 = ::lime::graphics::opengl::GL_obj::lime_gl_create_render_buffer();		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(662)
			::lime::graphics::opengl::GLRenderbuffer _g5 = ::lime::graphics::opengl::GLRenderbuffer_obj::__new(_g3,_g4);		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(662)
		...
		HX_STACK_LINE(666)
		{
			...
			::lime::graphics::opengl::GLRenderbuffer renderbuffer = this->renderbuffer;		HX_STACK_VAR(renderbuffer,"renderbuffer");
			HX_STACK_LINE(666)
			::lime::graphics::opengl::GL_obj::lime_gl_bind_renderbuffer((int)36161,(  (((renderbuffer == null()))) ? int((int)0) : int(renderbuffer->id) ));
		}
		HX_STACK_LINE(670)
		::lime::graphics::opengl::GL_obj::lime_gl_renderbuffer_storage((int)36161,(int)6408,texture->width,texture->height);
		HX_STACK_LINE(672)
		::lime::graphics::opengl::GL_obj::lime_gl_framebuffer_texture2D((int)36160,(int)36064,(int)3553,texture->glTexture->id,(int)0);
		HX_STACK_LINE(674)
		::lime::graphics::opengl::GL_obj::lime_gl_renderbuffer_storage((int)36161,(int)34041,texture->width,texture->height);
		HX_STACK_LINE(675)
		::lime::graphics::opengl::GL_obj::lime_gl_framebuffer_renderbuffer((int)36160,(int)33306,(int)36161,this->renderbuffer->id);
		HX_STACK_LINE(677)
		if ((enableDepthAndStencil)){
			HX_STACK_LINE(679)
			::lime::graphics::opengl::GL_obj::lime_gl_enable((int)2929);
		...
		{
			HX_STACK_LINE(684)
			::lime::utils::ByteArray _g6 = null();		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(684)
			Dynamic _g7 = null();		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(684)
			::lime::graphics::opengl::GL_obj::lime_gl_tex_image_2d((int)3553,(int)0,(int)6408,texture->width,texture->height,(int)0,(int)6408,(int)5121,_g6,_g7);
		}
		HX_STACK_LINE(685)
		...
		HX_STACK_LINE(688)
		::lime::graphics::opengl::GL_obj::lime_gl_viewport((int)0,(int)0,texture->width,texture->height);
	}
return null();
}
...
Void Context3D_obj::setStencilActions( Dynamic triangleFace,Dynamic compareMode,Dynamic actionOnBothPass,Dynamic actionOnDepthFail,Dynamic actionOnDepthPassStencilFail){
{
		...
		HX_STACK_LINE(732)
		::lime::graphics::opengl::GL_obj::lime_gl_stencil_func(this->stencilCompareMode,this->stencilRef,this->stencilReadMask);
	}
return null();
}
	...
	HX_STACK_ARG(writeMask,"writeMask")
{
		...
		::lime::graphics::opengl::GL_obj::lime_gl_stencil_func(this->stencilCompareMode,this->stencilRef,this->stencilReadMask);
		HX_STACK_LINE(743)
		::lime::graphics::opengl::GL_obj::lime_gl_stencil_mask(writeMask);
	}
return null();
}
...
Void Context3D_obj::setTextureParameters( ::openfl::display3D::textures::TextureBase texture,::openfl::display3D::Context3DWrapMode wrap,::openfl::display3D::Context3DTextureFilter filter,::openfl::display3D::Context3DMipFilter mipfilter){
{
		...
		if ((!(::openfl::display3D::Context3D_obj::anisotropySupportTested))){
			...
			HX_STACK_LINE(769)
			::openfl::display3D::Context3D_obj::supportsAnisotropy = (ext != null());
			HX_STACK_LINE(773)
			...
			HX_STACK_LINE(775)
			::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,_Function_2_1::Block());
			HX_STACK_LINE(776)
			int _g = ::lime::graphics::opengl::GL_obj::lime_gl_get_tex_parameter((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(776)
			::openfl::display3D::Context3D_obj::maxSupportedAnisotropy = _g;
		}
		HX_STACK_LINE(780)
		if ((::Std_obj::is(texture,hx::ClassOf< ::openfl::display3D::textures::Texture >()))){
			HX_STACK_LINE(783)
			...
			switch( (int)(filter->__Index())){
				case (int)4: {
					...
					if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
						HX_STACK_LINE(809)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(int)1);
					}
				}
				;break;
				case (int)5: {
				...
				case (int)0: {
					...
					if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
						...
						HX_STACK_LINE(820)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_4_1::Block())) ? Float(_Function_4_2::Block()) : Float((int)2) ));
					}
				}
				;break;
				case (int)1: {
					...
					if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
						...
						HX_STACK_LINE(825)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_4_1::Block())) ? Float(_Function_4_2::Block()) : Float((int)4) ));
					}
				}
				;break;
				case (int)2: {
					...
					if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
						...
						HX_STACK_LINE(830)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_4_1::Block())) ? Float(_Function_4_2::Block()) : Float((int)8) ));
					}
				}
				;break;
				case (int)3: {
					...
					if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
						...
						HX_STACK_LINE(835)
						::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_4_1::Block())) ? Float(_Function_4_2::Block()) : Float((int)16) ));
					}
				}
				;break;
			}
				...
				switch( (int)(filter->__Index())){
					...
					case (int)0: {
						...
						if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
							...
							HX_STACK_LINE(883)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_5_1::Block())) ? Float(_Function_5_2::Block()) : Float((int)2) ));
						}
					}
					;break;
					case (int)1: {
						...
						if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
							...
							HX_STACK_LINE(888)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_5_1::Block())) ? Float(_Function_5_2::Block()) : Float((int)4) ));
						}
					}
					;break;
					case (int)2: {
						...
						if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
							...
							HX_STACK_LINE(893)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_5_1::Block())) ? Float(_Function_5_2::Block()) : Float((int)8) ));
						}
					}
					;break;
					case (int)3: {
						...
						if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
							...
							HX_STACK_LINE(898)
							::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)3553,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_5_1::Block())) ? Float(_Function_5_2::Block()) : Float((int)16) ));
						}
					}
					;break;
				}
				...
				if ((::Std_obj::is(texture,hx::ClassOf< ::openfl::display3D::textures::CubeTexture >()))){
					...
					switch( (int)(filter->__Index())){
						case (int)4: {
							...
							if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
								HX_STACK_LINE(930)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(int)1);
							}
						}
						;break;
						case (int)5: {
						...
						case (int)0: {
							...
							if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
								...
								HX_STACK_LINE(941)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_6_1::Block())) ? Float(_Function_6_2::Block()) : Float((int)2) ));
							}
						}
						;break;
						case (int)1: {
							...
							if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
								...
								HX_STACK_LINE(946)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_6_1::Block())) ? Float(_Function_6_2::Block()) : Float((int)4) ));
							}
						}
						;break;
						case (int)2: {
							...
							if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
								...
								HX_STACK_LINE(951)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_6_1::Block())) ? Float(_Function_6_2::Block()) : Float((int)8) ));
							}
						}
						;break;
						case (int)3: {
							...
							if ((::openfl::display3D::Context3D_obj::supportsAnisotropy)){
								...
								HX_STACK_LINE(956)
								::lime::graphics::opengl::GL_obj::lime_gl_tex_parameterf((int)34067,::openfl::display3D::Context3D_obj::TEXTURE_MAX_ANISOTROPY_EXT,(  ((_Function_6_1::Block())) ? Float(_Function_6_2::Block()) : Float((int)16) ));
							}
						}
						;break;
					}
					...
					HX_STACK_LINE(978)
					::Class _g1 = ::Type_obj::getClass(texture);		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(978)
					::String _g2 = ::Type_obj::getClassName(_g1);		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(978)
					::String _g3 = (HX_CSTRING("Texture of type ") + _g2);		HX_STACK_VAR(_g3,"_g3");
					HX_STACK_LINE(978)
					HX_STACK_DO_THROW((_g3 + HX_CSTRING(" not supported yet")));
				}
			}
		}
	}
...
Void Context3D_obj::__updateBlendStatus( ){
{
		...
		if ((this->blendEnabled)){
			...
			HX_STACK_LINE(1018)
			::lime::graphics::opengl::GL_obj::lime_gl_blend_func(this->blendSourceFactor,this->blendDestinationFactor);
		}
		else{
			HX_STACK_LINE(1022)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::graphics::opengl::GLFramebuffer*/ ,(int)offsetof(Context3D_obj,framebuffer),HX_CSTRING("framebuffer")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(Context3D_obj,indexBuffersCreated),HX_CSTRING("indexBuffersCreated")},
	{hx::fsObject /*::openfl::display::OpenGLView*/ ,(int)offsetof(Context3D_obj,ogl),HX_CSTRING("ogl")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(Context3D_obj,programsCreated),HX_CSTRING("programsCreated")},
	{hx::fsObject /*::lime::graphics::opengl::GLRenderbuffer*/ ,(int)offsetof(Context3D_obj,renderbuffer),HX_CSTRING("renderbuffer")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(Context3D_obj,samplerParameters),HX_CSTRING("samplerParameters")},
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(Context3D_obj,scrollRect),HX_CSTRING("scrollRect")},
	{hx::fsObject /*::lime::graphics::opengl::GLRenderbuffer*/ ,(int)offsetof(Context3D_obj,stencilbuffer),HX_CSTRING("stencilbuffer")},
