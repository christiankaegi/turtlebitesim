...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::graphics::opengl::GLFramebuffer*/ ,(int)offsetof(TextureBase_obj,frameBuffer),HX_CSTRING("frameBuffer")},
	{hx::fsObject /*::lime::graphics::opengl::GLTexture*/ ,(int)offsetof(TextureBase_obj,glTexture),HX_CSTRING("glTexture")},
