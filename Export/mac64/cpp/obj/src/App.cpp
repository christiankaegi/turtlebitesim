...
HX_STACK_THIS(this)
{
	...
	super::__construct();
	HX_STACK_LINE(25)
	this->stage->scaleMode = ::openfl::display::StageScaleMode_obj::NO_SCALE;
	HX_STACK_LINE(26)
	this->stage->align = ::openfl::display::StageAlign_obj::TOP_LEFT;
	HX_STACK_LINE(27)
	...
	HX_STACK_LINE(29)
	this->zoomContainer->addEventListener(::openfl::events::MouseEvent_obj::MOUSE_DOWN,this->mouseDownHandler_dyn(),null(),null(),null());
	HX_STACK_LINE(30)
	this->zoomContainer->addEventListener(::openfl::events::MouseEvent_obj::MOUSE_UP,this->mouseUpHandler_dyn(),null(),null(),null());
	HX_STACK_LINE(31)
...
Void App_obj::addZoomView( ::openfl::display::DisplayObject view){
{
...
Void App_obj::addDetailPopupView( ::openfl::display::DisplayObject view){
{
...
Void App_obj::addNavigView( ::openfl::display::DisplayObject view){
{
...
Void App_obj::mouseDownHandler( ::openfl::events::MouseEvent event){
{
...
Void App_obj::mouseUpHandler( ::openfl::events::MouseEvent event){
{
...
Void App_obj::zoomIn( ){
{
		...
		HX_STACK_LINE(74)
		Float _g = this->zoomContainer->get_width();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(74)
		Float _g1 = (_g * 0.5);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(74)
		Float _g2 = ((this->stage->stageWidth * 0.5) - _g1);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(74)
		int _g3 = ::Math_obj::floor(_g2);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(74)
		this->zoomContainer->set_x(_g3);
		HX_STACK_LINE(75)
		Float _g4 = this->zoomContainer->get_height();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(75)
		Float _g5 = (_g4 * 0.5);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(75)
		Float _g6 = ((this->stage->stageHeight * 0.5) - _g5);		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(75)
		int _g7 = ::Math_obj::floor(_g6);		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(75)
		this->zoomContainer->set_y(_g7);
	}
return null();
}
...
Dynamic App_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"zoomContainer") ) { zoomContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"navigContainer") ) { navigContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"detailPopupContainer") ) { detailPopupContainer=inValue.Cast< ::openfl::display::Sprite >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(App_obj,zoomContainer),HX_CSTRING("zoomContainer")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(App_obj,detailPopupContainer),HX_CSTRING("detailPopupContainer")},
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(App_obj,navigContainer),HX_CSTRING("navigContainer")},
