...
::lime::graphics::RenderContext  RenderContext_obj::CAIRO(::lime::graphics::cairo::Cairo cairo)
	{ return hx::CreateEnum< RenderContext_obj >(HX_CSTRING("CAIRO"),4,hx::DynamicArray(0,1).Add(cairo)); }
...
::lime::graphics::RenderContext  RenderContext_obj::CONSOLE(::lime::graphics::ConsoleRenderContext context)
	{ return hx::CreateEnum< RenderContext_obj >(HX_CSTRING("CONSOLE"),5,hx::DynamicArray(0,1).Add(context)); }

::lime::graphics::RenderContext  RenderContext_obj::CUSTOM(Dynamic data)
	{ return hx::CreateEnum< RenderContext_obj >(HX_CSTRING("CUSTOM"),6,hx::DynamicArray(0,1).Add(data)); }
...
{
	if (inName==HX_CSTRING("CAIRO")) return 4;
	if (inName==HX_CSTRING("CANVAS")) return 1;
	if (inName==HX_CSTRING("CONSOLE")) return 5;
	if (inName==HX_CSTRING("CUSTOM")) return 6;
	if (inName==HX_CSTRING("DOM")) return 2;
	if (inName==HX_CSTRING("FLASH")) return 3;
	if (inName==HX_CSTRING("NONE")) return 7;
...
{
	if (inName==HX_CSTRING("CAIRO")) return 1;
	if (inName==HX_CSTRING("CANVAS")) return 1;
	if (inName==HX_CSTRING("CONSOLE")) return 1;
...
{
	if (inName==HX_CSTRING("CAIRO")) return CAIRO_dyn();
	if (inName==HX_CSTRING("CANVAS")) return CANVAS_dyn();
	if (inName==HX_CSTRING("CONSOLE")) return CONSOLE_dyn();
...
{
hx::Static(NONE) = hx::CreateEnum< RenderContext_obj >(HX_CSTRING("NONE"),7);
}
