...
int HTML5AudioContext_obj::getAudioDecodedByteCount( ::lime::audio::AudioBuffer buffer){
	HX_STACK_FRAME("lime.audio.HTML5AudioContext","getAudioDecodedByteCount",0xd408996d,"lime.audio.HTML5AudioContext.getAudioDecodedByteCount","lime/audio/HTML5AudioContext.hx",70,0xfd54306e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_LINE(70)
	return (int)0;
...
Dynamic HTML5AudioContext_obj::getController( ::lime::audio::AudioBuffer buffer){
	HX_STACK_FRAME("lime.audio.HTML5AudioContext","getController",0x1667b0b6,"lime.audio.HTML5AudioContext.getController","lime/audio/HTML5AudioContext.hx",117,0xfd54306e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_LINE(117)
	return null();
...
Float HTML5AudioContext_obj::getInitialTime( ::lime::audio::AudioBuffer buffer){
	HX_STACK_FRAME("lime.audio.HTML5AudioContext","getInitialTime",0x8b6d9957,"lime.audio.HTML5AudioContext.getInitialTime","lime/audio/HTML5AudioContext.hx",224,0xfd54306e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_LINE(224)
	return (int)0;
...
::String HTML5AudioContext_obj::getMediaGroup( ::lime::audio::AudioBuffer buffer){
	HX_STACK_FRAME("lime.audio.HTML5AudioContext","getMediaGroup",0x865efbd5,"lime.audio.HTML5AudioContext.getMediaGroup","lime/audio/HTML5AudioContext.hx",256,0xfd54306e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_LINE(256)
	return null();
...
{
		HX_STACK_FRAME("lime.audio.HTML5AudioContext","setController",0x5b6d92c2,"lime.audio.HTML5AudioContext.setController","lime/audio/HTML5AudioContext.hx",495,0xfd54306e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(buffer,"buffer")
		HX_STACK_ARG(value,"value")
	}
...
{
		HX_STACK_FRAME("lime.audio.HTML5AudioContext","setMediaGroup",0xcb64dde1,"lime.audio.HTML5AudioContext.setMediaGroup","lime/audio/HTML5AudioContext.hx",549,0xfd54306e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(buffer,"buffer")
		HX_STACK_ARG(value,"value")
	}
