...
#define INCLUDED_org_puremvc_haxe_multicore_interfaces_INotification
...
class HXCPP_CLASS_ATTRIBUTES  INotification_obj : public hx::Interface{
	public:
...
#define DELEGATE_org_puremvc_haxe_multicore_interfaces_INotification \
...
class INotification_delegate_ : public INotification_obj
{
	...
	public:
		...
		DELEGATE_org_puremvc_haxe_multicore_interfaces_INotification
};
...
#endif /* INCLUDED_org_puremvc_haxe_multicore_interfaces_INotification */ 
