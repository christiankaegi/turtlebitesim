...
class BucketDataType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_CSTRING("openfl._internal.renderer.opengl.utils.BucketDataType"); }
		::String __ToString() const { return HX_CSTRING("BucketDataType.") + tag; }
