...
class HXCPP_CLASS_ATTRIBUTES  TextFieldFactory_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::text::TextFormat TEXT_FORMAT;
		static ::openfl::text::TextFormat TEXT_FORMAT_CENTERED;
		static ::openfl::text::TextFormat TEXT_FORMAT_BOLD;
		static ::openfl::text::TextFormat TEXT_FORMAT_CENTERED_BOLD;
		static ::openfl::text::TextFormat TEXT_FORMAT_BUTTON_LABEL;
		static ::openfl::text::TextFormat OUTPUT_TEXT_FORMAT_BOLD;
		static ::openfl::text::TextFormat STEP_TEXT_FORMAT;
		static int TEXT_ACTIVE_COLOR;
		static int TEXT_INACTIVE_COLOR;
		static ::openfl::text::TextField getOutputTFBold( );
		static Dynamic getOutputTFBold_dyn();

		static ::openfl::text::TextField getInstructionOutput( );
