...
class HXCPP_CLASS_ATTRIBUTES  LabelButton_obj : public ::openfl::display::Sprite_obj{
	public:
	...
	public:
		...
		virtual Void buttonDownHandler( ::openfl::events::MouseEvent event);
		Dynamic buttonDownHandler_dyn();

		virtual Void buttonUpHandler( ::openfl::events::MouseEvent event);
