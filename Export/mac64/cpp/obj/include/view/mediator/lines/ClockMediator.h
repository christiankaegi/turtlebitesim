...
#define INCLUDED_view_mediator_lines_ClockMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,ClockMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  ClockMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		ClockMediator_obj();
		Void __construct(::view::component::lines::Clock viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< ClockMediator_obj > __new(::view::component::lines::Clock viewComponent);
		...
		virtual ::view::component::lines::Clock getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_ClockMediator */ 
