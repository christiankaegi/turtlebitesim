...
#define INCLUDED_view_mediator_lines_DecoderMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,DecoderMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  DecoderMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		DecoderMediator_obj();
		Void __construct(::view::component::lines::Decoder viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< DecoderMediator_obj > __new(::view::component::lines::Decoder viewComponent);
		...
		virtual ::view::component::lines::Decoder getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_DecoderMediator */ 
