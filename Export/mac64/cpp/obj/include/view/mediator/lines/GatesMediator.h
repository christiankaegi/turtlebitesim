...
#define INCLUDED_view_mediator_lines_GatesMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,GatesMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  GatesMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		GatesMediator_obj();
		Void __construct(::view::component::lines::Gates viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< GatesMediator_obj > __new(::view::component::lines::Gates viewComponent);
		...
		virtual ::view::component::lines::Gates getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_GatesMediator */ 
