...
#define INCLUDED_view_mediator_lines_TopLayerMediator
...
HX_DECLARE_CLASS3(view,component,lines,TopLayer)
HX_DECLARE_CLASS3(view,mediator,lines,TopLayerMediator)
namespace view{
namespace mediator{
namespace lines{


class HXCPP_CLASS_ATTRIBUTES  TopLayerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef TopLayerMediator_obj OBJ_;
		TopLayerMediator_obj();
		Void __construct(::view::component::lines::TopLayer viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< TopLayerMediator_obj > __new(::view::component::lines::TopLayer viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("TopLayerMediator"); }
		...
		virtual ::view::component::lines::TopLayer getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_TopLayerMediator */ 
