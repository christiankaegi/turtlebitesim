...
#define INCLUDED_view_mediator_lines_MainBusMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,MainBusMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  MainBusMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		MainBusMediator_obj();
		Void __construct(::view::component::lines::MainBus viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< MainBusMediator_obj > __new(::view::component::lines::MainBus viewComponent);
		...
		virtual ::view::component::lines::MainBus getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_MainBusMediator */ 
