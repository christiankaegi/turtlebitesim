...
#define INCLUDED_view_mediator_lines_DisplayMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,DisplayMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  DisplayMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		DisplayMediator_obj();
		Void __construct(::view::component::lines::Display viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< DisplayMediator_obj > __new(::view::component::lines::Display viewComponent);
		...
		virtual ::view::component::lines::Display getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_DisplayMediator */ 
