...
#define INCLUDED_view_mediator_HotspotMediator
...
HX_DECLARE_CLASS2(view,mediator,HotspotMediator)
namespace view{
namespace mediator{


class HXCPP_CLASS_ATTRIBUTES  HotspotMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef HotspotMediator_obj OBJ_;
		HotspotMediator_obj();
		Void __construct(::view::component::Hotspot viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< HotspotMediator_obj > __new(::view::component::Hotspot viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("HotspotMediator"); }
		...
		virtual ::view::component::Hotspot getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_HotspotMediator */ 
