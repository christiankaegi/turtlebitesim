...
#define INCLUDED_view_mediator_basis_AccumulatorMediator
...
HX_DECLARE_CLASS3(view,component,basis,Accumulator)
HX_DECLARE_CLASS3(view,mediator,basis,AccumulatorMediator)
namespace view{
namespace mediator{
namespace basis{


class HXCPP_CLASS_ATTRIBUTES  AccumulatorMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef AccumulatorMediator_obj OBJ_;
		AccumulatorMediator_obj();
		Void __construct(::view::component::basis::Accumulator viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< AccumulatorMediator_obj > __new(::view::component::basis::Accumulator viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("AccumulatorMediator"); }
		...
		virtual ::view::component::basis::Accumulator getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_AccumulatorMediator */ 
