...
#define INCLUDED_view_mediator_basis_BottomLayerMediator
...
HX_DECLARE_CLASS3(view,mediator,basis,BottomLayerMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  BottomLayerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::basis::BottomLayer viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< BottomLayerMediator_obj > __new(::view::component::basis::BottomLayer viewComponent);
		...
		virtual ::view::component::basis::BottomLayer getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_BottomLayerMediator */ 
