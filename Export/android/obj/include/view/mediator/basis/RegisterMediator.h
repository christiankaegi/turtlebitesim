...
#define INCLUDED_view_mediator_basis_RegisterMediator
...
HX_DECLARE_CLASS3(view,mediator,basis,RegisterMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  RegisterMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::basis::Register viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< RegisterMediator_obj > __new(::view::component::basis::Register viewComponent);
		...
		virtual ::view::component::basis::Register getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_RegisterMediator */ 
