...
#define INCLUDED_view_mediator_basis_MainBusMediator
...
HX_DECLARE_CLASS3(view,component,basis,MainBus)
HX_DECLARE_CLASS3(view,mediator,basis,MainBusMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  MainBusMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		MainBusMediator_obj();
		Void __construct(::view::component::basis::MainBus viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< MainBusMediator_obj > __new(::view::component::basis::MainBus viewComponent);
		...
		virtual ::view::component::basis::MainBus getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_MainBusMediator */ 
