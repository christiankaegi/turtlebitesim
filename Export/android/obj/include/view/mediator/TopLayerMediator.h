...
#define INCLUDED_view_mediator_TopLayerMediator
...
HX_DECLARE_CLASS2(view,mediator,TopLayerMediator)
namespace view{
namespace mediator{
...
class HXCPP_CLASS_ATTRIBUTES  TopLayerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::TopLayer viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< TopLayerMediator_obj > __new(::view::component::TopLayer viewComponent);
		...
		virtual ::view::component::TopLayer getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_TopLayerMediator */ 
