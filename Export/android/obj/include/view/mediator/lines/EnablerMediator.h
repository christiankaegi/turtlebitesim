...
#define INCLUDED_view_mediator_lines_EnablerMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,EnablerMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  EnablerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		EnablerMediator_obj();
		Void __construct(::view::component::lines::Enabler viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< EnablerMediator_obj > __new(::view::component::lines::Enabler viewComponent);
		...
		virtual ::view::component::lines::Enabler getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_EnablerMediator */ 
