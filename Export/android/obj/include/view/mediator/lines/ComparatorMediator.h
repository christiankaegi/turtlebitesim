...
#define INCLUDED_view_mediator_lines_ComparatorMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,ComparatorMediator)
namespace view{
namespace mediator{
namespace lines{
...
class HXCPP_CLASS_ATTRIBUTES  ComparatorMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::lines::Comparator viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< ComparatorMediator_obj > __new(::view::component::lines::Comparator viewComponent);
		...
		virtual ::view::component::lines::Comparator getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_ComparatorMediator */ 
