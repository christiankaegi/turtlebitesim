...
class HXCPP_CLASS_ATTRIBUTES  ProgramProxy_obj : public ::org::puremvc::haxe::multicore::patterns::proxy::Proxy_obj{
	...
	public:
		...
		virtual ::model::vo::InstructionVO getManualInstruction( );
		Dynamic getManualInstruction_dyn();

		virtual ::model::vo::InstructionVO getPreviousInstruction( );
		Dynamic getPreviousInstruction_dyn();
		...
		virtual Void setManualInstruction( ::model::vo::InstructionVO instruction);
		Dynamic setManualInstruction_dyn();
