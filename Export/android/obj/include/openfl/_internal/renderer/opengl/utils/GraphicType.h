...
class GraphicType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_CSTRING("openfl._internal.renderer.opengl.utils.GraphicType"); }
		::String __ToString() const { return HX_CSTRING("GraphicType.") + tag; }
