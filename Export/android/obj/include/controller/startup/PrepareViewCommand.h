...
#define INCLUDED_controller_startup_PrepareViewCommand
...
HX_DECLARE_CLASS2(controller,startup,PrepareViewCommand)
...
class HXCPP_CLASS_ATTRIBUTES  PrepareViewCommand_obj : public ::org::puremvc::haxe::multicore::patterns::command::SimpleCommand_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::command::SimpleCommand_obj super;
		typedef PrepareViewCommand_obj OBJ_;
		PrepareViewCommand_obj();
		Void __construct();

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< PrepareViewCommand_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("PrepareViewCommand"); }
...
#endif /* INCLUDED_controller_startup_PrepareViewCommand */ 
