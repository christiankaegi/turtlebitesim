...
{
HX_STACK_FRAME("ScaledStage","new",0x3bde1c96,"ScaledStage.new","ApplicationMain.hx",216,0x0780ded5)
HX_STACK_THIS(this)
...
int ScaledStage_obj::get___stageHeight( ){
	HX_STACK_FRAME("ScaledStage","get___stageHeight",0x9db8d432,"ScaledStage.get___stageHeight","ApplicationMain.hx",223,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(223)
...
int ScaledStage_obj::get___stageWidth( ){
	HX_STACK_FRAME("ScaledStage","get___stageWidth",0xb66b3c1b,"ScaledStage.get___stageWidth","ApplicationMain.hx",230,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
...
int ScaledStage_obj::get_stageHeight( ){
	HX_STACK_FRAME("ScaledStage","get_stageHeight",0x948e0612,"ScaledStage.get_stageHeight","ApplicationMain.hx",237,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(237)
	return (int)768;
}
...
int ScaledStage_obj::get_stageWidth( ){
	HX_STACK_FRAME("ScaledStage","get_stageWidth",0x034ae63b,"ScaledStage.get_stageWidth","ApplicationMain.hx",243,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(243)
	return (int)1024;
}
