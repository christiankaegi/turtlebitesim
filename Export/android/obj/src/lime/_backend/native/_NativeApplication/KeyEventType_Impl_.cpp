...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("lime._backend.native._NativeApplication.KeyEventType_Impl_"), hx::TCanCast< KeyEventType_Impl__obj> ,sStaticFields,sMemberFields,
