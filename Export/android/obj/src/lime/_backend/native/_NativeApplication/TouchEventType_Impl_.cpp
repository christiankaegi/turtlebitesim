...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("lime._backend.native._NativeApplication.TouchEventType_Impl_"), hx::TCanCast< TouchEventType_Impl__obj> ,sStaticFields,sMemberFields,
