...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("lime._backend.native._NativeWindow.WindowFlags_Impl_"), hx::TCanCast< WindowFlags_Impl__obj> ,sStaticFields,sMemberFields,
