...
::openfl::_legacy::text::TextField TextFieldFactory_obj::getInstructionOutput( ){
	...
	::openfl::_legacy::text::TextField tf = ::openfl::_legacy::text::TextField_obj::__new();		HX_STACK_VAR(tf,"tf");
	HX_STACK_LINE(67)
	::openfl::_legacy::text::TextFormat _g = ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)20,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(67)
...
void TextFieldFactory_obj::__boot()
{
	...
	TF_HEIGHT= (int)14;
	SCALE_FACTOR= (int)1;
	TEXT_FORMAT= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	TEXT_FORMAT_CENTERED= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro"),(int)12,(int)16777215,null(),null(),null(),null(),null(),::openfl::_legacy::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	TEXT_FORMAT_BOLD= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	TEXT_FORMAT_CENTERED_BOLD= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)12,(int)16777215,null(),null(),null(),null(),null(),::openfl::_legacy::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	TEXT_FORMAT_BUTTON_LABEL= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Myriad Pro Bold"),(int)14,(int)16777215,null(),null(),null(),null(),null(),::openfl::_legacy::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	OUTPUT_TEXT_FORMAT_BOLD= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Consolas Bold"),(int)12,(int)65280,null(),null(),null(),null(),null(),::openfl::_legacy::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
	STEP_TEXT_FORMAT= ::openfl::_legacy::text::TextFormat_obj::__new(HX_CSTRING("Consolas Bold"),(int)18,(int)65280,null(),null(),null(),null(),null(),::openfl::_legacy::text::TextFormatAlign_obj::CENTER,null(),null(),null(),null());
