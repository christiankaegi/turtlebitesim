...
#include <view/mediator/BottomLayerMediator.h>
#endif
namespace view{
namespace mediator{

Void BottomLayerMediator_obj::__construct(::view::component::BottomLayer viewComponent)
{
HX_STACK_FRAME("view.mediator.BottomLayerMediator","new",0x87358379,"view.mediator.BottomLayerMediator.new","view/mediator/BottomLayerMediator.hx",11,0x053eadf7)
HX_STACK_THIS(this)
...
hx::ObjectPtr< BottomLayerMediator_obj > BottomLayerMediator_obj::__new(::view::component::BottomLayer viewComponent)
...
{
		HX_STACK_FRAME("view.mediator.BottomLayerMediator","onRegister",0x114e4ca9,"view.mediator.BottomLayerMediator.onRegister","view/mediator/BottomLayerMediator.hx",14,0x053eadf7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16)
		::view::component::BottomLayer _g = this->getView();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(16)
...
Array< ::String > BottomLayerMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.BottomLayerMediator","listNotificationInterests",0x092b56b9,"view.mediator.BottomLayerMediator.listNotificationInterests","view/mediator/BottomLayerMediator.hx",20,0x053eadf7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(20)
...
{
		HX_STACK_FRAME("view.mediator.BottomLayerMediator","handleNotification",0x28d953ba,"view.mediator.BottomLayerMediator.handleNotification","view/mediator/BottomLayerMediator.hx",23,0x053eadf7)
		HX_STACK_THIS(this)
...
::view::component::BottomLayer BottomLayerMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.BottomLayerMediator","getView",0x4b0d95b4,"view.mediator.BottomLayerMediator.getView","view/mediator/BottomLayerMediator.hx",55,0x053eadf7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("view.mediator.BottomLayerMediator"), hx::TCanCast< BottomLayerMediator_obj> ,sStaticFields,sMemberFields,
