...
{
		HX_STACK_FRAME("view.mediator.basis.MainBusMediator","handleNotification",0x137dcde9,"view.mediator.basis.MainBusMediator.handleNotification","view/mediator/basis/MainBusMediator.hx",25,0x96146667)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.MainBusMediator","viewReadyHandler",0x6a502d62,"view.mediator.basis.MainBusMediator.viewReadyHandler","view/mediator/basis/MainBusMediator.hx",54,0x96146667)
		HX_STACK_THIS(this)
...
::view::component::basis::MainBus MainBusMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.MainBusMediator","getView",0xffb31f25,"view.mediator.basis.MainBusMediator.getView","view/mediator/basis/MainBusMediator.hx",58,0x96146667)
	HX_STACK_THIS(this)
	HX_STACK_LINE(58)
