...
{
HX_STACK_FRAME("view.mediator.basis.RegisterMediator","new",0x8a67e94a,"view.mediator.basis.RegisterMediator.new","view/mediator/basis/RegisterMediator.hx",14,0x58eebe25)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.RegisterMediator","onRegister",0x5191b2f8,"view.mediator.basis.RegisterMediator.onRegister","view/mediator/basis/RegisterMediator.hx",17,0x58eebe25)
		HX_STACK_THIS(this)
		HX_STACK_LINE(18)
...
Array< ::String > RegisterMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.RegisterMediator","listNotificationInterests",0x3487614a,"view.mediator.basis.RegisterMediator.listNotificationInterests","view/mediator/basis/RegisterMediator.hx",23,0x58eebe25)
	HX_STACK_THIS(this)
	HX_STACK_LINE(23)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::REGISTER_1_CHANGED).Add(::AppConstants_obj::REGISTER_2_CHANGED);
}


Void RegisterMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.basis.RegisterMediator","handleNotification",0x2c722109,"view.mediator.basis.RegisterMediator.handleNotification","view/mediator/basis/RegisterMediator.hx",26,0x58eebe25)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(28)
		{
			...
			if (  ( _switch_1==::AppConstants_obj::REGISTER_1_CHANGED)){
				HX_STACK_LINE(31)
				this->getView()->showLinesRegister1(instruction);
			}
			else if (  ( _switch_1==::AppConstants_obj::REGISTER_2_CHANGED)){
				HX_STACK_LINE(33)
				this->getView()->showLinesRegister2(instruction);
			}
		}
	}
return null();
...
{
		HX_STACK_FRAME("view.mediator.basis.RegisterMediator","viewReadyHandler",0x57837882,"view.mediator.basis.RegisterMediator.viewReadyHandler","view/mediator/basis/RegisterMediator.hx",38,0x58eebe25)
		HX_STACK_THIS(this)
...
::view::component::basis::Register RegisterMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.RegisterMediator","getView",0x9e95b805,"view.mediator.basis.RegisterMediator.getView","view/mediator/basis/RegisterMediator.hx",42,0x58eebe25)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
