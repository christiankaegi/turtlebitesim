...
{
		HX_STACK_FRAME("view.mediator.basis.ClockMediator","handleNotification",0x7017cd82,"view.mediator.basis.ClockMediator.handleNotification","view/mediator/basis/ClockMediator.hx",26,0x3fd2e9c0)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.ClockMediator","viewReadyHandler",0x094ae4bb,"view.mediator.basis.ClockMediator.viewReadyHandler","view/mediator/basis/ClockMediator.hx",38,0x3fd2e9c0)
		HX_STACK_THIS(this)
...
::view::component::basis::Clock ClockMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.ClockMediator","getView",0x5fb0b6ec,"view.mediator.basis.ClockMediator.getView","view/mediator/basis/ClockMediator.hx",42,0x3fd2e9c0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
