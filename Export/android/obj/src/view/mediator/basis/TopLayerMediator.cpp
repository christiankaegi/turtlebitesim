...
{
		HX_STACK_FRAME("view.mediator.basis.TopLayerMediator","handleNotification",0x14e57b10,"view.mediator.basis.TopLayerMediator.handleNotification","view/mediator/basis/TopLayerMediator.hx",24,0x78bf5a2c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.TopLayerMediator","viewReadyHandler",0xeb8e72c9,"view.mediator.basis.TopLayerMediator.viewReadyHandler","view/mediator/basis/TopLayerMediator.hx",56,0x78bf5a2c)
		HX_STACK_THIS(this)
...
::view::component::basis::TopLayer TopLayerMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.TopLayerMediator","getView",0xa58f229e,"view.mediator.basis.TopLayerMediator.getView","view/mediator/basis/TopLayerMediator.hx",60,0x78bf5a2c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(60)
