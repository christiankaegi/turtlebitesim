...
{
		HX_STACK_FRAME("view.component.basis.Multiplexer","out1LoadCompleteHandler",0x30e47c85,"view.component.basis.Multiplexer.out1LoadCompleteHandler","view/component/basis/Multiplexer.hx",38,0xd0b4a416)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(39)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.basis.Multiplexer","out2LoadCompleteHandler",0x97492124,"view.component.basis.Multiplexer.out2LoadCompleteHandler","view/component/basis/Multiplexer.hx",45,0xd0b4a416)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(46)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.basis.Multiplexer","out3LoadCompleteHandler",0xfdadc5c3,"view.component.basis.Multiplexer.out3LoadCompleteHandler","view/component/basis/Multiplexer.hx",52,0xd0b4a416)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(53)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
