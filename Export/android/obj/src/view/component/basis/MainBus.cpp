...
{
HX_STACK_FRAME("view.component.basis.MainBus","new",0x4579cdaf,"view.component.basis.MainBus.new","view/component/basis/MainBus.hx",12,0xc9aeb724)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(17)
	this->maxLines = (int)8;
...
{
		HX_STACK_FRAME("view.component.basis.MainBus","addedToStageHandler",0x3c09e2f6,"view.component.basis.MainBus.addedToStageHandler","view/component/basis/MainBus.hx",24,0xc9aeb724)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.MainBus","showLines",0x5dc7a651,"view.component.basis.MainBus.showLines","view/component/basis/MainBus.hx",32,0xc9aeb724)
		HX_STACK_THIS(this)
		...
		while((true)){
			...
			HX_STACK_LINE(39)
			this->linesActive->__get(i).StaticCast< ::openfl::_legacy::display::Bitmap >()->set_visible(instruction->codeArr->__get(i));
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("view.component.basis.MainBus","hideAllLines",0x8c9880d1,"view.component.basis.MainBus.hideAllLines","view/component/basis/MainBus.hx",47,0xc9aeb724)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(47)
...
{
		HX_STACK_FRAME("view.component.basis.MainBus","loadLine",0x8d894d8b,"view.component.basis.MainBus.loadLine","view/component/basis/MainBus.hx",60,0xc9aeb724)
		HX_STACK_THIS(this)
		HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("view.component.basis.MainBus","bmpLoadCompleteHandler",0x067ea357,"view.component.basis.MainBus.bmpLoadCompleteHandler","view/component/basis/MainBus.hx",64,0xc9aeb724)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(70)
		this->addChild(this->linesActive->__get(this->currentLineNum).StaticCast< ::openfl::_legacy::display::Bitmap >());
		HX_STACK_LINE(71)
		this->linesActive->__get(this->currentLineNum).StaticCast< ::openfl::_legacy::display::Bitmap >()->set_visible(false);
		HX_STACK_LINE(74)
		if (((this->currentLineNum < (this->maxLines - (int)1)))){
			...
			HX_STACK_LINE(78)
			::haxe::Log_obj::trace(HX_CSTRING("MainBus REady!"),hx::SourceInfo(HX_CSTRING("MainBus.hx"),78,HX_CSTRING("view.component.basis.MainBus"),HX_CSTRING("bmpLoadCompleteHandler")));
			HX_STACK_LINE(79)
