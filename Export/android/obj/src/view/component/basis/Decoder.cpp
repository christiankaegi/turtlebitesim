...
{
HX_STACK_FRAME("view.component.basis.Decoder","new",0x93194f2c,"view.component.basis.Decoder.new","view/component/basis/Decoder.hx",17,0x864cb447)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.basis.Decoder","addedToStageHandler",0xc588ee73,"view.component.basis.Decoder.addedToStageHandler","view/component/basis/Decoder.hx",22,0x864cb447)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Decoder","out1LoadCompleteHandler",0x85d1bb34,"view.component.basis.Decoder.out1LoadCompleteHandler","view/component/basis/Decoder.hx",29,0x864cb447)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Decoder","out2LoadCompleteHandler",0xec365fd3,"view.component.basis.Decoder.out2LoadCompleteHandler","view/component/basis/Decoder.hx",36,0x864cb447)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(37)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.basis.Decoder","out3LoadCompleteHandler",0x529b0472,"view.component.basis.Decoder.out3LoadCompleteHandler","view/component/basis/Decoder.hx",43,0x864cb447)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(44)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
Void Decoder_obj::showLines( ::model::vo::InstructionVO instruction){
{
		HX_STACK_FRAME("view.component.basis.Decoder","showLines",0xcb78e38e,"view.component.basis.Decoder.showLines","view/component/basis/Decoder.hx",51,0x864cb447)
		HX_STACK_THIS(this)
		HX_STACK_ARG(instruction,"instruction")
		HX_STACK_LINE(52)
		this->hideAllLines();
		HX_STACK_LINE(53)
		::String t = instruction->code.substr((int)0,(int)4);		HX_STACK_VAR(t,"t");
		HX_STACK_LINE(55)
		if (((bool((bool((t == HX_CSTRING("0001"))) || bool((t == HX_CSTRING("0110"))))) || bool((t == HX_CSTRING("0111")))))){
			HX_STACK_LINE(56)
			::String _g = instruction->code.substr((int)4,(int)2);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(56)
			::String _g1 = (HX_CSTRING("instruction.code.substr(4, 2): ") + _g);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(56)
			::haxe::Log_obj::trace(_g1,hx::SourceInfo(HX_CSTRING("Decoder.hx"),56,HX_CSTRING("view.component.basis.Decoder"),HX_CSTRING("showLines")));
			HX_STACK_LINE(57)
			{
				HX_STACK_LINE(57)
				...
				if (  ( _switch_1==HX_CSTRING("00"))){
					HX_STACK_LINE(59)
					this->addChild(this->out3);
				}
				else if (  ( _switch_1==HX_CSTRING("10"))){
					HX_STACK_LINE(61)
					this->addChild(this->out2);
				}
				else if (  ( _switch_1==HX_CSTRING("01"))){
					HX_STACK_LINE(63)
...
{
		HX_STACK_FRAME("view.component.basis.Decoder","hideAllLines",0x7ddd67b4,"view.component.basis.Decoder.hideAllLines","view/component/basis/Decoder.hx",69,0x864cb447)
		HX_STACK_THIS(this)
		HX_STACK_LINE(69)
