...
Void Welcome_obj::addedToStageHandler( ::openfl::_legacy::events::Event event){
{
		...
		HX_STACK_LINE(25)
		::openfl::_legacy::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/PowerOffCover.png")),this->powerLoadCompleteHandler_dyn(),null());
	}
return null();
}
