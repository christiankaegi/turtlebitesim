...
Void MainMenu_obj::createBG( ){
{
		...
		HX_STACK_LINE(83)
		this->bg->get_graphics()->drawRect((int)0,(int)0,_g1,::view::component::MainMenu_obj::NAVIG_BG_HEIGHT);
		HX_STACK_LINE(84)
		int _g2 = this->get_stage()->get_stageHeight();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(84)
		int _g3 = (_g2 - ::view::component::MainMenu_obj::NAVIG_BG_HEIGHT);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(84)
		this->menuContainer->set_y(_g3);
		HX_STACK_LINE(86)
...
Void MainMenu_obj::createZoomButton( ){
{
		...
		int _g1 = this->get_stage()->get_stageWidth();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(154)
		Float _g2 = (_g1 - w);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(154)
		Float _g3 = (_g2 - (((int)2 * this->buttonGap) * ::AppConstants_obj::SCALE_FACTOR));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(154)
		this->zoomButton->set_x(_g3);
		HX_STACK_LINE(156)
