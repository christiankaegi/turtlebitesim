...
::String Capabilities_obj::get_os( ){
	HX_STACK_FRAME("openfl._legacy.system.Capabilities","get_os",0x1134dd6a,"openfl._legacy.system.Capabilities.get_os","openfl/_legacy/system/Capabilities.hx",73,0x2d33a12e)
	HX_STACK_LINE(73)
...
::String Capabilities_obj::get_version( ){
	...
	HX_STACK_LINE(199)
	::String value = HX_CSTRING("AND");		HX_STACK_VAR(value,"value");
	HX_STACK_LINE(206)
	{
		HX_STACK_LINE(208)
