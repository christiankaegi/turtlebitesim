...
#ifndef INCLUDED_openfl__internal_renderer_opengl_shaders2__DefaultShader_Attrib_Impl_
...
::String Attrib_Impl__obj::TexCoord;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Attrib_Impl__obj::TexCoord,"TexCoord");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Attrib_Impl__obj::TexCoord,"TexCoord");
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._internal.renderer.opengl.shaders2._DefaultShader.Attrib_Impl_"), hx::TCanCast< Attrib_Impl__obj> ,sStaticFields,sMemberFields,
...
void Attrib_Impl__obj::__boot()
{
	...
	TexCoord= HX_CSTRING("aTexCoord0");
