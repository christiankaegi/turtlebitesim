...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(17)
	::String _g9 = ::Std_obj::string(HX_CSTRING("uColor"));		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(17)
	::String _g10 = (HX_CSTRING("uniform vec4 ") + _g9);		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(17)
	::String _g11 = (_g10 + HX_CSTRING(";"));		HX_STACK_VAR(_g11,"_g11");
	HX_STACK_LINE(18)
	::String _g12 = ::Std_obj::string(HX_CSTRING("uAlpha"));		HX_STACK_VAR(_g12,"_g12");
	HX_STACK_LINE(18)
	::String _g13 = (HX_CSTRING("uniform float ") + _g12);		HX_STACK_VAR(_g13,"_g13");
	HX_STACK_LINE(18)
	::String _g14 = (_g13 + HX_CSTRING(";"));		HX_STACK_VAR(_g14,"_g14");
	HX_STACK_LINE(19)
	::String _g15 = ::Std_obj::string(HX_CSTRING("uColorMultiplier"));		HX_STACK_VAR(_g15,"_g15");
	HX_STACK_LINE(19)
	::String _g16 = (HX_CSTRING("uniform vec4 ") + _g15);		HX_STACK_VAR(_g16,"_g16");
	HX_STACK_LINE(19)
	::String _g17 = (_g16 + HX_CSTRING(";"));		HX_STACK_VAR(_g17,"_g17");
	HX_STACK_LINE(20)
	::String _g18 = ::Std_obj::string(HX_CSTRING("uColorOffset"));		HX_STACK_VAR(_g18,"_g18");
	HX_STACK_LINE(20)
	...
	HX_STACK_LINE(35)
	::String _g30 = ::Std_obj::string(HX_CSTRING("uColor"));		HX_STACK_VAR(_g30,"_g30");
	HX_STACK_LINE(35)
