...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._internal.renderer.opengl.shaders2._FillShader.Attrib_Impl_"), hx::TCanCast< Attrib_Impl__obj> ,sStaticFields,sMemberFields,
