...
HX_STACK_ARG(gl,"gl")
{
	...
	HX_STACK_LINE(26)
	::String _g23 = (_g22 + HX_CSTRING(".bgra;"));		HX_STACK_VAR(_g23,"_g23");
	HX_STACK_LINE(13)
	...
	HX_STACK_LINE(37)
	::String _g28 = ::Std_obj::string(HX_CSTRING("uColor"));		HX_STACK_VAR(_g28,"_g28");
	HX_STACK_LINE(37)
	::String _g29 = (HX_CSTRING("uniform vec3 ") + _g28);		HX_STACK_VAR(_g29,"_g29");
	HX_STACK_LINE(37)
	::String _g30 = (_g29 + HX_CSTRING(";"));		HX_STACK_VAR(_g30,"_g30");
	HX_STACK_LINE(38)
	::String _g31 = ::Std_obj::string(HX_CSTRING("uUseTexture"));		HX_STACK_VAR(_g31,"_g31");
	HX_STACK_LINE(38)
	::String _g32 = (HX_CSTRING("uniform bool ") + _g31);		HX_STACK_VAR(_g32,"_g32");
	HX_STACK_LINE(38)
	::String _g33 = (_g32 + HX_CSTRING(";"));		HX_STACK_VAR(_g33,"_g33");
	HX_STACK_LINE(39)
	::String _g34 = ::Std_obj::string(HX_CSTRING("uAlpha"));		HX_STACK_VAR(_g34,"_g34");
	HX_STACK_LINE(39)
	::String _g35 = (HX_CSTRING("uniform float ") + _g34);		HX_STACK_VAR(_g35,"_g35");
	HX_STACK_LINE(39)
	...
	HX_STACK_LINE(40)
	::String _g38 = (HX_CSTRING("uniform vec4 ") + _g37);		HX_STACK_VAR(_g38,"_g38");
	HX_STACK_LINE(40)
	...
	HX_STACK_LINE(58)
	::String _g43 = ::Std_obj::string(HX_CSTRING("uUseTexture"));		HX_STACK_VAR(_g43,"_g43");
	HX_STACK_LINE(58)
	::String _g44 = (HX_CSTRING("   if(") + _g43);		HX_STACK_VAR(_g44,"_g44");
	HX_STACK_LINE(58)
	::String _g45 = (_g44 + HX_CSTRING(") {"));		HX_STACK_VAR(_g45,"_g45");
	HX_STACK_LINE(59)
	::String _g46 = ::Std_obj::string(HX_CSTRING("uSampler0"));		HX_STACK_VAR(_g46,"_g46");
	HX_STACK_LINE(59)
	::String _g47 = (HX_CSTRING("       tmp = texture2D(") + _g46);		HX_STACK_VAR(_g47,"_g47");
	HX_STACK_LINE(59)
	::String _g48 = (_g47 + HX_CSTRING(", vTexCoord);"));		HX_STACK_VAR(_g48,"_g48");
	HX_STACK_LINE(61)
	::String _g49 = ::Std_obj::string(HX_CSTRING("uColor"));		HX_STACK_VAR(_g49,"_g49");
	HX_STACK_LINE(61)
	::String _g50 = (HX_CSTRING("       tmp = vec4(") + _g49);		HX_STACK_VAR(_g50,"_g50");
	HX_STACK_LINE(61)
	::String _g51 = (_g50 + HX_CSTRING(", 1.);"));		HX_STACK_VAR(_g51,"_g51");
	HX_STACK_LINE(63)
	::String _g52 = ::Std_obj::string(HX_CSTRING("uColorMultiplier"));		HX_STACK_VAR(_g52,"_g52");
	HX_STACK_LINE(63)
	::String _g53 = (HX_CSTRING("   gl_FragColor = colorTransform(tmp, vColor, ") + _g52);		HX_STACK_VAR(_g53,"_g53");
	HX_STACK_LINE(63)
	::String _g54 = (_g53 + HX_CSTRING(", "));		HX_STACK_VAR(_g54,"_g54");
	HX_STACK_LINE(63)
	::String _g55 = ::Std_obj::string(HX_CSTRING("uColorOffset"));		HX_STACK_VAR(_g55,"_g55");
	HX_STACK_LINE(63)
	::String _g56 = (_g54 + _g55);		HX_STACK_VAR(_g56,"_g56");
	HX_STACK_LINE(63)
	::String _g57 = (_g56 + HX_CSTRING(");"));		HX_STACK_VAR(_g57,"_g57");
	HX_STACK_LINE(31)
	Array< ::String > _g58 = Array_obj< ::String >::__new().Add(HX_CSTRING("#ifdef GL_ES")).Add(HX_CSTRING("precision lowp float;")).Add(HX_CSTRING("#endif")).Add(_g27).Add(_g30).Add(_g33).Add(_g36).Add(_g39).Add(_g42).Add(HX_CSTRING("varying vec2 vTexCoord;")).Add(HX_CSTRING("varying vec4 vColor;")).Add(HX_CSTRING("vec4 tmp;")).Add(HX_CSTRING("vec4 colorTransform(const vec4 color, const vec4 tint, const vec4 multiplier, const vec4 offset) {")).Add(HX_CSTRING("   vec4 unmultiply = vec4(color.rgb / color.a, color.a);")).Add(HX_CSTRING("   vec4 result = unmultiply * tint * multiplier;")).Add(HX_CSTRING("   result = result + offset;")).Add(HX_CSTRING("   result = clamp(result, 0., 1.);")).Add(HX_CSTRING("   result = vec4(result.rgb * result.a, result.a);")).Add(HX_CSTRING("   return result;")).Add(HX_CSTRING("}")).Add(HX_CSTRING("void main(void) {")).Add(_g45).Add(_g48).Add(HX_CSTRING("   } else {")).Add(_g51).Add(HX_CSTRING("   }")).Add(_g57).Add(HX_CSTRING("}"));		HX_STACK_VAR(_g58,"_g58");
	HX_STACK_LINE(31)
	this->fragmentSrc = _g58;
	HX_STACK_LINE(67)
	this->init();
}
;
