	...
	if (((hl > (hr + (int)2)))){
		struct _Function_2_1{
			inline static int Block( ::haxe::ds::TreeNode &l){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",191,0xbda098e0)
				{
					HX_STACK_LINE(191)
		...
		if (((hr > (hl + (int)2)))){
			struct _Function_3_1{
				inline static int Block( ::haxe::ds::TreeNode &r){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/ds/BalancedTree.hx",194,0xbda098e0)
					{
						HX_STACK_LINE(194)
