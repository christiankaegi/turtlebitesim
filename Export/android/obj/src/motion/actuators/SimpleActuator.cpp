...
HX_STACK_ARG(properties,"properties")
{
	...
	if ((!(::motion::actuators::SimpleActuator_obj::addedEvent))){
		...
		HX_STACK_LINE(81)
		::openfl::_legacy::Lib_obj::get_current()->get_stage()->addEventListener(::openfl::_legacy::events::Event_obj::ENTER_FRAME,::motion::actuators::SimpleActuator_obj::stage_onEnterFrame_dyn(),null(),null(),null());
	}
}
;
	return null();
			...
			while((true)){
				...
				if ((::Std_obj::is(start,hx::ClassOf< ::Float >()))){
					...
					HX_STACK_LINE(198)
					{
						...
						HX_STACK_LINE(198)
						Dynamic value1 = null();		HX_STACK_VAR(value1,"value1");
						HX_STACK_LINE(198)
					...
					HX_STACK_LINE(205)
					::motion::actuators::PropertyDetails _g4 = ::motion::actuators::PropertyDetails_obj::__new(this->target,i,start,(value - start),isField);		HX_STACK_VAR(_g4,"_g4");
					HX_STACK_LINE(205)
					details = _g4;
					HX_STACK_LINE(206)
...
Void SimpleActuator_obj::move( ){
{
		...
		if ((::Reflect_obj::hasField(this->properties,HX_CSTRING("alpha")))){
			HX_STACK_LINE(221)
			_g = ::Std_obj::is(this->target,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >());
		}
		else{
			HX_STACK_LINE(221)
			_g = false;
		...
		struct _Function_1_1{
			inline static Dynamic Block( hx::ObjectPtr< ::motion::actuators::SimpleActuator_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","motion/actuators/SimpleActuator.hx",226,0x731927e5)
				{
					HX_STACK_LINE(226)
				...
				if (((this->_repeat == (int)0))){
					...
					struct _Function_4_1{
						inline static bool Block( hx::ObjectPtr< ::motion::actuators::SimpleActuator_obj > __this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","motion/actuators/SimpleActuator.hx",495,0x731927e5)
							{
								HX_STACK_LINE(495)
								Dynamic _g5;		HX_STACK_VAR(_g5,"_g5");
								HX_STACK_LINE(495)
...
Void SimpleActuator_obj::stage_onEnterFrame( ::openfl::_legacy::events::Event event){
{
