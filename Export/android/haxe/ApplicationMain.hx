...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Christian Kaegi", "TurtlebiteSim3", "net.kaegi.TurtlebiteSim3", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TurtlebiteSim3", null, { width: 1024, height: 768 });
