...
#define INCLUDED_openfl__internal_renderer_opengl_shaders2__DrawTrianglesShader_Uniform_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS6(openfl,_internal,renderer,opengl,shaders2,_DrawTrianglesShader,Uniform_Impl_)
namespace openfl{
namespace _internal{
namespace renderer{
namespace opengl{
...
#endif /* INCLUDED_openfl__internal_renderer_opengl_shaders2__DrawTrianglesShader_Uniform_Impl_ */ 
