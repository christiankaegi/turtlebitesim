...
#define INCLUDED_view_mediator_basis_MultiplexerMediator
...
HX_DECLARE_CLASS3(view,component,basis,Multiplexer)
HX_DECLARE_CLASS3(view,mediator,basis,MultiplexerMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  MultiplexerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::basis::Multiplexer viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< MultiplexerMediator_obj > __new(::view::component::basis::Multiplexer viewComponent);
		...
		virtual ::view::component::basis::Multiplexer getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_MultiplexerMediator */ 
