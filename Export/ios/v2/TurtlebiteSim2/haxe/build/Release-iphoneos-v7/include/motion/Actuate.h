...
class HXCPP_CLASS_ATTRIBUTES  Actuate_obj : public hx::Object{
	...
	public:
		...
		static ::motion::actuators::GenericActuator apply( Dynamic target,Dynamic properties,::Class customActuator);
		static Dynamic apply_dyn();

		static ::motion::_Actuate::EffectsOptions effects( ::openfl::_legacy::display::DisplayObject target,Float duration,hx::Null< bool >  overwrite);
		...
		static ::motion::actuators::GenericActuator timer( Float duration,::Class customActuator);
		...
		static ::motion::actuators::GenericActuator tween( Dynamic target,Float duration,Dynamic properties,hx::Null< bool >  overwrite,::Class customActuator);
		static Dynamic tween_dyn();

		static Void unload( ::motion::actuators::GenericActuator actuator);
		static Dynamic unload_dyn();

		static ::motion::actuators::GenericActuator update( Dynamic target,Float duration,Dynamic start,Dynamic end,hx::Null< bool >  overwrite);
