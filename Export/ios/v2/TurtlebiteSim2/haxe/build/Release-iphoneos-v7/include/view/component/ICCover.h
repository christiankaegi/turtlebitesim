...
#define INCLUDED_view_component_ICCover
...
class HXCPP_CLASS_ATTRIBUTES  ICCover_obj : public ::openfl::_legacy::display::Sprite_obj{
	public:
		typedef ::openfl::_legacy::display::Sprite_obj super;
		typedef ICCover_obj OBJ_;
		ICCover_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< ICCover_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("ICCover"); }
...
#endif /* INCLUDED_view_component_ICCover */ 
