...
class HXCPP_CLASS_ATTRIBUTES  TextField_obj : public ::openfl::display::InteractiveObject_obj{
	...
	public:
		...
		virtual ::openfl::text::Font __findFont( ::String name);
		Dynamic __findFont_dyn();
		...
		virtual int __getLineBreaks( );
		Dynamic __getLineBreaks_dyn();

		virtual Array< int > __getLineBreakIndeces( );
		Dynamic __getLineBreakIndeces_dyn();

		virtual int __getLineBreaksInRange( int i);
		Dynamic __getLineBreaksInRange_dyn();

		virtual Array< int > __getLineIndeces( int line);
		Dynamic __getLineIndeces_dyn();

		virtual Float __getLineWidth( int line);
		Dynamic __getLineWidth_dyn();

		virtual Float __getLineMetric( int line,int metric);
		Dynamic __getLineMetric_dyn();

		virtual Float __getLineMetricSubRangesNull( hx::Null< bool >  singleLine,int metric);
		Dynamic __getLineMetricSubRangesNull_dyn();

		virtual Float __getLineMetricSubRangesNotNull( int specificLine,int metric);
		Dynamic __getLineMetricSubRangesNotNull_dyn();
		...
		virtual Array< Float > __measureText( hx::Null< bool >  condense);
		Dynamic __measureText_dyn();

		virtual Array< Float > __measureTextSub( bool condense);
		Dynamic __measureTextSub_dyn();

		virtual Array< Float > __measureTextSubRangesNull( bool condense);
		Dynamic __measureTextSubRangesNull_dyn();

		virtual Array< Float > __measureTextSubRangesNotNull( bool condense);
		Dynamic __measureTextSubRangesNotNull_dyn();
