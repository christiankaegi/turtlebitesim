...
{
HX_STACK_FRAME("view.mediator.EditRomMediator","new",0x25f67fb9,"view.mediator.EditRomMediator.new","view/mediator/EditRomMediator.hx",18,0x86ba89b7)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","onRegister",0xbf815869,"view.mediator.EditRomMediator.onRegister","view/mediator/EditRomMediator.hx",21,0x86ba89b7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(22)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","onRemove",0x1d3ba0ca,"view.mediator.EditRomMediator.onRemove","view/mediator/EditRomMediator.hx",29,0x86ba89b7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(29)
...
Array< ::String > EditRomMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.EditRomMediator","listNotificationInterests",0xc23b82f9,"view.mediator.EditRomMediator.listNotificationInterests","view/mediator/EditRomMediator.hx",33,0x86ba89b7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","handleNotification",0x569e1f7a,"view.mediator.EditRomMediator.handleNotification","view/mediator/EditRomMediator.hx",36,0x86ba89b7)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","dataEventHandler",0x2c3bcd21,"view.mediator.EditRomMediator.dataEventHandler","view/mediator/EditRomMediator.hx",40,0x86ba89b7)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","populateRomRows",0x1b539658,"view.mediator.EditRomMediator.populateRomRows","view/mediator/EditRomMediator.hx",55,0x86ba89b7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_LINE(56)
...
{
		HX_STACK_FRAME("view.mediator.EditRomMediator","viewReadyHandler",0x133648b3,"view.mediator.EditRomMediator.viewReadyHandler","view/mediator/EditRomMediator.hx",61,0x86ba89b7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(62)
...
::view::component::EditRom EditRomMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.EditRomMediator","getView",0x1da1b1f4,"view.mediator.EditRomMediator.getView","view/mediator/EditRomMediator.hx",68,0x86ba89b7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(68)
