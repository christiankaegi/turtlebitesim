...
#ifndef INCLUDED_openfl__Assets_AssetType_Impl_
...
::String AssetType_Impl__obj::MOVIE_CLIP;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(AssetType_Impl__obj::MOVIE_CLIP,"MOVIE_CLIP");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(AssetType_Impl__obj::MOVIE_CLIP,"MOVIE_CLIP");
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._Assets.AssetType_Impl_"), hx::TCanCast< AssetType_Impl__obj> ,sStaticFields,sMemberFields,
...
void AssetType_Impl__obj::__boot()
{
	...
	MOVIE_CLIP= HX_CSTRING("MOVIE_CLIP");
