...
::String SystemPath_obj::get_applicationDirectory( ){
	HX_STACK_FRAME("openfl._legacy.utils.SystemPath","get_applicationDirectory",0x7e4e50bf,"openfl._legacy.utils.SystemPath.get_applicationDirectory","openfl/_legacy/utils/SystemPath.hx",35,0xd2b50226)
	HX_STACK_LINE(35)
	return ::openfl::_legacy::utils::SystemPath_obj::lime_filesystem_get_special_dir((int)0);
}
...
::String SystemPath_obj::get_applicationStorageDirectory( ){
	HX_STACK_FRAME("openfl._legacy.utils.SystemPath","get_applicationStorageDirectory",0xf52ba3a0,"openfl._legacy.utils.SystemPath.get_applicationStorageDirectory","openfl/_legacy/utils/SystemPath.hx",36,0xd2b50226)
	HX_STACK_LINE(36)
	return ::openfl::_legacy::utils::SystemPath_obj::lime_filesystem_get_special_dir((int)1);
}
...
::String SystemPath_obj::get_desktopDirectory( ){
	HX_STACK_FRAME("openfl._legacy.utils.SystemPath","get_desktopDirectory",0x42d4fbb3,"openfl._legacy.utils.SystemPath.get_desktopDirectory","openfl/_legacy/utils/SystemPath.hx",37,0xd2b50226)
	HX_STACK_LINE(37)
	return ::openfl::_legacy::utils::SystemPath_obj::lime_filesystem_get_special_dir((int)2);
}
...
::String SystemPath_obj::get_documentsDirectory( ){
	HX_STACK_FRAME("openfl._legacy.utils.SystemPath","get_documentsDirectory",0x7e51e997,"openfl._legacy.utils.SystemPath.get_documentsDirectory","openfl/_legacy/utils/SystemPath.hx",38,0xd2b50226)
	HX_STACK_LINE(38)
	return ::openfl::_legacy::utils::SystemPath_obj::lime_filesystem_get_special_dir((int)3);
}
...
::String SystemPath_obj::get_userDirectory( ){
	HX_STACK_FRAME("openfl._legacy.utils.SystemPath","get_userDirectory",0xd12826a0,"openfl._legacy.utils.SystemPath.get_userDirectory","openfl/_legacy/utils/SystemPath.hx",39,0xd2b50226)
	HX_STACK_LINE(39)
	return ::openfl::_legacy::utils::SystemPath_obj::lime_filesystem_get_special_dir((int)4);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.SystemPath"), hx::TCanCast< SystemPath_obj> ,sStaticFields,sMemberFields,
