...
{
HX_STACK_FRAME("AppFacade","new",0x7eccbe2d,"AppFacade.new","AppFacade.hx",28,0x4200e5e3)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("AppFacade","startup",0x50338f8a,"AppFacade.startup","AppFacade.hx",40,0x4200e5e3)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("AppFacade","initializeController",0x10a64d9f,"AppFacade.initializeController","AppFacade.hx",43,0x4200e5e3)
		HX_STACK_THIS(this)
		HX_STACK_LINE(44)
...
::AppFacade AppFacade_obj::getInstance( ::String key){
	HX_STACK_FRAME("AppFacade","getInstance",0x9fd3e518,"AppFacade.getInstance","AppFacade.hx",31,0x4200e5e3)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(32)
