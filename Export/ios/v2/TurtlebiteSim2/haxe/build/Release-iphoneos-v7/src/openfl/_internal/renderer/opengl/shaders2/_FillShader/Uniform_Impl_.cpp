...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._internal.renderer.opengl.shaders2._FillShader.Uniform_Impl_"), hx::TCanCast< Uniform_Impl__obj> ,sStaticFields,sMemberFields,
