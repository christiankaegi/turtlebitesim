...
{
		HX_STACK_FRAME("openfl._legacy.utils.Timer","start",0xbd3fe0b8,"openfl._legacy.utils.Timer.start","openfl/_legacy/utils/Timer.hx",54,0x3ee24e7d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(54)
		if ((!(this->running))){
			HX_STACK_LINE(56)
...
Float Timer_obj::get_delay( ){
	HX_STACK_FRAME("openfl._legacy.utils.Timer","get_delay",0xc9208330,"openfl._legacy.utils.Timer.get_delay","openfl/_legacy/utils/Timer.hx",88,0x3ee24e7d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(88)
	return this->__delay;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._legacy.utils.Timer"), hx::TCanCast< Timer_obj> ,sStaticFields,sMemberFields,
