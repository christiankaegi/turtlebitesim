...
{
HX_STACK_FRAME("view.mediator.basis.EnablerMediator","new",0xd637c472,"view.mediator.basis.EnablerMediator.new","view/mediator/basis/EnablerMediator.hx",14,0xc6b23b5f)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.EnablerMediator","onRegister",0xc5250cd0,"view.mediator.basis.EnablerMediator.onRegister","view/mediator/basis/EnablerMediator.hx",17,0xc6b23b5f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(18)
		...
		HX_STACK_LINE(20)
		::view::component::basis::Enabler _g1 = this->getView();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(20)
...
Array< ::String > EnablerMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.EnablerMediator","listNotificationInterests",0x8d42da72,"view.mediator.basis.EnablerMediator.listNotificationInterests","view/mediator/basis/EnablerMediator.hx",24,0xc6b23b5f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
...
{
		HX_STACK_FRAME("view.mediator.basis.EnablerMediator","handleNotification",0xd43712e1,"view.mediator.basis.EnablerMediator.handleNotification","view/mediator/basis/EnablerMediator.hx",34,0xc6b23b5f)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.EnablerMediator","viewReadyHandler",0x47bbc45a,"view.mediator.basis.EnablerMediator.viewReadyHandler","view/mediator/basis/EnablerMediator.hx",50,0xc6b23b5f)
		HX_STACK_THIS(this)
...
::view::component::basis::Enabler EnablerMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.EnablerMediator","getView",0x46f6472d,"view.mediator.basis.EnablerMediator.getView","view/mediator/basis/EnablerMediator.hx",54,0xc6b23b5f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
