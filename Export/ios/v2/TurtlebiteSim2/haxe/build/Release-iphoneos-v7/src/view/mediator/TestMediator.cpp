...
Array< ::String > TestMediator_obj::listNotificationInterests( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::CLOCK_SPEED_CHANGED).Add(::AppConstants_obj::CLOCK_ON);
}
...
{
		HX_STACK_FRAME("view.mediator.TestMediator","viewReadyHandler",0x0e15cee3,"view.mediator.TestMediator.viewReadyHandler","view/mediator/TestMediator.hx",57,0xd4421027)
		HX_STACK_THIS(this)
...
::view::component::Test TestMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.TestMediator","getView",0x878bb1c4,"view.mediator.TestMediator.getView","view/mediator/TestMediator.hx",61,0xd4421027)
	HX_STACK_THIS(this)
	HX_STACK_LINE(61)
...
{
		HX_STACK_FRAME("view.mediator.TestMediator","dataEventHandler",0x271b5351,"view.mediator.TestMediator.dataEventHandler","view/mediator/TestMediator.hx",65,0xd4421027)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(65)
