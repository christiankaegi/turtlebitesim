...
{
HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","new",0x2abd30df,"view.mediator.basis.ProgramcounterMediator.new","view/mediator/basis/ProgramcounterMediator.hx",17,0x6a82d970)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","onRegister",0xdddfb803,"view.mediator.basis.ProgramcounterMediator.onRegister","view/mediator/basis/ProgramcounterMediator.hx",20,0x6a82d970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(21)
		...
		HX_STACK_LINE(23)
		::view::component::basis::Programcounter _g1 = this->getView();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(23)
...
Array< ::String > ProgramcounterMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","listNotificationInterests",0x2fd8c09f,"view.mediator.basis.ProgramcounterMediator.listNotificationInterests","view/mediator/basis/ProgramcounterMediator.hx",27,0x6a82d970)
	HX_STACK_THIS(this)
	HX_STACK_LINE(27)
...
{
		HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","handleNotification",0x7e2ca914,"view.mediator.basis.ProgramcounterMediator.handleNotification","view/mediator/basis/ProgramcounterMediator.hx",34,0x6a82d970)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","viewReadyHandler",0xc70f57cd,"view.mediator.basis.ProgramcounterMediator.viewReadyHandler","view/mediator/basis/ProgramcounterMediator.hx",51,0x6a82d970)
		HX_STACK_THIS(this)
...
::view::component::basis::Programcounter ProgramcounterMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.ProgramcounterMediator","getView",0xcb4eee1a,"view.mediator.basis.ProgramcounterMediator.getView","view/mediator/basis/ProgramcounterMediator.hx",55,0x6a82d970)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
