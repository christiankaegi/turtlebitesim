...
{
HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","new",0x6b3966a9,"view.mediator.basis.AccumulatorMediator.new","view/mediator/basis/AccumulatorMediator.hx",18,0x12873188)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","onRegister",0x78522f79,"view.mediator.basis.AccumulatorMediator.onRegister","view/mediator/basis/AccumulatorMediator.hx",21,0x12873188)
		HX_STACK_THIS(this)
		HX_STACK_LINE(22)
...
Array< ::String > AccumulatorMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","listNotificationInterests",0x58f71de9,"view.mediator.basis.AccumulatorMediator.listNotificationInterests","view/mediator/basis/AccumulatorMediator.hx",27,0x12873188)
	HX_STACK_THIS(this)
	HX_STACK_LINE(27)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::ACCUMULATOR_CHANGED).Add(::AppConstants_obj::MODEL_RESET_COMPLETE);
}
