...
{
		HX_STACK_FRAME("view.mediator.HotspotMediator","dataEventHandler",0xb653fb18,"view.mediator.HotspotMediator.dataEventHandler","view/mediator/HotspotMediator.hx",59,0xf502456e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.HotspotMediator","viewReadyHandler",0x9d4e76aa,"view.mediator.HotspotMediator.viewReadyHandler","view/mediator/HotspotMediator.hx",69,0xf502456e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(69)
...
::view::component::Hotspot HotspotMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.HotspotMediator","getView",0x75c31edd,"view.mediator.HotspotMediator.getView","view/mediator/HotspotMediator.hx",73,0xf502456e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(73)
