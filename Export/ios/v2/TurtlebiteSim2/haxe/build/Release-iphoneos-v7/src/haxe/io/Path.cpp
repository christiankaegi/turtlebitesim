...
::String Path_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","/usr/lib/haxe/std/haxe/io/Path.hx",109,0xf85ee938)
	HX_STACK_THIS(this)
	HX_STACK_LINE(109)
...
::String Path_obj::withoutDirectory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","/usr/lib/haxe/std/haxe/io/Path.hx",128,0xf85ee938)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(129)
