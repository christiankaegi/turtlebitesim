...
{
HX_STACK_FRAME("view.component.Output","new",0xa0ac5d4d,"view.component.Output.new","view/component/Output.hx",21,0xe160a741)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(22)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.Output","addedToStageHandler",0xa0060e94,"view.component.Output.addedToStageHandler","view/component/Output.hx",26,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","createRomDisplay",0x3ccf7321,"view.component.Output.createRomDisplay","view/component/Output.hx",38,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(39)
		::view::component::RomRamDisplay _g = ::view::component::RomRamDisplay_obj::__new((int)4494335);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(39)
		this->rom = _g;
		HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("view.component.Output","createRamDisplay",0xb39bb513,"view.component.Output.createRamDisplay","view/component/Output.hx",45,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(46)
		::view::component::RomRamDisplay _g = ::view::component::RomRamDisplay_obj::__new((int)65280);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(46)
		this->ram = _g;
		HX_STACK_LINE(47)
...
{
		HX_STACK_FRAME("view.component.Output","createRegister1Display",0x5de8c1c3,"view.component.Output.createRegister1Display","view/component/Output.hx",52,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
...
{
		HX_STACK_FRAME("view.component.Output","createRegister2Display",0x971b33e2,"view.component.Output.createRegister2Display","view/component/Output.hx",60,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(61)
		::openfl::_legacy::text::TextField _g = ::utilities::TextFieldFactory_obj::getOutputTFBold();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(61)
...
{
		HX_STACK_FRAME("view.component.Output","createAccumulatorDisplay",0x362525ab,"view.component.Output.createAccumulatorDisplay","view/component/Output.hx",68,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(69)
		::openfl::_legacy::text::TextField _g = ::utilities::TextFieldFactory_obj::getOutputTFBold();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(69)
...
{
		HX_STACK_FRAME("view.component.Output","setRegister1",0x32889ddf,"view.component.Output.setRegister1","view/component/Output.hx",80,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","setRegister2",0x32889de0,"view.component.Output.setRegister2","view/component/Output.hx",85,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(86)
...
{
		HX_STACK_FRAME("view.component.Output","setAccumulator",0x192ff4f7,"view.component.Output.setAccumulator","view/component/Output.hx",90,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("view.component.Output","powerOn",0x964f63f1,"view.component.Output.powerOn","view/component/Output.hx",99,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(100)
		this->ram->clear(null());
		HX_STACK_LINE(101)
...
{
		HX_STACK_FRAME("view.component.Output","powerOff",0xef28085d,"view.component.Output.powerOff","view/component/Output.hx",106,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(107)
		this->rom->clear(true);
		HX_STACK_LINE(108)
...
{
		HX_STACK_FRAME("view.component.Output","setProgramCountPointer",0x9d3bfd03,"view.component.Output.setProgramCountPointer","view/component/Output.hx",115,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","updateRam",0x318c3002,"view.component.Output.updateRam","view/component/Output.hx",119,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","resetRamPointer",0x6ba5ad9b,"view.component.Output.resetRamPointer","view/component/Output.hx",123,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(123)
...
{
		HX_STACK_FRAME("view.component.Output","setRamPointer",0x17f0bfee,"view.component.Output.setRamPointer","view/component/Output.hx",127,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_ARG(pointer,"pointer")
		HX_STACK_LINE(127)
...
{
		HX_STACK_FRAME("view.component.Output","resetRam",0x299d8742,"view.component.Output.resetRam","view/component/Output.hx",131,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(131)
		this->ram->clear(null());
	}
...
{
		HX_STACK_FRAME("view.component.Output","resetAll",0x2990aa85,"view.component.Output.resetAll","view/component/Output.hx",134,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(135)
		this->ram->clear(null());
		HX_STACK_LINE(136)
...
Dynamic Output_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 2:
		...
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"rom") ) { rom=inValue.Cast< ::view::component::RomRamDisplay >(); return inValue; }
		if (HX_FIELD_EQ(inName,"ram") ) { ram=inValue.Cast< ::view::component::RomRamDisplay >(); return inValue; }
		break;
	case 4:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::view::component::RomRamDisplay*/ ,(int)offsetof(Output_obj,rom),HX_CSTRING("rom")},
	{hx::fsObject /*::view::component::RomRamDisplay*/ ,(int)offsetof(Output_obj,ram),HX_CSTRING("ram")},
	{ hx::fsUnknown, 0, null()}
};
#endif
