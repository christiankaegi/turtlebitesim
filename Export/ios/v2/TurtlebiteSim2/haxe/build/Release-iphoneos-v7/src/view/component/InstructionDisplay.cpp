...
{
HX_STACK_FRAME("view.component.InstructionDisplay","new",0xb7142ca0,"view.component.InstructionDisplay.new","view/component/InstructionDisplay.hx",30,0xdd15284e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(31)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","addedToStageHandler",0xd048f3e7,"view.component.InstructionDisplay.addedToStageHandler","view/component/InstructionDisplay.hx",35,0xdd15284e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","bmpLoadCompleteHandler",0x9655ff06,"view.component.InstructionDisplay.bmpLoadCompleteHandler","view/component/InstructionDisplay.hx",49,0xdd15284e)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","createTfPointer",0x92de6b0f,"view.component.InstructionDisplay.createTfPointer","view/component/InstructionDisplay.hx",64,0xdd15284e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","createTfAssembler",0x5d11a9f2,"view.component.InstructionDisplay.createTfAssembler","view/component/InstructionDisplay.hx",79,0xdd15284e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","createTfMachine",0x04b7e5d9,"view.component.InstructionDisplay.createTfMachine","view/component/InstructionDisplay.hx",97,0xdd15284e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(98)
		::openfl::_legacy::text::TextField _g = this->getBasicTextField();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(98)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","createTfHex",0x2c6fdc2d,"view.component.InstructionDisplay.createTfHex","view/component/InstructionDisplay.hx",115,0xdd15284e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(116)
		::openfl::_legacy::text::TextField _g = this->getBasicTextField();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","createTfDescription",0x8452444e,"view.component.InstructionDisplay.createTfDescription","view/component/InstructionDisplay.hx",133,0xdd15284e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(134)
		::openfl::_legacy::text::TextField _g = ::openfl::_legacy::text::TextField_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("view.component.InstructionDisplay","setOutput",0xcef39083,"view.component.InstructionDisplay.setOutput","view/component/InstructionDisplay.hx",164,0xdd15284e)
		HX_STACK_THIS(this)
