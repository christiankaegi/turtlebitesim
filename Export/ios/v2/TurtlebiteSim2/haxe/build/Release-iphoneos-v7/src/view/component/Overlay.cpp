...
Void Overlay_obj::addedToStageHandler( ::openfl::_legacy::events::Event event){
{
		...
		HX_STACK_LINE(26)
		::openfl::_legacy::Assets_obj::loadBitmapData(((HX_CSTRING("assets/") + ::AppConstants_obj::ASSET_FOLDER) + HX_CSTRING("/MarkUnits2048.png")),this->markUnitsLoadCompleteHandler_dyn(),true);
	}
return null();
}
...
{
		HX_STACK_FRAME("view.component.Overlay","showUnits",0x856e473a,"view.component.Overlay.showUnits","view/component/Overlay.hx",47,0xc6ed03ca)
		HX_STACK_THIS(this)
		HX_STACK_LINE(48)
		this->hideUnits();
		HX_STACK_LINE(49)
...
{
		HX_STACK_FRAME("view.component.Overlay","hideUnits",0xb2689d55,"view.component.Overlay.hideUnits","view/component/Overlay.hx",52,0xc6ed03ca)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
...
{
		HX_STACK_FRAME("view.component.Overlay","showFlow",0x6f373c83,"view.component.Overlay.showFlow","view/component/Overlay.hx",58,0xc6ed03ca)
		HX_STACK_THIS(this)
		HX_STACK_LINE(59)
		this->hideFlow();
		HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("view.component.Overlay","hideFlow",0x607e62c8,"view.component.Overlay.hideFlow","view/component/Overlay.hx",63,0xc6ed03ca)
		HX_STACK_THIS(this)
		HX_STACK_LINE(64)
