...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(25)
		::openfl::_legacy::Lib_obj::setPackage(HX_CSTRING("Christian Kaegi"),HX_CSTRING("TurtlebiteSim2"),HX_CSTRING("net.kaegi.TurtlebiteSim2"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(38)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_2()),(int)0,(int)0,(int)30,(int)7303023,(int((int((int((int((int((int((int((int((int((int(::openfl::_legacy::Lib_obj::HARDWARE) | int(::openfl::_legacy::Lib_obj::ALLOW_SHADERS))) | int(::openfl::_legacy::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::_legacy::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::openfl::_legacy::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("TurtlebiteSim2"),null(),null());
	}
return null();
}
