...
Void SimpleRectangle_obj::__construct(Float width,Float height,Dynamic __o_color,Dynamic __o_alpha)
{
...
hx::ObjectPtr< SimpleRectangle_obj > SimpleRectangle_obj::__new(Float width,Float height,Dynamic __o_color,Dynamic __o_alpha)
{  hx::ObjectPtr< SimpleRectangle_obj > result = new SimpleRectangle_obj();
	result->__construct(width,height,__o_color,__o_alpha);
	return result;}
