...
Void LabelButton_obj::createBG( ){
{
		...
		if ((this->inactive)){
			...
			HX_STACK_LINE(56)
			::view::elements::SimpleRectangle _g = ::view::elements::SimpleRectangle_obj::__new(this->btnWidth,_Function_2_1::Block(),::view::elements::LabelButton_obj::BG_INACTIVE_COLOR,(int)1);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(56)
			this->bg = _g;
			HX_STACK_LINE(57)
			...
			HX_STACK_LINE(59)
			::view::elements::SimpleRectangle _g1 = ::view::elements::SimpleRectangle_obj::__new(this->btnWidth,_Function_2_1::Block(),::view::elements::LabelButton_obj::BG_COLOR,(int)1);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(59)
			this->bg = _g1;
			HX_STACK_LINE(60)
			this->addChild(this->bg);
			...
			HX_STACK_LINE(61)
			::view::elements::SimpleRectangle _g2 = ::view::elements::SimpleRectangle_obj::__new(this->btnWidth,_Function_2_2::Block(),::view::elements::LabelButton_obj::BG_COLOR_HIGHLIGHT,0.2);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(61)
			...
			HX_STACK_LINE(64)
			::view::elements::SimpleRectangle _g3 = ::view::elements::SimpleRectangle_obj::__new(this->btnWidth,_Function_2_3::Block(),::view::elements::LabelButton_obj::BG_COLOR_ACTIVE,(int)1);		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(64)
			this->bgActive = _g3;
			HX_STACK_LINE(65)
...
Void LabelButton_obj::createCheckbox( ){
{
		...
		HX_STACK_LINE(71)
		::view::elements::SimpleRectangle _g = ::view::elements::SimpleRectangle_obj::__new((_Function_1_1::Block() * 0.5),(_Function_1_2::Block() * 0.5),(int)16777215,0.2);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(71)
		...
		HX_STACK_LINE(76)
		::view::elements::SimpleRectangle _g1 = ::view::elements::SimpleRectangle_obj::__new((_Function_1_5::Block() * 0.5),(_Function_1_6::Block() * 0.5),::view::elements::LabelButton_obj::BG_COLOR_ACTIVE,(int)1);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(76)
...
Void LabelButton_obj::createLabel( ){
{
		...
		if ((this->hasCheckbox)){
			...
			struct _Function_2_1{
				inline static Float Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/elements/LabelButton.hx",95,0x10657ec6)
					{
						HX_STACK_LINE(95)
						int _int = ::view::elements::LabelButton_obj::BTN_HEIGHT;		HX_STACK_VAR(_int,"int");
						HX_STACK_LINE(95)
...
{
		HX_STACK_FRAME("view.elements.LabelButton","createClickArea",0xfeb5dfc3,"view.elements.LabelButton.createClickArea","view/elements/LabelButton.hx",106,0x10657ec6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(106)
		if ((!(this->inactive))){
			struct _Function_2_1{
				inline static Float Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/elements/LabelButton.hx",107,0x10657ec6)
					{
						HX_STACK_LINE(107)
						int _int = ::view::elements::LabelButton_obj::BTN_HEIGHT;		HX_STACK_VAR(_int,"int");
						HX_STACK_LINE(107)
			...
			HX_STACK_LINE(107)
			::view::elements::SimpleRectangle s = ::view::elements::SimpleRectangle_obj::__new(this->btnWidth,_Function_2_1::Block(),(int)0,(int)0);		HX_STACK_VAR(s,"s");
			HX_STACK_LINE(108)
...
{
		HX_STACK_FRAME("view.elements.LabelButton","buttonDownHandler",0x00ce23a0,"view.elements.LabelButton.buttonDownHandler","view/elements/LabelButton.hx",119,0x10657ec6)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::String &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/elements/LabelButton.hx",121,0x10657ec6)
				{
...
{
		HX_STACK_FRAME("view.elements.LabelButton","buttonUpHandler",0x499ea0c7,"view.elements.LabelButton.buttonUpHandler","view/elements/LabelButton.hx",125,0x10657ec6)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(125)
		this->bgHighlight->set_visible(false);
...
{
		HX_STACK_FRAME("view.elements.LabelButton","setLabel",0xe39d9f48,"view.elements.LabelButton.setLabel","view/elements/LabelButton.hx",129,0x10657ec6)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.elements.LabelButton","setActive",0x1316d9f2,"view.elements.LabelButton.setActive","view/elements/LabelButton.hx",133,0x10657ec6)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(133)
		if ((this->hasCheckbox)){
...
{
		HX_STACK_FRAME("view.elements.LabelButton","reset",0x26572fb9,"view.elements.LabelButton.reset","view/elements/LabelButton.hx",140,0x10657ec6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(141)
...
Dynamic LabelButton_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 2:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"tfLabel") ) { tfLabel=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::display::Sprite*/ ,(int)offsetof(LabelButton_obj,clickArea),HX_CSTRING("clickArea")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(LabelButton_obj,tfLabel),HX_CSTRING("tfLabel")},
