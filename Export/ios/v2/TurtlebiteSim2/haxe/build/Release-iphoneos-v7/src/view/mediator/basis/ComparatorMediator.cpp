...
{
		HX_STACK_FRAME("view.mediator.basis.ComparatorMediator","handleNotification",0xa1148336,"view.mediator.basis.ComparatorMediator.handleNotification","view/mediator/basis/ComparatorMediator.hx",31,0xa7522412)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.ComparatorMediator","viewReadyHandler",0x7e77056f,"view.mediator.basis.ComparatorMediator.viewReadyHandler","view/mediator/basis/ComparatorMediator.hx",47,0xa7522412)
		HX_STACK_THIS(this)
...
::view::component::basis::Comparator ComparatorMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.ComparatorMediator","getView",0x3edb7cb8,"view.mediator.basis.ComparatorMediator.getView","view/mediator/basis/ComparatorMediator.hx",51,0xa7522412)
	HX_STACK_THIS(this)
	HX_STACK_LINE(51)
