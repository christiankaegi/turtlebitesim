...
Void OpcodeALUCommand_obj::execute( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		...
		struct _Function_1_1{
			inline static Float Block( int &accu){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","controller/instruction/OpcodeALUCommand.hx",47,0xb11165db)
				{
					HX_STACK_LINE(47)
					int _int = accu;		HX_STACK_VAR(_int,"int");
					HX_STACK_LINE(47)
		...
		struct _Function_1_2{
			inline static Float Block( int &reg1){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","controller/instruction/OpcodeALUCommand.hx",47,0xb11165db)
				{
					HX_STACK_LINE(47)
					int _int = reg1;		HX_STACK_VAR(_int,"int");
					HX_STACK_LINE(47)
					return (  (((_int < (int)0))) ? Float((4294967296.0 + _int)) : Float((_int + 0.0)) );
				}
				return null();
		...
		HX_STACK_LINE(47)
		if (((_Function_1_1::Block(accu) == _Function_1_2::Block(reg1)))){
			HX_STACK_LINE(48)
