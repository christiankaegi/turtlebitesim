...
bool preserveDrawingBuffer = __o_preserveDrawingBuffer.Default(false);
{
	...
	HX_STACK_LINE(74)
	Dynamic _g2 = ::lime::graphics::opengl::GL_obj::lime_gl_get_parameter((int)36006);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(74)
	::lime::graphics::opengl::GLFramebuffer _g3 = ::lime::graphics::opengl::GLFramebuffer_obj::__new(_g1,_g2);		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(74)
	this->defaultFramebuffer = _g3;
	HX_STACK_LINE(79)
	...
	if (((::openfl::_internal::renderer::opengl::GLRenderer_obj::blendModesWebGL == null()))){
		HX_STACK_LINE(83)
		::haxe::ds::EnumValueMap _g4 = ::haxe::ds::EnumValueMap_obj::__new();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(83)
		::openfl::_internal::renderer::opengl::GLRenderer_obj::blendModesWebGL = _g4;
		HX_STACK_LINE(85)
	...
	HX_STACK_LINE(103)
	::openfl::geom::Matrix _g5 = ::openfl::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(103)
	this->projectionMatrix = _g5;
	HX_STACK_LINE(105)
	...
	HX_STACK_LINE(109)
	::openfl::geom::Point _g7 = ::openfl::geom::Point_obj::__new((int)0,(int)0);		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(109)
	this->offset = _g7;
	HX_STACK_LINE(111)
	...
	HX_STACK_LINE(114)
	::openfl::_internal::renderer::opengl::utils::ShaderManager _g8 = ::openfl::_internal::renderer::opengl::utils::ShaderManager_obj::__new(gl);		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(114)
	this->shaderManager = _g8;
	HX_STACK_LINE(115)
	::openfl::_internal::renderer::opengl::utils::SpriteBatch _g9 = ::openfl::_internal::renderer::opengl::utils::SpriteBatch_obj::__new(gl,null());		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(115)
	this->spriteBatch = _g9;
	HX_STACK_LINE(116)
	::openfl::_internal::renderer::opengl::utils::FilterManager _g10 = ::openfl::_internal::renderer::opengl::utils::FilterManager_obj::__new(gl,this->transparent);		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(116)
	this->filterManager = _g10;
	HX_STACK_LINE(117)
	::openfl::_internal::renderer::opengl::utils::StencilManager _g11 = ::openfl::_internal::renderer::opengl::utils::StencilManager_obj::__new(gl);		HX_STACK_VAR(_g11,"_g11");
	HX_STACK_LINE(117)
	this->stencilManager = _g11;
	HX_STACK_LINE(118)
	::openfl::_internal::renderer::opengl::utils::BlendModeManager _g12 = ::openfl::_internal::renderer::opengl::utils::BlendModeManager_obj::__new(gl);		HX_STACK_VAR(_g12,"_g12");
	HX_STACK_LINE(118)
	this->blendModeManager = _g12;
	HX_STACK_LINE(120)
	::openfl::_internal::renderer::RenderSession _g13 = ::openfl::_internal::renderer::RenderSession_obj::__new();		HX_STACK_VAR(_g13,"_g13");
	HX_STACK_LINE(120)
	this->renderSession = _g13;
	HX_STACK_LINE(121)
	...
	HX_STACK_LINE(133)
	::openfl::_internal::renderer::opengl::utils::GLMaskManager _g14 = ::openfl::_internal::renderer::opengl::utils::GLMaskManager_obj::__new(this->renderSession);		HX_STACK_VAR(_g14,"_g14");
	HX_STACK_LINE(133)
	this->maskManager = _g14;
	HX_STACK_LINE(134)
	this->renderSession->maskManager = this->maskManager;
	HX_STACK_LINE(136)
...
Void GLRenderer_obj::handleContextRestored( ){
{
		...
		HX_STACK_LINE(256)
		Dynamic _g1 = ::lime::graphics::opengl::GL_obj::lime_gl_get_parameter((int)36006);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(256)
		::lime::graphics::opengl::GLFramebuffer _g2 = ::lime::graphics::opengl::GLFramebuffer_obj::__new(_g,_g1);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(256)
		this->defaultFramebuffer = _g2;
		HX_STACK_LINE(261)
		::lime::graphics::opengl::GL_obj::lime_gl_disable(gl->DEPTH_TEST);
		HX_STACK_LINE(262)
		::lime::graphics::opengl::GL_obj::lime_gl_disable(gl->CULL_FACE);
