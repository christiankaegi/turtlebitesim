...
::String Uniform_Impl__obj::PatternMatrix;

::String Uniform_Impl__obj::PatternTL;

::String Uniform_Impl__obj::PatternBR;
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("PatternMatrix"),
	HX_CSTRING("PatternTL"),
	HX_CSTRING("PatternBR"),
	HX_CSTRING("Sampler"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Uniform_Impl__obj::PatternMatrix,"PatternMatrix");
	HX_MARK_MEMBER_NAME(Uniform_Impl__obj::PatternTL,"PatternTL");
	HX_MARK_MEMBER_NAME(Uniform_Impl__obj::PatternBR,"PatternBR");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Uniform_Impl__obj::PatternMatrix,"PatternMatrix");
	HX_VISIT_MEMBER_NAME(Uniform_Impl__obj::PatternTL,"PatternTL");
	HX_VISIT_MEMBER_NAME(Uniform_Impl__obj::PatternBR,"PatternBR");
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._internal.renderer.opengl.shaders2._PatternFillShader.Uniform_Impl_"), hx::TCanCast< Uniform_Impl__obj> ,sStaticFields,sMemberFields,
...
void Uniform_Impl__obj::__boot()
{
	...
	PatternMatrix= HX_CSTRING("uPatternMatrix");
	PatternTL= HX_CSTRING("uPatternTL");
	PatternBR= HX_CSTRING("uPatternBR");
