...
Void TransformActuator_obj::setField_openfl__legacy_geom_Transform( ::openfl::_legacy::geom::Transform target,::String propertyName,Dynamic value){
{
		HX_STACK_FRAME("motion.actuators.TransformActuator","setField_openfl__legacy_geom_Transform",0xfdb7e83d,"motion.actuators.TransformActuator.setField_openfl__legacy_geom_Transform","motion/actuators/SimpleActuator.hx",319,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(target,"target")
...
HX_DEFINE_DYNAMIC_FUNC3(TransformActuator_obj,setField_openfl__legacy_geom_Transform,(void))
...
{
		HX_STACK_FRAME("motion.actuators.TransformActuator","setField_motion_actuators_TransformActuator_T",0x9a29d91e,"motion.actuators.TransformActuator.setField_motion_actuators_TransformActuator_T","motion/actuators/SimpleActuator.hx",319,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(target,"target")
		HX_STACK_ARG(propertyName,"propertyName")
		HX_STACK_ARG(value,"value")
...
Void TransformActuator_obj::apply( ){
{
		...
		if (((this->endColorTransform != null()))){
			HX_STACK_LINE(34)
			::openfl::_legacy::geom::Transform transform;		HX_STACK_VAR(transform,"transform");
			HX_STACK_LINE(34)
			{
				HX_STACK_LINE(34)
...
Void TransformActuator_obj::initialize( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(50)
		if (((  ((::Reflect_obj::hasField(this->properties,HX_CSTRING("colorValue")))) ? bool(::Std_obj::is(this->target,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >())) : bool(false) ))){
			HX_STACK_LINE(52)
...
Void TransformActuator_obj::initializeColor( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		::openfl::_legacy::geom::ColorTransform _g = ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(70)
		...
		HX_STACK_LINE(128)
		::openfl::_legacy::geom::ColorTransform begin;		HX_STACK_VAR(begin,"begin");
		struct _Function_1_1{
			inline static Dynamic Block( ::openfl::_legacy::geom::Transform &transform){
		...
		HX_STACK_LINE(129)
		::openfl::_legacy::geom::ColorTransform _g8 = ::openfl::_legacy::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(129)
		...
		HX_STACK_LINE(134)
		{
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::String &propertyName,::openfl::_legacy::geom::ColorTransform &begin){
				...
				{
					HX_STACK_LINE(137)
					::openfl::_legacy::geom::ColorTransform target = this->endColorTransform;		HX_STACK_VAR(target,"target");
					HX_STACK_LINE(137)
					Dynamic value = null();		HX_STACK_VAR(value,"value");
					HX_STACK_LINE(137)
					if ((::Reflect_obj::hasField(target,propertyName))){
...
Dynamic TransformActuator_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 19:
		...
		break;
	case 38:
		if (HX_FIELD_EQ(inName,"setField_openfl__legacy_geom_Transform") ) { return setField_openfl__legacy_geom_Transform_dyn(); }
		break;
	case 45:
...
Dynamic TransformActuator_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"endColorTransform") ) { endColorTransform=inValue.Cast< ::openfl::_legacy::geom::ColorTransform >(); return inValue; }
		if (HX_FIELD_EQ(inName,"endSoundTransform") ) { endSoundTransform=inValue.Cast< ::openfl::media::SoundTransform >(); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"tweenColorTransform") ) { tweenColorTransform=inValue.Cast< ::openfl::_legacy::geom::ColorTransform >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,endColorTransform),HX_CSTRING("endColorTransform")},
	...
	{hx::fsObject /*::openfl::_legacy::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,tweenColorTransform),HX_CSTRING("tweenColorTransform")},
...
static ::String sMemberFields[] = {
	HX_CSTRING("setField_openfl__legacy_geom_Transform"),
