...
#define INCLUDED_view_mediator_basis_ProgramcounterMediator
...
HX_DECLARE_CLASS3(view,component,basis,Programcounter)
HX_DECLARE_CLASS3(view,mediator,basis,ProgramcounterMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  ProgramcounterMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		Void __construct(::view::component::basis::Programcounter viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< ProgramcounterMediator_obj > __new(::view::component::basis::Programcounter viewComponent);
		...
		virtual ::view::component::basis::Programcounter getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_ProgramcounterMediator */ 
