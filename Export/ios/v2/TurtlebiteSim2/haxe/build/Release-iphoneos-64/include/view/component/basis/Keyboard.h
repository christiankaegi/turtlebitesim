...
#define INCLUDED_view_component_basis_Keyboard
...
class HXCPP_CLASS_ATTRIBUTES  Keyboard_obj : public ::openfl::_legacy::display::Sprite_obj{
	public:
...
#endif /* INCLUDED_view_component_basis_Keyboard */ 
