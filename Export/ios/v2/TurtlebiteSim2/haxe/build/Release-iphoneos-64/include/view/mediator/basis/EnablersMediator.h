...
#define INCLUDED_view_mediator_basis_EnablersMediator
...
HX_DECLARE_CLASS3(view,component,basis,Enablers)
HX_DECLARE_CLASS3(view,mediator,basis,EnablersMediator)
namespace view{
namespace mediator{
namespace basis{


class HXCPP_CLASS_ATTRIBUTES  EnablersMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef EnablersMediator_obj OBJ_;
		EnablersMediator_obj();
		Void __construct(::view::component::basis::Enablers viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< EnablersMediator_obj > __new(::view::component::basis::Enablers viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("EnablersMediator"); }
		...
		virtual ::view::component::basis::Enablers getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_EnablersMediator */ 
