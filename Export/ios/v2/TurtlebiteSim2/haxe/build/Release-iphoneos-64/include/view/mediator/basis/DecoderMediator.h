...
#define INCLUDED_view_mediator_basis_DecoderMediator
...
HX_DECLARE_CLASS3(view,mediator,basis,DecoderMediator)
namespace view{
namespace mediator{
namespace basis{


class HXCPP_CLASS_ATTRIBUTES  DecoderMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef DecoderMediator_obj OBJ_;
		DecoderMediator_obj();
		Void __construct(::view::component::basis::Decoder viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< DecoderMediator_obj > __new(::view::component::basis::Decoder viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("DecoderMediator"); }
		...
		virtual ::view::component::basis::Decoder getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_DecoderMediator */ 
