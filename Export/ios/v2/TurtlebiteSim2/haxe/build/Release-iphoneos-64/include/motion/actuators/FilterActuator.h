...
class HXCPP_CLASS_ATTRIBUTES  FilterActuator_obj : public ::motion::actuators::SimpleActuator_obj{
	public:
		...
		FilterActuator_obj();
		Void __construct(::openfl::_legacy::display::DisplayObject target,Float duration,Dynamic properties);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< FilterActuator_obj > __new(::openfl::_legacy::display::DisplayObject target,Float duration,Dynamic properties);
		...
		virtual Void setField_openfl__legacy_display_DisplayObject( ::openfl::_legacy::display::DisplayObject target,::String propertyName,Dynamic value);
		Dynamic setField_openfl__legacy_display_DisplayObject_dyn();

		::openfl::_legacy::filters::BitmapFilter filter;
		::Class filterClass;
		int filterIndex;
		virtual Void apply( );
