...
#define INCLUDED_view_mediator_basis_ComparatorsMediator
...
HX_DECLARE_CLASS3(view,mediator,basis,ComparatorsMediator)
namespace view{
namespace mediator{
namespace basis{


class HXCPP_CLASS_ATTRIBUTES  ComparatorsMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef ComparatorsMediator_obj OBJ_;
		ComparatorsMediator_obj();
		Void __construct(::view::component::basis::Comparators viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< ComparatorsMediator_obj > __new(::view::component::basis::Comparators viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("ComparatorsMediator"); }
		...
		virtual ::view::component::basis::Comparators getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_ComparatorsMediator */ 
