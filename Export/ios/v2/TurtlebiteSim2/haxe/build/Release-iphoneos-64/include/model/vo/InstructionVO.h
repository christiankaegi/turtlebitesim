...
class HXCPP_CLASS_ATTRIBUTES  InstructionVO_obj : public hx::Object{
	public:
		...
		InstructionVO_obj();
		Void __construct(int pointer,::String _asm_,::String code,::String description);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< InstructionVO_obj > __new(int pointer,::String _asm_,::String code,::String description);
