...
#define INCLUDED_view_component_basis_Enablers
...
class HXCPP_CLASS_ATTRIBUTES  Enablers_obj : public ::openfl::_legacy::display::Sprite_obj{
	public:
		typedef ::openfl::_legacy::display::Sprite_obj super;
		typedef Enablers_obj OBJ_;
		Enablers_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< Enablers_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("Enablers"); }
...
#endif /* INCLUDED_view_component_basis_Enablers */ 
