...
{
		HX_STACK_FRAME("App","addZoomView",0x2cfc62ec,"App.addZoomView","App.hx",34,0xc43e94dd)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("App","addNavigView",0x72b39832,"App.addNavigView","App.hx",38,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(view,"view")
		HX_STACK_LINE(38)
...
{
		HX_STACK_FRAME("App","mouseDownHandler",0xc10a8ff0,"App.mouseDownHandler","App.hx",42,0xc43e94dd)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("App","mouseUpHandler",0xf3c05917,"App.mouseUpHandler","App.hx",48,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(48)
		if ((this->isZoomed)){
...
{
		HX_STACK_FRAME("App","dragStart",0x4eb12da1,"App.dragStart","App.hx",54,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(54)
...
{
		HX_STACK_FRAME("App","dragStop",0x453b63a3,"App.dragStop","App.hx",58,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(58)
...
Void App_obj::zoomIn( ){
{
		HX_STACK_FRAME("App","zoomIn",0x9629b225,"App.zoomIn","App.hx",61,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(62)
		this->isZoomed = true;
		HX_STACK_LINE(63)
...
{
		HX_STACK_FRAME("App","resetZoom",0xff34f655,"App.resetZoom","App.hx",69,0xc43e94dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		this->isZoomed = false;
		HX_STACK_LINE(71)
