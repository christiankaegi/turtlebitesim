...
::openfl::_legacy::text::TextField RomRow_obj::getBasicTextField( ){
...
{
		HX_STACK_FRAME("view.elements.RomRow","populate",0x6d1ec6c0,"view.elements.RomRow.populate","view/elements/RomRow.hx",95,0x978cca86)
		HX_STACK_THIS(this)
		HX_STACK_ARG(instruction,"instruction")
		HX_STACK_LINE(96)
...
{
		HX_STACK_FRAME("view.elements.RomRow","destroy",0x3b6b71e4,"view.elements.RomRow.destroy","view/elements/RomRow.hx",104,0x978cca86)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
...
Dynamic RomRow_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"tfHex") ) { tfHex=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"tfCode") ) { tfCode=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"tfOpcode") ) { tfOpcode=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"tfPointer") ) { tfPointer=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tfAddress") ) { tfAddress=inValue.Cast< ::openfl::_legacy::text::TextField >(); return inValue; }
		break;
	case 13:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfPointer),HX_CSTRING("tfPointer")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfOpcode),HX_CSTRING("tfOpcode")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfAddress),HX_CSTRING("tfAddress")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfCode),HX_CSTRING("tfCode")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfHex),HX_CSTRING("tfHex")},
	{hx::fsObject /*::openfl::_legacy::text::TextField*/ ,(int)offsetof(RomRow_obj,tfDescription),HX_CSTRING("tfDescription")},
	{ hx::fsUnknown, 0, null()}
};
#endif
