...
Array< ::String > MainMenuMediator_obj::listNotificationInterests( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::CLOCK_ON).Add(::AppConstants_obj::PAUSE).Add(::AppConstants_obj::MANUAL_MODE_ON).Add(::AppConstants_obj::MODEL_RESET_COMPLETE);
}


Void MainMenuMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.MainMenuMediator","handleNotification",0xf70df844,"view.mediator.MainMenuMediator.handleNotification","view/mediator/MainMenuMediator.hx",42,0x5d24b2c1)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.MainMenuMediator","dataEventHandler",0xb6c2ff6b,"view.mediator.MainMenuMediator.dataEventHandler","view/mediator/MainMenuMediator.hx",69,0x5d24b2c1)
		HX_STACK_THIS(this)
		...
		if (  ( _switch_2==HX_CSTRING("resetButton"))){
			...
			if ((this->appProxy->getAutoClockOn())){
				...
				HX_STACK_LINE(104)
				this->appProxy->setAutoClockOn(true);
				HX_STACK_LINE(105)
				this->getView()->setPlay(true);
				HX_STACK_LINE(106)
				this->clockProxy->startClock();
			}
		}
...
{
		HX_STACK_FRAME("view.mediator.MainMenuMediator","resetSubmenus",0x0d8e0d72,"view.mediator.MainMenuMediator.resetSubmenus","view/mediator/MainMenuMediator.hx",188,0x5d24b2c1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_LINE(189)
		this->getView()->setHertzActive(false,null());
...
{
		HX_STACK_FRAME("view.mediator.MainMenuMediator","viewReadyHandler",0x9dbd7afd,"view.mediator.MainMenuMediator.viewReadyHandler","view/mediator/MainMenuMediator.hx",199,0x5d24b2c1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(200)
		this->getView()->setHertz(this->clockProxy->getCurrentFrequency()->label);
...
::view::component::MainMenu MainMenuMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.MainMenuMediator","getView",0x61b1f0ea,"view.mediator.MainMenuMediator.getView","view/mediator/MainMenuMediator.hx",206,0x5d24b2c1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(206)
