...
{
		HX_STACK_FRAME("view.mediator.basis.DecoderMediator","handleNotification",0x6067dc0c,"view.mediator.basis.DecoderMediator.handleNotification","view/mediator/basis/DecoderMediator.hx",32,0x2378be8a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.DecoderMediator","viewReadyHandler",0xfc055cc5,"view.mediator.basis.DecoderMediator.viewReadyHandler","view/mediator/basis/DecoderMediator.hx",54,0x2378be8a)
		HX_STACK_THIS(this)
...
::view::component::basis::Decoder DecoderMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.DecoderMediator","getView",0xce0d6822,"view.mediator.basis.DecoderMediator.getView","view/mediator/basis/DecoderMediator.hx",58,0x2378be8a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(58)
