...
{
HX_STACK_FRAME("controller.EditRomCommand","new",0x58537fe9,"controller.EditRomCommand.new","controller/EditRomCommand.hx",11,0xa36e9e86)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(11)
	super::__construct();
...
{
		HX_STACK_FRAME("controller.EditRomCommand","execute",0x90f5b23e,"controller.EditRomCommand.execute","controller/EditRomCommand.hx",14,0xa36e9e86)
		HX_STACK_THIS(this)
