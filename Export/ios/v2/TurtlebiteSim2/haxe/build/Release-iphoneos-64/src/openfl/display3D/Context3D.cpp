...
Void Context3D_obj::present( ){
{
		...
		if (((this->framebuffer != null()))){
			HX_STACK_LINE(294)
			::openfl::_legacy::gl::GLFramebuffer framebuffer = null();		HX_STACK_VAR(framebuffer,"framebuffer");
			HX_STACK_LINE(294)
			if (((framebuffer == null()))){
				HX_STACK_LINE(294)
				framebuffer = ::openfl::_legacy::gl::GL_obj::defaultFramebuffer;
			}
			HX_STACK_LINE(294)
	...
	HX_STACK_ARG(surfaceSelector,"surfaceSelector")
{
		...
		HX_STACK_LINE(668)
		::openfl::_legacy::gl::GL_obj::lime_gl_renderbuffer_storage((int)36161,(int)35056,texture->width,texture->height);
		HX_STACK_LINE(672)
