...
Void Timer_obj::stop( ){
{
		HX_STACK_FRAME("motion.actuators.Timer","stop",0x7b216177,"motion.actuators.Timer.stop","motion/actuators/SimpleActuator.hx",645,0x731927e5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(645)
		if ((this->mRunning)){
			HX_STACK_LINE(647)
...
Float Timer_obj::stamp( ){
	HX_STACK_FRAME("motion.actuators.Timer","stamp",0x420944ee,"motion.actuators.Timer.stamp","motion/actuators/SimpleActuator.hx",679,0x731927e5)
	HX_STACK_LINE(679)
