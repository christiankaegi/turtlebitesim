...
Void EffectsOptions_obj::__construct(::openfl::_legacy::display::DisplayObject target,Float duration,bool overwrite)
{
...
hx::ObjectPtr< EffectsOptions_obj > EffectsOptions_obj::__new(::openfl::_legacy::display::DisplayObject target,Float duration,bool overwrite)
...
Dynamic EffectsOptions_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"target") ) { target=inValue.Cast< ::openfl::_legacy::display::DisplayObject >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::display::DisplayObject*/ ,(int)offsetof(EffectsOptions_obj,target),HX_CSTRING("target")},
	{ hx::fsUnknown, 0, null()}
};
#endif
