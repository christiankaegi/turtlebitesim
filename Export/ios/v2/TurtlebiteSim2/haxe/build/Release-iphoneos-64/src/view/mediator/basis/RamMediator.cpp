...
{
HX_STACK_FRAME("view.mediator.basis.RamMediator","new",0xdeb4a941,"view.mediator.basis.RamMediator.new","view/mediator/basis/RamMediator.hx",15,0x02ef40f0)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.RamMediator","onRegister",0x3196efe1,"view.mediator.basis.RamMediator.onRegister","view/mediator/basis/RamMediator.hx",18,0x02ef40f0)
		HX_STACK_THIS(this)
		HX_STACK_LINE(19)
		...
		HX_STACK_LINE(21)
		::view::component::basis::Ram _g1 = this->getView();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(21)
...
Array< ::String > RamMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.RamMediator","listNotificationInterests",0xb69b1281,"view.mediator.basis.RamMediator.listNotificationInterests","view/mediator/basis/RamMediator.hx",25,0x02ef40f0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
...
{
		HX_STACK_FRAME("view.mediator.basis.RamMediator","handleNotification",0xabcbeef2,"view.mediator.basis.RamMediator.handleNotification","view/mediator/basis/RamMediator.hx",33,0x02ef40f0)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.RamMediator","viewReadyHandler",0x6a26ca2b,"view.mediator.basis.RamMediator.viewReadyHandler","view/mediator/basis/RamMediator.hx",48,0x02ef40f0)
		HX_STACK_THIS(this)
...
::view::component::basis::Ram RamMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.RamMediator","getView",0xc9a73f7c,"view.mediator.basis.RamMediator.getView","view/mediator/basis/RamMediator.hx",52,0x02ef40f0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(52)
