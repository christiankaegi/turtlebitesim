...
{
HX_STACK_FRAME("view.mediator.basis.AluMediator","new",0x85758e8d,"view.mediator.basis.AluMediator.new","view/mediator/basis/AluMediator.hx",16,0x22ad8924)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.AluMediator","onRegister",0xfde68c15,"view.mediator.basis.AluMediator.onRegister","view/mediator/basis/AluMediator.hx",19,0x22ad8924)
		HX_STACK_THIS(this)
		HX_STACK_LINE(20)
		...
		HX_STACK_LINE(22)
		::view::component::basis::Alu _g1 = this->getView();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(22)
...
Array< ::String > AluMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.AluMediator","listNotificationInterests",0xea0350cd,"view.mediator.basis.AluMediator.listNotificationInterests","view/mediator/basis/AluMediator.hx",26,0x22ad8924)
	HX_STACK_THIS(this)
	HX_STACK_LINE(26)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::BROADCAST_ALU).Add(::AppConstants_obj::ALU_OUT_ACTIVE).Add(::AppConstants_obj::ALU_EQUAL_ON).Add(::AppConstants_obj::ALU_EQUAL_OFF).Add(::AppConstants_obj::MODEL_RESET_COMPLETE);
}


Void AluMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.basis.AluMediator","handleNotification",0xd420df26,"view.mediator.basis.AluMediator.handleNotification","view/mediator/basis/AluMediator.hx",35,0x22ad8924)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(38)
		{
			...
			HX_STACK_LINE(38)
			::String _switch_1 = (_g);
			if (  ( _switch_1==::AppConstants_obj::BROADCAST_ALU)){
				HX_STACK_LINE(41)
...
{
		HX_STACK_FRAME("view.mediator.basis.AluMediator","viewReadyHandler",0x626f855f,"view.mediator.basis.AluMediator.viewReadyHandler","view/mediator/basis/AluMediator.hx",57,0x22ad8924)
		HX_STACK_THIS(this)
...
::view::component::basis::Alu AluMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.AluMediator","getView",0x55b2bac8,"view.mediator.basis.AluMediator.getView","view/mediator/basis/AluMediator.hx",61,0x22ad8924)
	HX_STACK_THIS(this)
	HX_STACK_LINE(61)
