...
{
HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","new",0xf97fe6b8,"view.mediator.basis.MultiplexerMediator.new","view/mediator/basis/MultiplexerMediator.hx",17,0x2588a859)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","onRegister",0x71d05f4a,"view.mediator.basis.MultiplexerMediator.onRegister","view/mediator/basis/MultiplexerMediator.hx",20,0x2588a859)
		HX_STACK_THIS(this)
		HX_STACK_LINE(21)
		...
		HX_STACK_LINE(23)
		::view::component::basis::Multiplexer _g1 = this->getView();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(23)
...
Array< ::String > MultiplexerMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","listNotificationInterests",0x33176138,"view.mediator.basis.MultiplexerMediator.listNotificationInterests","view/mediator/basis/MultiplexerMediator.hx",27,0x2588a859)
	HX_STACK_THIS(this)
	HX_STACK_LINE(27)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::CLOCK_ON).Add(::AppConstants_obj::CLOCK_OFF).Add(::AppConstants_obj::MODEL_RESET_COMPLETE);
}


Void MultiplexerMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","handleNotification",0x7e906f5b,"view.mediator.basis.MultiplexerMediator.handleNotification","view/mediator/basis/MultiplexerMediator.hx",35,0x2588a859)
		HX_STACK_THIS(this)
			...
			if (((bool((bool((bool((opcode == ::AppConstants_obj::OPCODE_MOV)) || bool((opcode == ::AppConstants_obj::OPCODE_SDA)))) || bool((opcode == ::AppConstants_obj::OPCODE_INP)))) || bool((opcode == ::AppConstants_obj::OPCODE_OUT))))){
				HX_STACK_LINE(42)
				{
					...
					if (  ( _switch_2==::AppConstants_obj::MULTIPLEXER_ACCUMULATOR)){
						...
						codeArr = _g2;
						HX_STACK_LINE(46)
						this->sendNotification(::AppConstants_obj::UPDATE_DETAIL_ACCUMULATOR_LINES,codeArr,null());
					}
...
{
		HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","viewReadyHandler",0xf7eb2e54,"view.mediator.basis.MultiplexerMediator.viewReadyHandler","view/mediator/basis/MultiplexerMediator.hx",65,0x2588a859)
		HX_STACK_THIS(this)
...
::view::component::basis::Multiplexer MultiplexerMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.MultiplexerMediator","getView",0x9c040473,"view.mediator.basis.MultiplexerMediator.getView","view/mediator/basis/MultiplexerMediator.hx",69,0x2588a859)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
