...
{
HX_STACK_FRAME("view.component.basis.Clock","new",0xd1a160f6,"view.component.basis.Clock.new","view/component/basis/Clock.hx",14,0x9b38b2fd)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(15)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.basis.Clock","addedToStageHandler",0x1966b43d,"view.component.basis.Clock.addedToStageHandler","view/component/basis/Clock.hx",19,0x9b38b2fd)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Clock","outLoadCompleteHandler",0xde1025c7,"view.component.basis.Clock.outLoadCompleteHandler","view/component/basis/Clock.hx",24,0x9b38b2fd)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Clock","showLines",0x5cd368d8,"view.component.basis.Clock.showLines","view/component/basis/Clock.hx",31,0x9b38b2fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("view.component.basis.Clock","hideAllLines",0xdb0dccaa,"view.component.basis.Clock.hideAllLines","view/component/basis/Clock.hx",34,0x9b38b2fd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(35)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("view.component.basis.Clock"), hx::TCanCast< Clock_obj> ,sStaticFields,sMemberFields,
