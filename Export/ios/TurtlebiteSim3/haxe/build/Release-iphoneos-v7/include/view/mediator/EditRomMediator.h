...
#define INCLUDED_view_mediator_EditRomMediator
...
HX_DECLARE_CLASS2(view,mediator,EditRomMediator)
namespace view{
namespace mediator{


class HXCPP_CLASS_ATTRIBUTES  EditRomMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef EditRomMediator_obj OBJ_;
		EditRomMediator_obj();
		Void __construct(::view::component::EditRom viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< EditRomMediator_obj > __new(::view::component::EditRom viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("EditRomMediator"); }

		::model::proxy::ProgramProxy programProxy;
		int newProgramPointer;
...
#endif /* INCLUDED_view_mediator_EditRomMediator */ 
