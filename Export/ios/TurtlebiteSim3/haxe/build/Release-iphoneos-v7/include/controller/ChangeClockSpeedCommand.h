...
#define INCLUDED_controller_ChangeClockSpeedCommand
...
HX_DECLARE_CLASS1(controller,ChangeClockSpeedCommand)
...
#endif /* INCLUDED_controller_ChangeClockSpeedCommand */ 
