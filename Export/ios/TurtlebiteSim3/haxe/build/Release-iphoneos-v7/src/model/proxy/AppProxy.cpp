...
{
HX_STACK_FRAME("model.proxy.AppProxy","new",0xced73144,"model.proxy.AppProxy.new","model/proxy/AppProxy.hx",15,0xb57eff2a)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","onRegister",0xe1ecbe3e,"model.proxy.AppProxy.onRegister","model/proxy/AppProxy.hx",19,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(19)
...
::App AppProxy_obj::getApp( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getApp",0x93a67b47,"model.proxy.AppProxy.getApp","model/proxy/AppProxy.hx",23,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(23)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setStarted",0xbb90915b,"model.proxy.AppProxy.setStarted","model/proxy/AppProxy.hx",27,0xb57eff2a)
		HX_STACK_THIS(this)
...
bool AppProxy_obj::getStarted( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getStarted",0xb812f2e7,"model.proxy.AppProxy.getStarted","model/proxy/AppProxy.hx",31,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
bool AppProxy_obj::getIsZoomed( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getIsZoomed",0x68f86956,"model.proxy.AppProxy.getIsZoomed","model/proxy/AppProxy.hx",35,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setIsZoomed",0x73657062,"model.proxy.AppProxy.setIsZoomed","model/proxy/AppProxy.hx",39,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(39)
...
bool AppProxy_obj::getHertzSubmenuOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getHertzSubmenuOn",0xf0115e1d,"model.proxy.AppProxy.getHertzSubmenuOn","model/proxy/AppProxy.hx",43,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setHertzSubmenuOn",0x137f3629,"model.proxy.AppProxy.setHertzSubmenuOn","model/proxy/AppProxy.hx",47,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(47)
...
bool AppProxy_obj::getComponentsSubmenuOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getComponentsSubmenuOn",0x0f13bcce,"model.proxy.AppProxy.getComponentsSubmenuOn","model/proxy/AppProxy.hx",51,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(51)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setComponentsSubmenuOn",0x42bf3942,"model.proxy.AppProxy.setComponentsSubmenuOn","model/proxy/AppProxy.hx",55,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(55)
...
bool AppProxy_obj::getShowUnitsOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getShowUnitsOn",0x84d85997,"model.proxy.AppProxy.getShowUnitsOn","model/proxy/AppProxy.hx",59,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(59)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setShowUnitsOn",0xa4f8420b,"model.proxy.AppProxy.setShowUnitsOn","model/proxy/AppProxy.hx",63,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(63)
...
bool AppProxy_obj::getShowFlowOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getShowFlowOn",0x65e09ba4,"model.proxy.AppProxy.getShowFlowOn","model/proxy/AppProxy.hx",67,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setShowFlowOn",0xaae67db0,"model.proxy.AppProxy.setShowFlowOn","model/proxy/AppProxy.hx",71,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(71)
...
bool AppProxy_obj::getPowerOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getPowerOn",0xddc1262a,"model.proxy.AppProxy.getPowerOn","model/proxy/AppProxy.hx",75,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setPowerOn",0xe13ec49e,"model.proxy.AppProxy.setPowerOn","model/proxy/AppProxy.hx",79,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(79)
...
bool AppProxy_obj::getAutoClockOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getAutoClockOn",0x3e0c1784,"model.proxy.AppProxy.getAutoClockOn","model/proxy/AppProxy.hx",83,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(83)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setAutoClockOn",0x5e2bfff8,"model.proxy.AppProxy.setAutoClockOn","model/proxy/AppProxy.hx",87,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(87)
...
bool AppProxy_obj::getShowHighlightOn( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getShowHighlightOn",0x4a740a1c,"model.proxy.AppProxy.getShowHighlightOn","model/proxy/AppProxy.hx",91,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setShowHightlightOn",0x8f834446,"model.proxy.AppProxy.setShowHightlightOn","model/proxy/AppProxy.hx",95,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(95)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","reset",0xe590abb3,"model.proxy.AppProxy.reset","model/proxy/AppProxy.hx",98,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(99)
...
bool AppProxy_obj::getDetailPopupActive( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getDetailPopupActive",0x9b81cb27,"model.proxy.AppProxy.getDetailPopupActive","model/proxy/AppProxy.hx",104,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setDetailPopupActive",0x6839829b,"model.proxy.AppProxy.setDetailPopupActive","model/proxy/AppProxy.hx",108,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(108)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setCharCodeActive",0x7026c06f,"model.proxy.AppProxy.setCharCodeActive","model/proxy/AppProxy.hx",112,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(112)
...
bool AppProxy_obj::getCharCodeActive( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getCharCodeActive",0x4cb8e863,"model.proxy.AppProxy.getCharCodeActive","model/proxy/AppProxy.hx",116,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setEnterInstructionActive",0x504a4762,"model.proxy.AppProxy.setEnterInstructionActive","model/proxy/AppProxy.hx",120,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(120)
...
bool AppProxy_obj::getEnterInstructionActive( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getEnterInstructionActive",0xe3f38356,"model.proxy.AppProxy.getEnterInstructionActive","model/proxy/AppProxy.hx",124,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
...
{
		HX_STACK_FRAME("model.proxy.AppProxy","setEnterInstructionOutputValid",0xa57ff71f,"model.proxy.AppProxy.setEnterInstructionOutputValid","model/proxy/AppProxy.hx",128,0xb57eff2a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(on,"on")
		HX_STACK_LINE(128)
...
bool AppProxy_obj::getEnterInstructionOutputValid( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getEnterInstructionOutputValid",0xca94e6ab,"model.proxy.AppProxy.getEnterInstructionOutputValid","model/proxy/AppProxy.hx",132,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(132)
...
Dynamic AppProxy_obj::getData( ){
	HX_STACK_FRAME("model.proxy.AppProxy","getData",0x9ff5a8c4,"model.proxy.AppProxy.getData","model/proxy/AppProxy.hx",136,0xb57eff2a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(136)
	return this->data;
}
