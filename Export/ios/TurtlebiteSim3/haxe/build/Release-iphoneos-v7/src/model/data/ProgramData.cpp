...
{
HX_STACK_FRAME("model.data.ProgramData","new",0xb4473541,"model.data.ProgramData.new","model/data/ProgramData.hx",19,0x726d31af)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(20)
...
::model::vo::InstructionVO ProgramData_obj::getInstruction( int pointer){
	HX_STACK_FRAME("model.data.ProgramData","getInstruction",0x151c7dd7,"model.data.ProgramData.getInstruction","model/data/ProgramData.hx",97,0x726d31af)
	HX_STACK_THIS(this)
...
Array< ::Dynamic > ProgramData_obj::getCurrentInstructions( ){
	HX_STACK_FRAME("model.data.ProgramData","getCurrentInstructions",0x34d2a947,"model.data.ProgramData.getCurrentInstructions","model/data/ProgramData.hx",101,0x726d31af)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
...
Array< ::Dynamic > ProgramData_obj::getInstructionsByProgramPointer( int pointer){
	HX_STACK_FRAME("model.data.ProgramData","getInstructionsByProgramPointer",0x8ac43dac,"model.data.ProgramData.getInstructionsByProgramPointer","model/data/ProgramData.hx",105,0x726d31af)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pointer,"pointer")
	HX_STACK_LINE(105)
