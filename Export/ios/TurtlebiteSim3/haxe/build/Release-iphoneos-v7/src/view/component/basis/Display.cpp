...
{
HX_STACK_FRAME("view.component.basis.Display","new",0xb79884ea,"view.component.basis.Display.new","view/component/basis/Display.hx",16,0x78b00049)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(17)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.basis.Display","addedToStageHandler",0xc3780031,"view.component.basis.Display.addedToStageHandler","view/component/basis/Display.hx",21,0x78b00049)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Display","setOutput",0x707e3c4d,"view.component.basis.Display.setOutput","view/component/basis/Display.hx",42,0x78b00049)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.basis.Display","clear",0xe19ddc97,"view.component.basis.Display.clear","view/component/basis/Display.hx",47,0x78b00049)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
		this->tf->set_text(HX_CSTRING(""));
	}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("view.component.basis.Display"), hx::TCanCast< Display_obj> ,sStaticFields,sMemberFields,
