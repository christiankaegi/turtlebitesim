...
{
HX_STACK_FRAME("view.component.lines.TopLayer","new",0x2a8b2497,"view.component.lines.TopLayer.new","view/component/lines/TopLayer.hx",15,0x0858f2d6)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(16)
	super::__construct();
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","addedToStageHandler",0xa89d89de,"view.component.lines.TopLayer.addedToStageHandler","view/component/lines/TopLayer.hx",20,0x0858f2d6)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","bmpLoadCompleteHandler",0xca903d6f,"view.component.lines.TopLayer.bmpLoadCompleteHandler","view/component/lines/TopLayer.hx",30,0x0858f2d6)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","bmp2048LoadCompleteHandler",0xaf730bed,"view.component.lines.TopLayer.bmp2048LoadCompleteHandler","view/component/lines/TopLayer.hx",35,0x0858f2d6)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(36)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","clockLoadCompleteHandler",0x76adc5c6,"view.component.lines.TopLayer.clockLoadCompleteHandler","view/component/lines/TopLayer.hx",40,0x0858f2d6)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bmd,"bmd")
		HX_STACK_LINE(41)
		::openfl::_legacy::display::Bitmap _g = ::openfl::_legacy::display::Bitmap_obj::__new(bmd,null(),null());		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","showClock",0x9e524708,"view.component.lines.TopLayer.showClock","view/component/lines/TopLayer.hx",52,0x0858f2d6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
		this->hideClock();
		HX_STACK_LINE(54)
...
{
		HX_STACK_FRAME("view.component.lines.TopLayer","hideClock",0xcb4c9d23,"view.component.lines.TopLayer.hideClock","view/component/lines/TopLayer.hx",57,0x0858f2d6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(58)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("view.component.lines.TopLayer"), hx::TCanCast< TopLayer_obj> ,sStaticFields,sMemberFields,
