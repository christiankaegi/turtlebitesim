...
{
HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","new",0x6b3966a9,"view.mediator.basis.AccumulatorMediator.new","view/mediator/basis/AccumulatorMediator.hx",22,0x12873188)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","onRegister",0x78522f79,"view.mediator.basis.AccumulatorMediator.onRegister","view/mediator/basis/AccumulatorMediator.hx",25,0x12873188)
		HX_STACK_THIS(this)
		HX_STACK_LINE(26)
		...
		this->appProxy = _g1;
		HX_STACK_LINE(29)
		::view::component::basis::Accumulator _g2 = this->getView();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(29)
...
Array< ::String > AccumulatorMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","listNotificationInterests",0x58f71de9,"view.mediator.basis.AccumulatorMediator.listNotificationInterests","view/mediator/basis/AccumulatorMediator.hx",33,0x12873188)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::ACCUMULATOR_CHANGED).Add(::AppConstants_obj::CLOCK_ON).Add(::AppConstants_obj::CLOCK_OFF).Add(::AppConstants_obj::MODEL_RESET_COMPLETE);
}


Void AccumulatorMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","handleNotification",0x4db4868a,"view.mediator.basis.AccumulatorMediator.handleNotification","view/mediator/basis/AccumulatorMediator.hx",40,0x12873188)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","viewReadyHandler",0x6819cbc3,"view.mediator.basis.AccumulatorMediator.viewReadyHandler","view/mediator/basis/AccumulatorMediator.hx",58,0x12873188)
		HX_STACK_THIS(this)
...
::view::component::basis::Accumulator AccumulatorMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.AccumulatorMediator","getView",0x857ad0e4,"view.mediator.basis.AccumulatorMediator.getView","view/mediator/basis/AccumulatorMediator.hx",62,0x12873188)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
