...
{
HX_STACK_FRAME("view.mediator.basis.DisplayMediator","new",0x6c8c2aa5,"view.mediator.basis.DisplayMediator.new","view/mediator/basis/DisplayMediator.hx",18,0x01eadc8c)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.DisplayMediator","onRegister",0xdfd622fd,"view.mediator.basis.DisplayMediator.onRegister","view/mediator/basis/DisplayMediator.hx",21,0x01eadc8c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(22)
		...
		HX_STACK_LINE(25)
		::view::component::basis::Display _g2 = this->getView();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(25)
...
Array< ::String > DisplayMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.DisplayMediator","listNotificationInterests",0x48b1bee5,"view.mediator.basis.DisplayMediator.listNotificationInterests","view/mediator/basis/DisplayMediator.hx",29,0x01eadc8c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("view.mediator.basis.DisplayMediator","handleNotification",0x5b5d9e0e,"view.mediator.basis.DisplayMediator.handleNotification","view/mediator/basis/DisplayMediator.hx",36,0x01eadc8c)
		HX_STACK_THIS(this)
					...
					HX_STACK_LINE(45)
					{
						...
						struct _Function_5_1{
							inline static Float Block( int &this1){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/mediator/basis/DisplayMediator.hx",45,0x01eadc8c)
								{
									HX_STACK_LINE(45)
						...
						HX_STACK_LINE(45)
						_g11 = ::Std_obj::string(_Function_5_1::Block(this1));
					}
					HX_STACK_LINE(45)
...
{
		HX_STACK_FRAME("view.mediator.basis.DisplayMediator","viewReadyHandler",0x24a73a47,"view.mediator.basis.DisplayMediator.viewReadyHandler","view/mediator/basis/DisplayMediator.hx",56,0x01eadc8c)
		HX_STACK_THIS(this)
...
::view::component::basis::Display DisplayMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.DisplayMediator","getView",0xd3e542e0,"view.mediator.basis.DisplayMediator.getView","view/mediator/basis/DisplayMediator.hx",60,0x01eadc8c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(60)
