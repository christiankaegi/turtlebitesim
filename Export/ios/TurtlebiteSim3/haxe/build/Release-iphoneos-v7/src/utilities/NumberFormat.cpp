...
{
HX_STACK_FRAME("utilities.NumberFormat","new",0xe0351e16,"utilities.NumberFormat.new","utilities/NumberFormat.hx",10,0x7fdedf39)
HX_STACK_THIS(this)
{
}
;
...
::String NumberFormat_obj::intToString( int num){
	HX_STACK_FRAME("utilities.NumberFormat","intToString",0xdfd49471,"utilities.NumberFormat.intToString","utilities/NumberFormat.hx",13,0x7fdedf39)
...
Dynamic length = __o_length.Default(8);
	HX_STACK_FRAME("utilities.NumberFormat","binaryToArray",0x063ee553,"utilities.NumberFormat.binaryToArray","utilities/NumberFormat.hx",35,0x7fdedf39)
...
::model::vo::DecHexVO NumberFormat_obj::binaryToDecimal( ::String value){
	HX_STACK_FRAME("utilities.NumberFormat","binaryToDecimal",0xec1c0ecb,"utilities.NumberFormat.binaryToDecimal","utilities/NumberFormat.hx",48,0x7fdedf39)
...
::String NumberFormat_obj::decimalToBinary( int value){
	HX_STACK_FRAME("utilities.NumberFormat","decimalToBinary",0xc25a5443,"utilities.NumberFormat.decimalToBinary","utilities/NumberFormat.hx",85,0x7fdedf39)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(86)
...
::String NumberFormat_obj::decimalToChar( int value){
	HX_STACK_FRAME("utilities.NumberFormat","decimalToChar",0xffcc0298,"utilities.NumberFormat.decimalToChar","utilities/NumberFormat.hx",123,0x7fdedf39)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(134)
