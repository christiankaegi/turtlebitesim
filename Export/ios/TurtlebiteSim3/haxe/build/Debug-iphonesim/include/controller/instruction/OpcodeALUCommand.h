...
#define INCLUDED_controller_instruction_OpcodeALUCommand
...
HX_DECLARE_CLASS2(controller,instruction,OpcodeALUCommand)
...
class HXCPP_CLASS_ATTRIBUTES  OpcodeALUCommand_obj : public ::org::puremvc::haxe::multicore::patterns::command::SimpleCommand_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::command::SimpleCommand_obj super;
		typedef OpcodeALUCommand_obj OBJ_;
		OpcodeALUCommand_obj();
		Void __construct();

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< OpcodeALUCommand_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("OpcodeALUCommand"); }
...
#endif /* INCLUDED_controller_instruction_OpcodeALUCommand */ 
