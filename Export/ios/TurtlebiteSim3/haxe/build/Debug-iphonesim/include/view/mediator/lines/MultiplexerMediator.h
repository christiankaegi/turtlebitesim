...
#define INCLUDED_view_mediator_lines_MultiplexerMediator
...
HX_DECLARE_CLASS3(view,component,lines,Multiplexer)
HX_DECLARE_CLASS3(view,mediator,lines,MultiplexerMediator)
namespace view{
namespace mediator{
namespace lines{


class HXCPP_CLASS_ATTRIBUTES  MultiplexerMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef MultiplexerMediator_obj OBJ_;
		MultiplexerMediator_obj();
		Void __construct(::view::component::lines::Multiplexer viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< MultiplexerMediator_obj > __new(::view::component::lines::Multiplexer viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("MultiplexerMediator"); }
		...
		virtual ::view::component::lines::Multiplexer getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_MultiplexerMediator */ 
