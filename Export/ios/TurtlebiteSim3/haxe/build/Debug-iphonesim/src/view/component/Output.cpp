...
{
		HX_STACK_FRAME("view.component.Output","loadRomDisplay",0x2e704c0b,"view.component.Output.loadRomDisplay","view/component/Output.hx",97,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","powerOn",0x964f63f1,"view.component.Output.powerOn","view/component/Output.hx",100,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(101)
		this->ram->clear(null());
		HX_STACK_LINE(102)
...
{
		HX_STACK_FRAME("view.component.Output","powerOff",0xef28085d,"view.component.Output.powerOff","view/component/Output.hx",107,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(108)
		this->rom->clear(true);
		HX_STACK_LINE(109)
...
{
		HX_STACK_FRAME("view.component.Output","setProgramCountPointer",0x9d3bfd03,"view.component.Output.setProgramCountPointer","view/component/Output.hx",116,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","updateRam",0x318c3002,"view.component.Output.updateRam","view/component/Output.hx",120,0xe160a741)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.component.Output","resetRamPointer",0x6ba5ad9b,"view.component.Output.resetRamPointer","view/component/Output.hx",124,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(124)
...
{
		HX_STACK_FRAME("view.component.Output","setRamPointer",0x17f0bfee,"view.component.Output.setRamPointer","view/component/Output.hx",128,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_ARG(pointer,"pointer")
		HX_STACK_LINE(128)
...
{
		HX_STACK_FRAME("view.component.Output","resetRam",0x299d8742,"view.component.Output.resetRam","view/component/Output.hx",132,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(132)
		this->ram->clear(null());
	}
...
{
		HX_STACK_FRAME("view.component.Output","resetAll",0x2990aa85,"view.component.Output.resetAll","view/component/Output.hx",135,0xe160a741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(136)
		this->ram->clear(null());
		HX_STACK_LINE(137)
