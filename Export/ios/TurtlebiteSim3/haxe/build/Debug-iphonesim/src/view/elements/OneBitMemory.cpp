...
Dynamic OneBitMemory_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"setButton") ) { setButton=inValue.Cast< ::openfl::_legacy::display::Sprite >(); return inValue; }
		break;
	case 10:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"inputButton") ) { inputButton=inValue.Cast< ::openfl::_legacy::display::Sprite >(); return inValue; }
		break;
	case 12:
		...
		if (HX_FIELD_EQ(inName,"bmpContainer") ) { bmpContainer=inValue.Cast< ::openfl::_legacy::display::Sprite >(); return inValue; }
		break;
	case 18:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_legacy::display::Sprite*/ ,(int)offsetof(OneBitMemory_obj,inputButton),HX_CSTRING("inputButton")},
	{hx::fsObject /*::openfl::_legacy::display::Sprite*/ ,(int)offsetof(OneBitMemory_obj,setButton),HX_CSTRING("setButton")},
	...
	{hx::fsObject /*::openfl::_legacy::display::Sprite*/ ,(int)offsetof(OneBitMemory_obj,bmpContainer),HX_CSTRING("bmpContainer")},
	{ hx::fsUnknown, 0, null()}
};
#endif
