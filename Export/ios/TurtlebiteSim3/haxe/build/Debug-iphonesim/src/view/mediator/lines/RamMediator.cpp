...
Void RamMediator_obj::__construct(::view::component::lines::Ram viewComponent)
{
HX_STACK_FRAME("view.mediator.lines.RamMediator","new",0x9fbaae82,"view.mediator.lines.RamMediator.new","view/mediator/lines/RamMediator.hx",17,0xc3835ecf)
HX_STACK_THIS(this)
...
hx::ObjectPtr< RamMediator_obj > RamMediator_obj::__new(::view::component::lines::Ram viewComponent)
...
{
		HX_STACK_FRAME("view.mediator.lines.RamMediator","onRegister",0xbf5a84c0,"view.mediator.lines.RamMediator.onRegister","view/mediator/lines/RamMediator.hx",20,0xc3835ecf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(21)
		...
		HX_STACK_LINE(24)
		::view::component::lines::Ram _g2 = this->getView();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(24)
...
Array< ::String > RamMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.lines.RamMediator","listNotificationInterests",0x76f1d082,"view.mediator.lines.RamMediator.listNotificationInterests","view/mediator/lines/RamMediator.hx",28,0xc3835ecf)
	HX_STACK_THIS(this)
	HX_STACK_LINE(28)
	return Array_obj< ::String >::__new().Add(::AppConstants_obj::CLOCK_ON).Add(::AppConstants_obj::BROADCAST_SDA).Add(::AppConstants_obj::BROADCAST_LDA).Add(::AppConstants_obj::MODEL_RESET_COMPLETE).Add(::AppConstants_obj::DETAIL_POPUP_ACTIVE);
}


Void RamMediator_obj::handleNotification( ::org::puremvc::haxe::multicore::interfaces::INotification note){
{
		HX_STACK_FRAME("view.mediator.lines.RamMediator","handleNotification",0x858dfad1,"view.mediator.lines.RamMediator.handleNotification","view/mediator/lines/RamMediator.hx",38,0xc3835ecf)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.lines.RamMediator","viewReadyHandler",0xce03d04a,"view.mediator.lines.RamMediator.viewReadyHandler","view/mediator/lines/RamMediator.hx",61,0xc3835ecf)
		HX_STACK_THIS(this)
...
::view::component::lines::Ram RamMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.lines.RamMediator","getView",0xf39f793d,"view.mediator.lines.RamMediator.getView","view/mediator/lines/RamMediator.hx",65,0xc3835ecf)
	HX_STACK_THIS(this)
	HX_STACK_LINE(65)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("view.mediator.lines.RamMediator"), hx::TCanCast< RamMediator_obj> ,sStaticFields,sMemberFields,
