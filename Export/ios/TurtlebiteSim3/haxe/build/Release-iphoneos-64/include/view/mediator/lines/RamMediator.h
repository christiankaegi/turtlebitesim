...
#define INCLUDED_view_mediator_lines_RamMediator
...
HX_DECLARE_CLASS3(view,mediator,lines,RamMediator)
namespace view{
namespace mediator{
namespace lines{


class HXCPP_CLASS_ATTRIBUTES  RamMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		typedef ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj super;
		typedef RamMediator_obj OBJ_;
		RamMediator_obj();
		Void __construct(::view::component::lines::Ram viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< RamMediator_obj > __new(::view::component::lines::Ram viewComponent);
		...
		::String __ToString() const { return HX_CSTRING("RamMediator"); }
		...
		virtual ::view::component::lines::Ram getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_lines_RamMediator */ 
