...
#define INCLUDED_view_mediator_basis_DisplayMediator
...
HX_DECLARE_CLASS3(view,component,basis,Display)
HX_DECLARE_CLASS3(view,mediator,basis,DisplayMediator)
namespace view{
namespace mediator{
namespace basis{
...
class HXCPP_CLASS_ATTRIBUTES  DisplayMediator_obj : public ::org::puremvc::haxe::multicore::patterns::mediator::Mediator_obj{
	public:
		...
		DisplayMediator_obj();
		Void __construct(::view::component::basis::Display viewComponent);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< DisplayMediator_obj > __new(::view::component::basis::Display viewComponent);
		...
		virtual ::view::component::basis::Display getView( );
		Dynamic getView_dyn();
...
#endif /* INCLUDED_view_mediator_basis_DisplayMediator */ 
