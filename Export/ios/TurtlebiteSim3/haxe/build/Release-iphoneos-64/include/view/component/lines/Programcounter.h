...
#define INCLUDED_view_component_lines_Programcounter
...
class HXCPP_CLASS_ATTRIBUTES  Programcounter_obj : public ::openfl::_legacy::display::Sprite_obj{
	public:
		typedef ::openfl::_legacy::display::Sprite_obj super;
		typedef Programcounter_obj OBJ_;
		Programcounter_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< Programcounter_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("Programcounter"); }
...
#endif /* INCLUDED_view_component_lines_Programcounter */ 
