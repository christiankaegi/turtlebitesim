...
#define INCLUDED_view_elements_RomRamDisplay
...
class HXCPP_CLASS_ATTRIBUTES  RomRamDisplay_obj : public ::openfl::_legacy::display::Sprite_obj{
	...
	public:
		...
		Array< ::Dynamic > tfOut;
		int textColor;
		::openfl::_legacy::display::Bitmap tfFrame;
		virtual Void tfFrameBmpLoadCompleteHandler( ::openfl::_legacy::display::BitmapData bmd);
		Dynamic tfFrameBmpLoadCompleteHandler_dyn();
...
#endif /* INCLUDED_view_elements_RomRamDisplay */ 
