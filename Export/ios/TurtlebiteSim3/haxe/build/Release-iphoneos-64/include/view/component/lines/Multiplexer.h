...
#define INCLUDED_view_component_lines_Multiplexer
...
class HXCPP_CLASS_ATTRIBUTES  Multiplexer_obj : public ::openfl::_legacy::display::Sprite_obj{
	public:
		typedef ::openfl::_legacy::display::Sprite_obj super;
		typedef Multiplexer_obj OBJ_;
		Multiplexer_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< Multiplexer_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("Multiplexer"); }
...
#endif /* INCLUDED_view_component_lines_Multiplexer */ 
