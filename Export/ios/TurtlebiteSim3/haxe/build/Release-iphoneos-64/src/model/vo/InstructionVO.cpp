...
{
HX_STACK_FRAME("model.vo.InstructionVO","new",0xc2460789,"model.vo.InstructionVO.new","model/vo/InstructionVO.hx",23,0xd6b372a7)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("model.vo.InstructionVO","assemble",0xbb63dd49,"model.vo.InstructionVO.assemble","model/vo/InstructionVO.hx",37,0xd6b372a7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(38)
		{
			HX_STACK_LINE(38)
