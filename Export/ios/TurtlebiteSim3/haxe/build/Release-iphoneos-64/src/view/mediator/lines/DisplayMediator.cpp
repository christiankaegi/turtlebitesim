...
Array< ::String > DisplayMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.lines.DisplayMediator","listNotificationInterests",0xa1a61166,"view.mediator.lines.DisplayMediator.listNotificationInterests","view/mediator/lines/DisplayMediator.hx",29,0xa1acd5eb)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("view.mediator.lines.DisplayMediator","handleNotification",0x0cdc856d,"view.mediator.lines.DisplayMediator.handleNotification","view/mediator/lines/DisplayMediator.hx",38,0xa1acd5eb)
		HX_STACK_THIS(this)
					...
					HX_STACK_LINE(44)
					{
						...
						struct _Function_5_1{
							inline static Float Block( int &this1){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","view/mediator/lines/DisplayMediator.hx",44,0xa1acd5eb)
								{
									HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("view.mediator.lines.DisplayMediator","viewReadyHandler",0x7beb3be6,"view.mediator.lines.DisplayMediator.viewReadyHandler","view/mediator/lines/DisplayMediator.hx",58,0xa1acd5eb)
		HX_STACK_THIS(this)
...
::view::component::lines::Display DisplayMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.lines.DisplayMediator","getView",0x5143f121,"view.mediator.lines.DisplayMediator.getView","view/mediator/lines/DisplayMediator.hx",62,0xa1acd5eb)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
