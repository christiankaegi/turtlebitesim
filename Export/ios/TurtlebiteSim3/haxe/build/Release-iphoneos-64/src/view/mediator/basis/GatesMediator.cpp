...
{
HX_STACK_FRAME("view.mediator.basis.GatesMediator","new",0x94f7ddeb,"view.mediator.basis.GatesMediator.new","view/mediator/basis/GatesMediator.hx",20,0x5ca2b9c6)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.GatesMediator","onRegister",0x54620477,"view.mediator.basis.GatesMediator.onRegister","view/mediator/basis/GatesMediator.hx",23,0x5ca2b9c6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(24)
		...
		HX_STACK_LINE(27)
		::view::component::basis::Gates _g2 = this->getView();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(27)
...
Array< ::String > GatesMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.basis.GatesMediator","listNotificationInterests",0xe99e96ab,"view.mediator.basis.GatesMediator.listNotificationInterests","view/mediator/basis/GatesMediator.hx",31,0x5ca2b9c6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("view.mediator.basis.GatesMediator","handleNotification",0x873e8988,"view.mediator.basis.GatesMediator.handleNotification","view/mediator/basis/GatesMediator.hx",44,0x5ca2b9c6)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.basis.GatesMediator","viewReadyHandler",0x420c7341,"view.mediator.basis.GatesMediator.viewReadyHandler","view/mediator/basis/GatesMediator.hx",78,0x5ca2b9c6)
		HX_STACK_THIS(this)
...
::view::component::basis::Gates GatesMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.basis.GatesMediator","getView",0x15b31126,"view.mediator.basis.GatesMediator.getView","view/mediator/basis/GatesMediator.hx",82,0x5ca2b9c6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
