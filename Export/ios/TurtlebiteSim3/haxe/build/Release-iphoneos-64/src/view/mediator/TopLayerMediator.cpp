...
{
HX_STACK_FRAME("view.mediator.TopLayerMediator","new",0x58f61633,"view.mediator.TopLayerMediator.new","view/mediator/TopLayerMediator.hx",14,0x426ce4bd)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.TopLayerMediator","onRegister",0x4b4ae52f,"view.mediator.TopLayerMediator.onRegister","view/mediator/TopLayerMediator.hx",17,0x426ce4bd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(18)
...
Array< ::String > TopLayerMediator_obj::listNotificationInterests( ){
	HX_STACK_FRAME("view.mediator.TopLayerMediator","listNotificationInterests",0x464f44f3,"view.mediator.TopLayerMediator.listNotificationInterests","view/mediator/TopLayerMediator.hx",24,0x426ce4bd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
...
{
		HX_STACK_FRAME("view.mediator.TopLayerMediator","handleNotification",0x7f8ae240,"view.mediator.TopLayerMediator.handleNotification","view/mediator/TopLayerMediator.hx",33,0x426ce4bd)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("view.mediator.TopLayerMediator","viewReadyHandler",0x024aadf9,"view.mediator.TopLayerMediator.viewReadyHandler","view/mediator/TopLayerMediator.hx",49,0x426ce4bd)
		HX_STACK_THIS(this)
...
::view::component::TopLayer TopLayerMediator_obj::getView( ){
	HX_STACK_FRAME("view.mediator.TopLayerMediator","getView",0x96070d6e,"view.mediator.TopLayerMediator.getView","view/mediator/TopLayerMediator.hx",53,0x426ce4bd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(53)
