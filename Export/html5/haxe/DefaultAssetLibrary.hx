...
@:keep @:bind #if display private #end class __ASSET__assets_fonts_consolas_bold_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_consolas_bold_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_consolas_bold_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_consolas_bold_woff extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_bold_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_bold_otf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_bold_woff extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_regular_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_regular_otf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_myriadpro_regular_woff extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_tbsimlogo_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_tbsimlogo2_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_tbsimlogo3_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_consolas_bold_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_consolas_bold_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_consolas_bold_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_consolas_bold_woff extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_bold_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_bold_otf extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_bold_woff extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_regular_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_regular_otf extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_myriadpro_regular_woff extends null { }
...
#if openfl
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_consolas_bold_ttf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/Consolas Bold"; name = "Consolas Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_myriadpro_bold_otf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/MyriadPro-Bold"; name = "Myriad Pro Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_myriadpro_regular_otf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/MyriadPro-Regular"; name = "Myriad Pro"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__fonts_consolas_bold_ttf extends openfl.text.Font { public function new () { __fontPath = "fonts/Consolas Bold"; name = "Consolas Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__fonts_myriadpro_bold_otf extends openfl.text.Font { public function new () { __fontPath = "fonts/MyriadPro-Bold"; name = "Myriad Pro Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__fonts_myriadpro_regular_otf extends openfl.text.Font { public function new () { __fontPath = "fonts/MyriadPro-Regular"; name = "Myriad Pro"; super (); }}
